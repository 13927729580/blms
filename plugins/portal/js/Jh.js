...
Jh.fn = function(a) {
    return a = {
        ...
        _createTable: function(b) {
            ...
            $("<tbody/>").append(a._createActionTr()).appendTo(b);
            return b
        },
    ...
    return a = {
        ...
        _createPortal: function(b, c) {
			...
			case "iframe3":
				...
				break;
			default:
				var PortalKey=b.replace(/[^0-9]/ig,"");
				if(PortalKey%3==1){
					d = a._elements.m_l;
				}else if(PortalKey%3==2){
					d = a._elements.m_m;
				}else{
					d = a._elements.m_r;
				}
...
//            })
        ...
        _createItemContent: function(c) {
            var a = $(i);
            if(c.type=="iframe"){
            	$("<iframe width='100%' height='200' src='"+c.url+"' scrolling='no' frameborder='0' marginheight='0' marginwidth='0'></iframe></div>").appendTo(a);
        	}else{
        		$("Portal Content").appendTo(a);
        	}
            return a
        },
