...
class article extends AppModel
{
    ...
    {
        $article_infos = $this->find('all', array('conditions' => $conditions, 'limit' => $limit, 'order' => 'Article.'.$order, 'fields' => 'Article.id,Article.category_id,Article.created,ArticleI18n.img01,ArticleI18n.img02,ArticleI18n.title,ArticleI18n.content,ArticleI18n.meta_description'));
    ...
    public function get_module_infos($params)
    {
        ...
        //pr($pages);
        //分页end
        $article_infos = $this->find('all', array('conditions' => $conditions, 'page' => $page, 'limit' => $limit, 'order' => 'Article.'.$order, 'fields' => 'Article.id,Article.category_id,Article.clicked,Article.created,ArticleI18n.img01,ArticleI18n.img02,ArticleI18n.title,ArticleI18n.subtitle,ArticleI18n.content,ArticleI18n.meta_description'));
        if (!empty($article_infos)) {
            $article_ids=array();
            foreach ($article_infos as $k => $v) {
            ...
            $article_like_info=$UserLike->find('all',array('conditions'=>array('UserLike.type'=>'A','UserLike.type_id'=>$article_ids,'UserLike.action'=>'like'),'fields'=>array("UserLike.type_id","count(UserLike.id) as like_num"),"group"=>'type_id'));
            	...
            	if(isset($_SESSION['User']['User'])){
            		...
            		$article_data['article_user_like'] = $article_user_like;
            	}
            }
        }
        $article_data['article'] = $article_infos;
        $article_data['paging'] = $pages;
        return $article_data;
    }
    /**
    ...
    public function get_module_article_video($params)
    {
        ...
        $conditions['Article.status'] = 1;
        $video_infos = $this->find('first', array('conditions' => $conditions, 'limit' => $limit, 'order' => 'Article.'.$order, 'fields' => 'Article.id,Article.video,Article.upload_video,Article.video_competence,ArticleI18n.img01,ArticleI18n.img02,ArticleI18n.title,ArticleI18n.content,ArticleI18n.meta_description'));
    ...
    public function get_module_relation_video($params)
    {
        ...
        $relation_video = $this->find('all', array('conditions' => $conditions, 'limit' => $limit, 'order' => 'Article.'.$order, 'fields' => 'Article.id,Article.video,ArticleI18n.img01,ArticleI18n.img02,Article.category_id,ArticleI18n.title,ArticleI18n.subtitle'));
        //查询相同分类的视频
    ...
    public function get_module_video_recommend($params)
    {
        ...
        $conditions['Article.status'] = '1';
        $conditions['Article.recommand'] = '1';
        $video_list = $this->find('all', array('fields' => array('Article.id', 'Article.category_id', 'Article.created', 'ArticleI18n.title', 'ArticleI18n.img01','ArticleI18n.img02', 'ArticleI18n.subtitle'), 'conditions' => $conditions, 'order' => $order, 'limit' => $limit));
    ...
    public function get_recommand_article_infos($params)
    {
        ...
        if (isset($params['category_id'])) {
            $conditions['Article.category_id'] = $params['category_id'];
        }
        if (isset($params['id'])) {
            $conditions['Article.id <>'] = $params['id'];
        }
        $conditions['Article.recommand'] = 1;
        $conditions['Article.status'] = 1;
        $article_infos = $this->find('all', array('conditions' => $conditions, 'limit' => $limit, 'order' => 'Article.'.$order, 'fields' => 'Article.id,Article.category_id,Article.created,ArticleI18n.img01,ArticleI18n.img02,ArticleI18n.title,ArticleI18n.subtitle,ArticleI18n.content,ArticleI18n.meta_description'));
        if (!empty($article_infos)) {
            foreach ($article_infos as $k => $v) {
                $article_infos[$k]['ArticleI18n']['des_content'] = $this->cutstr($v['ArticleI18n']['meta_description'], 80);
            }
    ...
    */
    public function get_article_lists($params)
    {
        ...
        //pr($pages);
        //分页end
        $article_lists = $this->find('all', array('fields' => array('Article.id','Article.clicked', 'Article.created', 'ArticleI18n.title', 'ArticleI18n.subtitle', 'ArticleI18n.content', 'ArticleI18n.author', 'ArticleI18n.img01','ArticleI18n.img02', 'ArticleI18n.meta_description'), 'conditions' => $conditions, 'order' => $order, 'page' => $page, 'limit' => $limit));
    ...
    public function get_module_article_infos($params)
    {
        ...
        $conditions['Article.status'] = '1';
        $article_infos = $this->find('first', array('fields' => array('Article.id','Article.clicked', 'Article.category_id', 'Article.created','Article.modified','ArticleI18n.title', 'ArticleI18n.subtitle', 'ArticleI18n.content', 'ArticleI18n.author', 'ArticleI18n.img01','ArticleI18n.img02','ArticleI18n.meta_description'), 'conditions' => $conditions, 'order' => $order, 'page' => $page, 'limit' => $limit));
        if (!empty($article_infos)) {
            //查询文章相册
    ...
    public function get_module_article_recommend($params)
    {
        ...
        if (isset($params['id'])&&intval($params['id'])>0) {
        	if(isset($params['controller'])&&isset($params['action'])&&$params['controller']=='articles'&&$params['action']=='view')$conditions['Article.id <>'] = $params['id'];
        }
        $conditions['Article.status'] = '1';
        $conditions['Article.recommand'] = '1';
        $article_list = $this->find('all', array('fields' => array('Article.id', 'Article.category_id', 'Article.created', 'ArticleI18n.title', 'ArticleI18n.img01','ArticleI18n.img02', 'ArticleI18n.subtitle', 'ArticleI18n.meta_description'), 'conditions' => $conditions, 'order' => $order, 'limit' => $limit));
