...
//        }
        ...
        if ($Product->check_product($params['id'])) {
            ...
            if (empty($product_infos)) {
                ...
                $product_infos[0]['ProductGallery']['product_image1'] = isset($p['Product']['product_image1']) ? $p['Product']['product_image1'] : '';
                $product_infos[0]['ProductGallery']['product_image2'] = isset($p['Product']['product_image2']) ? $p['Product']['product_image2'] : '';
