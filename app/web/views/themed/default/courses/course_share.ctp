...
.listtable_div_btm .am-u-lg-3{width:25%!important;}
	...
	<div class="am-panel am-panel-default <?php if($organizations_id!=''){echo 'am-u-lg-9';} ?>" id="course_share" style="font-size: 14px;margin-left: 0;">
	    ...
	    <div id="Share_record" class="am-panel-collapse am-collapse am-in">
	        ...
	        <div class="listtable_div_btm" style="line-height:46px;padding-left:1.25rem;padding-right:1.25rem;">
	                    <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-hide-sm-only" style="padding:5px;">分享时间</div>
	                    <div class="am-u-lg-6 am-u-md-6 am-u-sm-8" style="padding:5px;">分享对象</div>
	                    <!-- <div class="am-u-lg-4 am-u-md-3 am-u-sm-4" style="padding:5px;">分享者姓名</div> -->
	                    <div class="am-u-lg-2 am-u-md-2 am-u-sm-2" style="padding:5px;">操作</div>
	        ...
	        <div class="listtable_div_btm" style="line-height:46px;border-top: 1px solid #ccc;padding-left:1.25rem;padding-right:1.25rem;">
	            <div class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-hide-sm-only" style="padding:5px;"><?php echo $v['OrganizationShare']['created'] ?></div>
	            <div class="am-u-lg-6 am-u-md-6 am-u-sm-8" style="padding:5px 5px;">
	            ...
	            <!-- <div class="am-u-lg-4 am-u-md-2 am-u-sm-4" style="padding:5px 5px;">
	            ...
	            <div class="am-u-lg-2 am-u-md-2 am-u-sm-2" style="padding:5px 5px;">
