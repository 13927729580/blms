<div class="am-panel-group syn_callback" id="accordion" style="max-width: 600px;">
    <div class="am-panel am-panel-default <?php echo isset($action_code)&&$action_code!='auto_bind'?'am-hide':''; ?>">
        <div class="am-panel-hd">
          <h4 class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#auto_bind'}">新用户登录<span class="am-callback-icon am-fr <?php echo isset($action_code)&&$action_code!='auto_bind'?'am-icon-angle-double-down':'am-icon-angle-double-up'; ?>"></span></h4>
        </div>
          ...
          <div class="am-panel-bd" style="padding-top:20px;">
            <div class="am-cf am-g am-g-fixed">
                <div class="am-u-lg-12 am-u-md-12 am-u-sm-12">
        			...
        			<?php echo $html->image($response['auth']['info']['image']!=''&&$response['auth']['info']['image']!='/'?$response['auth']['info']['image']:($webroot.'theme/default/img/no_head.png'),array(' data-rel'=>$response['auth']['info']['image']!=''&&$response['auth']['info']['image']!='/'?$response['auth']['info']['image']:'/theme/default/img/no_head.png','style'=>'width:50%;height:50%;display: inline; max-height: 200px;max-width: 200px;'));  ?>
          			</figure>
        		</div>
                <div class="am-u-lg-12 am-u-md-12 am-u-sm-12">
        			...
        			<?php echo $form->create('/synchros',array('action'=>'apibind','id'=>'api_fast_login_form','name'=>'api_fast_login_form','type'=>'POST','class'=>'am-form am-form-horizontal'));?>
        			<input type="hidden" name="data[type]" value="fast_login" />
        			<input type="hidden" name="data[email]" value="<?php echo isset($response['auth']['info']['email'])?$response['auth']['info']['email']:''; ?>" />
					...
					<div class="am-form-group">
						<div class="am-u-lg-12 am-u-md-12 am-u-sm-12 am-form-label" style="padding:20px;"><input style="min-width: 275px;" class="am-btn am-btn-success" id="fast_login_btn" type="button" value="<?php echo isset($userAppNames[$response['auth']['provider']])?$userAppNames[$response['auth']['provider']]:$response['auth']['provider']; ?>自动登录" /></div>
					</div>
        			</div>
        			<?php echo $form->end();?>
        		</div>
    ...
    <div class="am-panel am-panel-default <?php echo isset($action_code)&&$action_code!='api_bind'?'am-hide':''; ?>">
        ...
        <div id="api_bind" class="am-panel-collapse am-collapse <?php echo isset($action_code)&&$action_code=='api_bind'?'am-in':''; ?>">
          <div class="am-panel-bd">
			...
			<input type="hidden" name="data[oauth_token]" value="<?php echo $response['auth']['credentials']['token']; ?>" />
			<input type="hidden" name="data[user_name]" value="<?php echo isset($response['auth']['info']['name'])&&$response['auth']['info']['name']!=''?$response['auth']['info']['name']:''; ?>">
    		<div class="am-form-detail" style="margin-top:1rem;">
    			<div class="am-form-group">
					<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label" style="padding-top:5px;"><?php echo $ld['login_name'] ?>:</label>
					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
						<input type="text" name="data[email]" id="api_log_email" value="" style="margin-left:0;" placeholder="<?php echo $ld['email'].'/'.$ld['user_id'].'/'.$ld['mobile']; ?>" />
					</div>
				</div>
				<div class="am-form-group">
					<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-label" style="padding-top:5px;"><?php echo $ld['password'] ?>:</label>
					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
				...
				<div class="am-form-group">
					...
					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
						<input style="min-width: 200px;width: 95%;padding:8px;" class="am-btn am-btn-primary am-btn-sm am-fl" type="submit" value="<?php echo '绑定账号' ?>" />
					</div>
				</div>
    		</div>
    		<?php echo $form->end();?>
    ...
    <div class="am-panel am-panel-default <?php echo (isset($response['auth']['provider'])&&($response['auth']['provider']=='wechat')||($response['auth']['provider']=='Wechat'))||(isset($action_code)&&$action_code!='api_register')?'am-hide':''; ?>" style="display: none;">
        <div class="am-panel-hd">
        ...
        <div id="api_register" class="am-panel-collapse am-collapse <?php echo isset($action_code)&&$action_code=='api_register'?'am-in':''; ?>">
          <div class="am-panel-bd">
            <?php echo $form->create('/synchros',array('action'=>'apibind','id'=>'api_register_form','class'=>'am-form am-form-horizontal','name'=>'api_register_login','type'=>'POST'));?>
    			...
    			<div class="am-form-detail" style="margin-top:1rem;">
        			<div class="am-form-group">
    					<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label" style="padding-top:5px;"><?php echo $ld['e-mail'] ?>:</label>
    					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
    						<input type="text" name="data[email]" id="api_reg_email" value="" style="margin-left:0;" /><em>*</em>
    					</div>
    				</div>
    				<div class="am-form-group">
    					<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label" style="padding-top:5px;"><?php echo $ld['password'] ?>:</label>
    					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
    						<input type="password" name="data[password]" id="api_reg_password" value="" /><em>*</em>
    					</div>
    				</div>
    				<div class="am-form-group">
    					<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label" style="padding-top:5px;"><?php echo $ld['confirm_password'] ?>:</label>
    					<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		...
		if(api_reg_email_check==false){
			...
			if(value!=""){
				...
				if(reg.test(value)){
					$.ajax({
		             type: "POST",
		             url: web_base+"/synchros/checkdata",
