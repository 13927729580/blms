...
<ul class="am-comments-list am-comments-list-flip">
  ...
  <li class="am-comment">
    <a target="_blank" title="<?php echo $vv['User']['name'];?>" href="<?php echo $html->url('/user_socials/index/'.$vv['Comment']['user_id']); ?>">
      <?php echo $html->image(isset($vv['User']['img01'])&&$vv['User']['img01']!=""?$vv['User']['img01']:('/theme/default/img/no_head.png'),array('alt'=>$vv['User']['name'],'style'=>'width:48px;height:48px;','class'=>'am-comment-avatar'));  ?>
    </a>
