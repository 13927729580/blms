...
<div class="am-g am-container">
	...
	<ul data-am-widget="gallery" class="am-gallery am-first-article am-gallery-overlay" data-am-gallery="{ pureview: true;gallery:false }" >
      <li style="width:100%">
        <div class="am-gallery-item">
            	<?php echo $html->image(isset($material['0']['OpenElement']['media_url'])?$material[0]['OpenElement']['media_url']:'');  ?>
    ...
    <div data-am-widget="list_news" class="am-list-news am-list-news-default" >
          ...
          <div class="am-u-sm-4 am-list-thumb">
          		<?php echo $html->image(isset($v['OpenElement']['media_url'])?$v['OpenElement']['media_url']:'');  ?>
          </div>
      </li>
    </ul>
</a>
...
<?php if(trim($material[0]['OpenElement']['media_url'])!=""&&$svshow->imgfilehave($server_host.(str_replace($server_host,'',$material[0]['OpenElement']['media_url'])))){ ?>
