<style>
	.pages em {background:white;color:black}
	.pages a{background:white;color:black}
	.cate_color a{color:black}
	.pad{padding-left:0px}
	.search_condition div:first-child, .search_condition_list div:first-child {text-align:left}
	
	.am-panel-hd{padding:0px}
	.f-size{font-size:14px}
	.am-list>li>a{color:black}
	.am-list>li>a:hover{color:#0e90d2}
	.search_condition div a:hover{color:#0e90d2}
	.jianju{margin-bottom:20px}
</style>
<?php
	$serach_title=false;
	$search_content=isset($configs['search_content'])?explode(';',$configs['search_content']):array();
	if(in_array('0',$search_content)||(!in_array('0',$search_content)&&sizeof($search_content)>=2)){$serach_title=true;}
?>
<div class="am-search-show">
    <?php if(in_array('0',$search_content)||in_array('1',$search_content)){ ?>
    <div class="am-g am-g-fixed">
        <div style="margin-top:10px;" class="am-panel am-panel-default">
        	 <?php if($serach_title){ ?>
	        <div class="am-panel-hd my-head pad" id="s_pro"><?php echo $ld['product'] ?>(<?php echo !empty($products)?sizeof($products):0; ?>)</div>
	        <?php } ?>
	        <div class="am-panel-bd">
                    <div>
        				...
        				<div class="am-g search_condition_list">
        				  <div class="am-u-lg-1 am-u-md-2 am-u-sm-2 " style="width:10%;">已选条件:</div>
        				  <div class="am-u-lg-9 am-u-md-8 am-u-sm-7 cate_color" style="margin-left:-2rem;">
        				...
        				<div class="am-g search_condition">
        				  <div class="am-u-lg-1 am-u-md-2 am-u-sm-2" style=""><?php echo $ld['categories'] ?>:</div>
        				  <div class="am-u-lg-9 am-u-md-8 am-u-sm-7 cate_color am-u-end" style="padding-left:0;margin-left:-1.5rem;">
        				    <?php
        					$other_condition="";
        					if(isset($_GET['searchtype'])){
        						$other_condition.="&searchtype=".$_GET['searchtype'];
        				...
        				<div class="am-g search_condition">
        				  ...
        				  <div class="am-u-lg-2 am-u-md-2 am-u-sm-2 cate_color">
        				    <?php
        						$other_condition="";
        						if(isset($_GET['searchtype'])){
        							$other_condition.="&searchtype=".$_GET['searchtype'];
        				  ...
        				  <div class="am-u-lg-4 am-u-md-4 am-u-sm-4" style="padding:0;">
        						...
        						?>
        								<div class="am-u-lg-2 am-u-md-2 am-u-sm-4">
        									<input style="width:41px" type="text" class="am-form-field am-input-sm" id="search_price_start" value="￥<?php echo isset($search_price_start)?$search_price_start:'' ?>">
        								</div>
        						    	<div class="am-u-lg-1" style="width:10px;max-width:10px;min-width:10px;padding:0px;margin:0;">-</div>
        						    	<div class="am-u-lg-2 am-u-md-2 am-u-sm-4">
        						        <input style="width:41px" type="text" class="am-form-field am-input-sm" id="search_price_end" value="￥<?php echo isset($search_price_end)?$search_price_end:'' ?>">
        						      </div>
        						      <button class="am-btn am-btn-secondary am-btn-sm" type="button" onclick="search_price('<?php echo $html->url('/searchs/keyword/'.$keyword.'?'.$other_condition) ?>')"><?php echo $ld['confirm'] ?></button>
        				  </div>
						</div>
        				<?php } ?>
        				...
        				<div class="am-g search_condition">
        				  ...
        				  <div class="am-u-lg-9 am-u-md-8 am-u-sm-7 cate_col">
				...
				<ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-gallery-overlay" data-am-gallery="{ }" id="baba">
    ...
    <?php if(in_array('0',$search_content)||in_array('2',$search_content)){ ?>
    <div class="am-g am-g-fixed">
        <div style="margin-top:10px;" class="am-panel am-panel-default">
            <?php if($serach_title){ ?>
            <div class="am-panel-hd my-head "  style="background:white;border-bottom: none;
    border-top: 1px solid #ddd;"><?php echo $ld['article'] ?>(<?php echo !empty($articles)?sizeof($articles):0; ?>)</div>
            <?php } ?>
            <div class="am-panel-bd">
                <div>
                    ...
                    <?php if(!empty($articles)){?>
    					<ul class="am-list am-list-striped">
    						<?php foreach($articles as $k=>$v){ ?>
    							<li class="f-size"><?php echo $svshow->seo_link(array('type'=>'A', 'name'=>$v['ArticleI18n']['title'], 'sub_name'=>$v['ArticleI18n']['title'], 'id'=>$v['Article']['id']));?></li>
    						<?php } ?>
    					</ul>
    				<?php }else{ ?>
