			...
			<div id="ds-thread" class="am-cf" style="margin-top: 5px;">
			  <div id="ds-reset">
				<div class="ds-textarea-wrapper ds-rounded-top" >
				  <input type="hidden" name="data[Comment][type_id]" id="type_id" value="<?php echo isset($topic_id)?$topic_id:'0'; ?>">
				 <!--  <?php pr($topic_id) ?>  -->
...
function ajax_add_topic_comment(){
	$.ajax({ 
		url: web_base+"/topics/ajax_add_topic_comment",
