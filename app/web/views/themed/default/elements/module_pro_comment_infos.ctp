    	...
    	<div class="comment" style="width:100%;margin:0 auto 16px;">
			...
			<div id="ds-thread" class="am-cf">
			  <div id="ds-reset">
                ...
                <!-- <div class="ds-other-data">
                        ...
                        <div class="kind_detail">
    						...
    						<i class="W_ico16 icon_sw_img" id="pictureUploadButton"></i>
    							...
    							<?php foreach($sm['expression'] as $k=>$v){
    									echo "<div class='picks' id='[@F_".($k+1)."@]' style='background:#fff;width:24px;height:24px; float:left; border:1px solid #CECECE;cursor:pointer;'><img style='margin-left:0;vertical-align: top;' src='".($webroot)."theme/default/img/gif/F_".($k+1).".gif' title='".$v."' /></div>";
    								}?>
    						...
    						<div id="pictureFile" style="display:none;width:auto;position: absolute;background:#ffffff;z-index:9999;top:30px;" name="upfile">
    							<div id="pictureFilebox" name="upfile" style="width:100%;background:#fff;border:1px solid #ccc;">
    								<span style="cursor: pointer; height: 24px;float:right;top: 5px; width: 24px;"><img src="<?php echo $webroot; ?>theme/default/img/btn_close_img.png"/></span>
                     ...
                     <div class="am-u-lg-4 am-u-sm-6 am-text-right">
                        ...
                        <div class="func">
                            ...
                            <a style="margin-left:1px;cursor: pointer;position:relative;top:3px;"  onclick="checktoken('<?php echo $v['UserApp']['type']; ?>')" href="javascript:void(0);"><img id="<?php echo $v['UserApp']['type']; ?>_icon" src="<?php echo $webroot; ?>theme/default/img/<?php echo $v['img'] ?>" style="width:16px;height:16px;<?php echo $v['status']=='0'?'filter: Alpha(opacity=10);-moz-opacity:.1;opacity:0.3;':''; ?>" /></a>
                            <?php } ?>
                            </span>
                        </div>
                        <?php }?>
                     ...
                     <div class="am-u-lg-4 am-u-sm-12 am-text-right">
                        <div class="comm_is_public">
    						<input type="radio" style="position:relative;top:5px;" name="data[Comment][is_public]" value="0" checked /><span style="margin-right:5px;"><?php echo $ld['public'];?></span>
    						<input type="radio" style="position:relative;top:5px;" name="data[Comment][is_public]" value="1" /><span><?php echo $ld['anonymity'];?></span>
    					</div>
                        <div class="am-cf"></div>
                     </div>
                     <div class="am-cf"></div>
			   ...
			   <button id="res_btn" style="margin-top:10px;" class="ds-post-button am-fr am-btn am-btn-secondary" type="button" onclick="add_comment()"><?php echo $ld['comment'] ?></button>
			</div>
...
(function($) {
    var EventsList = function(element, options) {
      ...
      this.renderList = function(start, type) {
        ...
        $.getJSON(this.URL + start).then(function(data) {
          ...
          if(data.total==0){
          	  $("#product_comments").html("<div class='no_comments'>"+j_no_comments+"</div>");
    ...
    $(function() {
      var app = new EventsList(null, {
        api: web_base+'/products/ajax_product_comment',
        params: {
