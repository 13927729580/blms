			...
			<?php foreach($brand as $v){ ?>
					<li>
				        <div class="am-gallery-item">
				          <a title="<?php echo $v['BrandI18n']['name'] ?>" href="<?php echo $html->url('/brands/'.$v['Brand']['id']); ?>"><?php echo $html->image($v['BrandI18n']['img01']); ?></a>
			  ...
			  <li>
		        <div class="am-gallery-item">
				  ...
				  <span class="like_icon am-gallery-like" style="">
				  	  <?php echo $html->image('/theme/default/img/like_icon.png',array('id'=>$p['Product']['id']));  ?>
			  ...
			  <?php $si=0;$sp_flagnum=0;foreach($sv as $s_v){ ?>
				<li>
			  	  <div class="am-gallery-item">
			  	    <?php if(isset($configs['show_product_like'])&&$configs['show_product_like']=='1'){ ?>
					<span class="like_icon am-gallery-like" style="">
						<?php echo $html->image('/theme/default/img/like_icon.png',array('id'=>$s_v['Product']['id']));  ?>
			...
			<?php foreach($brand as $v){ ?>
				<li class="am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
					<div class="am-col am-u-sm-4 am-list-thumb">
			  			<a title="<?php echo $v['BrandI18n']['name'] ?>" href="<?php echo $html->url('/brands/'.$v['Brand']['id']); ?>"><?php echo $html->image($v['BrandI18n']['img01'],array('style'=>'width:210px;height:210px;'));  ?></a>
					</div>
