...
<script>
	var auto_zoom = document.querySelector('.auto_zoom');
	if(auto_zoom.offsetHeight < 60){
		console.log('111')
		auto_zoom.style.height = 60+"px";
	}
</script>
<?php //pr($sm);?>
<div id="article_recommend" class="am-u-md-3 am-rencommed am-fr">
  ...
  <ul class="am-list am-avg-sm-1">
	...
	<li class="am-padding-vertical-xs <?php echo (isset($zhou_cats) && $zhou_cats[0]==$v['Article']['id'])?'current':''?>">
	  <div class="am-u-lg-5 am-u-md-4 am-u-sm-3"  style="padding-left: 0px;">
