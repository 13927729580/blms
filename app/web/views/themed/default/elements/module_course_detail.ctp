                ...
                <div class="am-tabs" data-am-tabs>
                    ...
                    <div class="am-tabs-bd">
                        <div class="am-tab-panel am-fade am-in am-active" id="course_chapter">
						  ...
						  ?>
                                                    <li class="am-padding-left-lg <?php echo isset($class_access_permission['code'])&&$class_access_permission['code']!='1'||($access_result['code']=='-1'&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')||((!isset($sm['course_log'])||empty($sm['course_log']))&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')?'course_class_error':''; ?>" <?php if(isset($class_access_permission['code'])&&$class_access_permission['code']!='1'||($access_result['code']=='-1'&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')||((!isset($sm['course_log'])||empty($sm['course_log']))&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')){ ?><?php }else{?> onclick="read_course_detail(this,'<?php echo $sm['course_data']['id']; ?>','<?php echo $vv['id']; ?>');" <?php }?>>
                                                    		<span><a class="keshi <?php echo isset($class_access_permission['code'])&&$class_access_permission['code']!='1'||($access_result['code']=='-1'&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')||((!isset($sm['course_log'])||empty($sm['course_log']))&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')?'course_class_error':''; ?>" href="<?php echo isset($class_access_permission['code'])&&$class_access_permission['code']=='1'||($access_result['code']=='-1'&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')||((!isset($sm['course_log'])||empty($sm['course_log']))&&isset($sm['course_data']['allow_learning'])&&$sm['course_data']['allow_learning']=='0')?$html->url('/courses/detail/'.$sm['course_data']['id'].'/'.$vv['id']):'javascript:void(0);'; ?>" onclick="return false;"><?php echo $vv['name']; ?></a></span>
