<script src="<?php echo $webroot.'theme/default/js/ckplayer6.3/js/youku_jsapi.js?ProjectVersion='.ProjectVersion; ?>" type="text/javascript"  charset="utf-8"></script>
<script src="<?php echo $webroot.'theme/default/js/ckplayer6.3/ckplayer/ckplayer.js?ProjectVersion='.ProjectVersion; ?>" type="text/javascript"  charset="utf-8"></script>
    ...
    <?php if(isset($sm)){?>	
		...
		<?php if(!isset($sm['Article'])||($sm['Article']['video']==""&&$sm['Article']['upload_video']=="")){ ?>
			...
			<div class="this_video">
				<a href="javascript:void(0);" onclick="no_video()">
				<?php echo $html->image(isset($video['ArticleI18n']['img01'])&&$video['ArticleI18n']['img01']!=""?$video['ArticleI18n']['img01']:'/theme/default/img/shipin_1.jpg',array('style'=>'width:100%; height:100%;'));  ?>
				</a>
			</div>
		<?php }else{
			...
			<div class="this_video" >
				...
				<?php echo $html->image(isset($sm['ArticleI18n']['img01'])&&$sm['ArticleI18n']['img01']!=""?$sm['ArticleI18n']['img01']:'/theme/default/img/shipin_1.jpg');  ?>
				</a>
			</div>
		<?php }}?>
		<!--视频播放 end-->
...
$(function(){
	if(document.getElementById("a1")){
		...
		<?php
			...
			?>
				var flashvars={
					f:web_base+"/articles/video_play/<?php echo $sm['Article']['id'];?>",
					s:'0',
					c:0,
					b:1
				};
					...
					*/
					...
					if (!Sys.firefox){
						var video=[web_base+"/articles/video_play/<?php echo $sm['Article']['id'];?>->video/mp4"];
		...
		var params={bgcolor:'#FFF',allowFullScreen:true,allowScriptAccess:'always', wmode: 'transparent'};
		CKobject.embedSWF(web_base+'/theme/default/js/ckplayer6.3/ckplayer/ckplayer.swf','a1','ckplayer_a1','100%','423',flashvars,params);
		<?php } ?>
