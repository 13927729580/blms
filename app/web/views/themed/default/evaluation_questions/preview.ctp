<div class="am-g uploadquestion_preview">
	<?php echo $form->create('evaluation_questions',array('action'=>'/batch_upload'));?>
			...
			<tr>
				...
				<?php
						if(isset($fields_desc)&&!empty($fields_desc)){foreach($fields_desc as $kk=>$vv){
								...
								$field_model=isset($field_codes[1])?$field_codes[0]:'UserQuestionOption';
		...
		<div class='btnouterlist'>
			<div class="am-u-lg-1 am-u-md-2 am-u-sm-3" style="padding:0;">
