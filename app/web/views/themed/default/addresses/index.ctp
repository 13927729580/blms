<style>#address_form select,#address_form input{border-radius:4px;}
...
<div style="text-align:left;font-size:20px;border-bottom:1px solid #ccc;padding-bottom:1rem;margin-top:1%;padding-left:5px;margin-bottom:1rem;" >
	<span style="float:left;"><?php echo '地址簿' ?></span>
	<div class="am-cf"></div>
</div>
<div class="am-panel am-panel-default">
  <?php $i=1;if(isset($this->data['user_address']) && !empty($this->data['user_address'])) foreach($this->data['user_address'] as $k=>$v){?>
  <div class="am-panel-bd">
	...
	<table cellpadding="0" cellspacing="0" style="margin-left:4.5rem">
		...
		<div class="am-icon-check-circle"></div>
		<tr>
			<td >
...
<div class="am-cf am-user" style="width:95%;height:40px;margin:0 auto;font-size:15px;padding:6px;color:#0e90d2;">
	...
	<div class="am-form-detail am-address">
	  <div class="am-form-group">
		...
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <input style="width:200px;margin-left: 5px;" type="text" name="data[address][consignee]" chkRules="nnull:<?php echo $ld['consignee_not_empty']?>;"/>
	  ...
	  <div class="am-form-group">
		...
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  ...
		  <span id="regionsupdate">
			<select style="margin-left: 5px;" gtbfieldid="1" name="data[Address][RegionUpdate][0]" id="region" onchange="reload_region(this)" chkRules="region:<?php echo $ld['j_please_select']?>;">
			  <option><?php echo $ld['state_province']?></option>
			  <option>...</option>
			</select>
			<select gtbfieldid="2" name="data[Address][RegionUpdate][1]" onchange="reload_region(this)">
			  <option><?php echo $ld['city']?></option>
			  <option>...</option>
			</select>
			<select gtbfieldid="3" name="data[Address][RegionUpdate][2]" onchange="reload_region(this)">
	  ...
	  <div class="am-form-group">
		...
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <input style="margin-left: 5px;" class="" type="text" name="data[address][address]" chkRules="nnull:<?php echo $ld['address_empty']?>;" value="<?php echo isset($address['UserAddress']['address'])?$address['UserAddress']['address']:'';?>"/>
		  <em style="margin-top: 5px;"><font style="font-style: normal;"><?php echo $ld['view_etailed_distribution_range']?></font><font color="red">*</font></em>
		</div>
	  </div>
	  <div class="am-form-group">
		<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label"><?php echo $ld['address_to']?></label>
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8"><input style="margin-left: 5px;" class="" type="text" name="data[address][sign_building]"  value="<?php echo isset($address['UserAddress']['sign_building'])?$address['UserAddress']['sign_building']:'';?>"/></div>
	  </div>
	  <div class="am-form-group">
		<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label"><?php echo $ld['zip']?></label>
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <input style="margin-left: 5px;" type="text" name="data[address][zipcode]" maxlength='6' chkRules="zip_code:<?php echo $ld['zipcode_incorrectly']?>"  value="<?php echo isset($address['UserAddress']['zipcode'])?$address['UserAddress']['zipcode']:'';?>"/>
		  <em><font color="red"></font><font></font></em>
		</div>
	  </div>
	  <div class="am-form-group">
		...
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <input style="margin-left: 5px;" type="text"  name="data[address][telephone]"  id="telephones" placeholder="" chkRules="must_one:<?php echo $ld['mobile_and_fixed_telephone_at_least_one_required']?>:mobiles;tel:<?php echo $ld['telephone_incorrectly_completed']?>"  value="<?php echo isset($address['UserAddress']['telephone'])?$address['UserAddress']['telephone']:'';?>"/>
		  <em style="margin-top: 5px;"><font><?php echo $ld['please_fill_in_the_code']?></font><font color="red">*</font></em>
		</div>
	  </div>
	  <div class="am-form-group">
		<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label"><?php echo $ld['mobile']?></label>
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <input style="margin-left: 5px;" type="text" name="data[address][mobile]" id="mobiles"  chkRules="must_one:<?php echo $ld['mobile_and_fixed_telephone_at_least_one_required']?>:telephones;mobile:<?php echo $ld['phone_incorrectly_completed']?>"  value="<?php echo isset($address['UserAddress']['mobile'])?$address['UserAddress']['mobile']:'';?>"/>
		  <em style="margin-top: 5px;"><font><?php echo $ld['mobile_and_fixed_telephone_at_least_one_required']?></font><font color="red">*</font></em>
		</div>
	  </div>
	  <div class="am-form-group">
		<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label"></label>
		<div class="am-u-lg-8 am-u-md-9 am-u-sm-8">
		  <button style="margin-left: 5px;" type="submit" style="width:110px" class="am-btn am-btn-secondary"><?php echo $ld['user_save']?></button>
		</div>
	  </div>
	</div>
	<?php echo $form->end();?>
...
<style>
 .am-u-lg-9.am-u-md-8.am-u-sm-12 .am-panel.am-panel-default .am-panel-bd {
    padding: 5px 0;
