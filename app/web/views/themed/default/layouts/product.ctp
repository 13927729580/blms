...
?>
<!-- content -->
<?php if(($this->params['controller']=="products" && $this->params['action']="view")|| $this->params['controller']=="categories" || $this->params['controller']=="topics" || $this->params['controller']=="articles" || $this->params['controller']=="brands" || $this->params['controller']=="carts"){ ?>
...
?>
<?php echo $this->element('popup_login_register');?>
