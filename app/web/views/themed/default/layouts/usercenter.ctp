...
<div id="wrapper">
	...
	<div class="am-cf am-g am-g-fixed">
		...
		<?php echo $this->element('users_menu');echo $this->element('users_offcanvas');	?>
		<div class="am-u-lg-9 am-u-md-8 am-u-sm-12" style="background:#fff;padding:0;">
		  <button style="margin:1rem;margin-left:0;" class="am-btn am-btn-sm am-btn-secondary am-show-sm-only" data-am-offcanvas="{target: '#doc-oc-demo2', effect: 'push'}"><span ><?php echo $ld['user_center'];?></span> </button>
