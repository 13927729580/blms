...
?>
<!-- content -->
<?php if(($this->params['controller']=="products" && $this->params['action']="view")|| $this->params['controller']=="categories" || $this->params['controller']=="topics" || $this->params['controller']=="articles" || $this->params['controller']=="brands" || $this->params['controller']=="carts" || $this->params['controller']=="promotions" || $this->params['controller']=="courses" || $this->params['controller']=="evaluations" || $this->params['controller']=="evaluation_categories" || $this->params['controller']=="course_categories"){ ?>
<div class="am-g am-g-fixed"><?php echo $this->element("ur_here");?><?php echo $content_for_layout;?></div>
<?php }else{?>
