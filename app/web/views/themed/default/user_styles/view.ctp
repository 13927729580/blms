...
function get_StyleTypeGroup(){
    ...
    if(product_style_id!="0"&&product_type_id!="0"){
        $.ajax({ 
                    // url:"<?php echo $html->url('/user_styles/get_StyleTypeGroup'); ?>",
                    url:web_base+"/user_styles/get_StyleTypeGroup",
                	type:"POST",
                	dataType:"json",
...
function user_style_attr_value(){
    ...
    if(product_style_id!="0"&&product_type_id!="0"&&group_name!="0"){
        $.ajax({ 
                    // url:"<?php echo $html->url('/user_styles/user_style_attr_value'); ?>",
                    url:web_base+"/user_styles/user_style_attr_value",
                	type:"POST",
                	dataType:"html",
