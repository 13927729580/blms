...
<div class="am-g am-g-fixed" id="Commodity_review">
  <div class="am-panel am-panel-default" style="margin-top:10px;">
	<div class="am-panel-hd my-head">页面评论</div>
			...
			<div id="ds-thread" class="am-cf" style="margin-top: 5px;">
			  <div id="ds-reset">
				<div class="ds-textarea-wrapper ds-rounded-top" >
				  <input type="hidden" name="data[Comment][type_id]" id="type_id" value="<?php echo isset($page_id)?$page_id:'0'; ?>">
				 <!--  <?php pr($page_id) ?> -->
...
function ajax_add_page_comment(){
	$.ajax({ 
		url: web_base+"/pages/ajax_add_page_comment",
