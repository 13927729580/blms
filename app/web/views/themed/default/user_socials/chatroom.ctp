		...
		$.ajax({ url:web_base+ "/user_socials/private_comment/",
	    		...
	    		success: function(data){
	    			if(data=="1"){
						...
						var show_html='<li class="am-comment"><a target="_blank" href="javascript:void(0);"><?php echo $html->image($_SESSION["User"]["User"]["img01"]!=""?$_SESSION["User"]["User"]["img01"]:"/theme/default/img/no_head.png",array("class"=>"am-comment-avatar","style"=>"width:48px;height:48px;"));  ?></a><div class="am-comment-main"><header class="am-comment-hd"><div class="am-comment-meta"><time>'+time_str+'</time></div></header><div class="am-comment-bd">'+text+'</div></div></li>';
