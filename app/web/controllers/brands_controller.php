...
class BrandsController extends AppController
{
    ...
    public function index($page = 1)
    {
    	 ...
    	 $first_letter_keyword=isset($_REQUEST['first_letter_keyword'])?$_REQUEST['first_letter_keyword']:'';
    	 $brand_keyword=isset($_REQUEST['brand_keyword'])?$_REQUEST['brand_keyword']:'';
        $this->ur_heres[] = array('name' => $this->ld['brand_list'] , 'url' => '/brands');
        $this->set('ur_heres', $this->ur_heres);
        $this->params['page'] = $page;
        $this->params['first_letter_keyword'] = $first_letter_keyword;
        $this->params['brand_keyword'] = $brand_keyword;
