...
//$_SESSION["appid"]    = "100253260"; 

//申请到的appkey
//$_SESSION["appkey"]   = "yourappkey"; 
//$_SESSION["appkey"]   = "ff40789347d9f383917b86139c0d6a93"; 

//QQ登录成功后跳转的地址,请确保地址真实可用，否则会导致登录失败。
//$_SESSION["callback"] = "http://your domain/oauth/get_access_token.php"; 
//$_SESSION["callback"] = "http://zhouquan.t.seevia.dev/demo/qq/oauth/qq_callback.php";
...
function reset_app($appid,$appkey,$callback,$scope){
	//申请到的appid
	//$_SESSION["appid"]    = yourappid; 
