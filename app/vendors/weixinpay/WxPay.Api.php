<?php
include dirname(__FILE__)."/WxPay.Exception.php";
include dirname(__FILE__)."/WxPay.Config.php";
include dirname(__FILE__)."/WxPay.Data.php";
include dirname(__FILE__)."/WxPay.NativePay.php";
include dirname(__FILE__)."/WxPay.Notify.php";
include dirname(__FILE__)."/WxPay.JsApiPay.php";
...
class WxPayApi
{
     ...
     */
    public static function sendRedPack (WxPayRedPackData $inputObj, $timeOut = 6){
		$url = 'https://api.mch.weixin.qq.com/mmpaymkttransfers/sendredpack';
		$inputObj->SetMchBillno("redpack" . time()  . rand(0, 1000));
	...
	{		
		...
		if($useCert == true){
			$SSLCERT_PATH=WWW_ROOT.'app/vendors/weixinpay/cert/apiclient_cert.pem';
			$SSLKEY_PATH=WWW_ROOT.'app/vendors/weixinpay/cert/apiclient_key.pem';
			//设置证书
 ...
 *
 */
class WxPayRedPackData extends WxPayDataBase
{
