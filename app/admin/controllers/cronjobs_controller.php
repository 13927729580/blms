...
class CronjobsController extends AppController
{
	...
	if (isset($this->params['url']['system_code']) && $this->params['url']['system_code'] != '') {
		$condition['Cronjob.system_code'] = $this->params['url']['system_code'];
	$this->set('system_code', $this->params['url']['system_code']);
	}
	if (isset($this->params['url']['module_code']) && $this->params['url']['module_code'] != '') {
		$condition['Cronjob.module_code'] = $this->params['url']['module_code'];
    ...
    function system_modified(){
		...
		$cronjob_id=isset($_POST['id'])?$_POST['id']:0;
		$system_code=isset($_POST['val'])?trim($_POST['val']):'';
		$this->Cronjob->save(array('id'=>$cronjob_id,'system_code'=>$system_code));
		$result['flag'] = 1;
      ...
      function module_modified(){
		...
		$this->Cronjob->save(array('id'=>$cronjob_id,'module_code'=>$module_code));
		$result['flag'] = 1;
