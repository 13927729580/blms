...
//	     	}
    ...
    public function remove($id=0)
    {
        ...
        $advertisement_info=$this->Advertisement->find('first',array("conditions"=>array("Advertisement.id"=>$id)));
        if(!empty($advertisement_info)){
	        ...
	        $this->redirect("/advertisement_positions/view/".$advertisement_info['Advertisement']['advertisement_position_id']);
        }else{
