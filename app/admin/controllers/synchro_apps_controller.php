...
class SynchroAppsController extends AppController
{
    ...
    public $user_apps = array('QQ' => 'QQ','SinaWeibo' => 'SinaWeibo','QQWeibo' => 'QQWeibo','Facebook' => 'Facebook','Google' => 'Google','Wechat' => 'Wechat','QYWechat'=>'QYWechat');
    ...
    public function index($page = 1)
    {
        ...
        $data = $this->UserApp->find('all', array('conditions' => $condition, 'order' => 'UserApp.status desc,UserApp.id'));
        $this->set('data', $data);
    }
    ...
    protected function fun_outh()
    {
        ...
        $this->user_apps_type['QYWechat'] = $this->ld['qywechat'];
    }
