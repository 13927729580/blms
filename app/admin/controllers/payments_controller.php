...
class PaymentsController extends AppController
{
    ...
    function remove($payment_id=0){
        	...
        	$child_payment_ids=$this->Payment->find('list',array('conditions'=>array('Payment.parent_id'=>$payment_id)));
        	if(!empty($child_payment_ids)){
        		$this->PaymentI18n->deleteAll(array('PaymentI18n.payment_id'=>$child_payment_ids));
        		$this->Payment->deleteAll(array('Payment.id'=>$child_payment_ids));
        	}
        	$this->PaymentI18n->deleteAll(array('PaymentI18n.payment_id'=>$payment_id));
        	$this->Payment->deleteAll(array('Payment.id'=>$payment_id));
        	$result['flag'] = 1;
