...
class brand extends AppModel
{
    ...
    {
        $brand_list = $this->find('all', array('conditions' => array('Brand.status' => 1, 'BrandI18n.locale' => $locale), 'fields' => array('Brand.id', 'BrandI18n.name', 'Brand.code'), 'order' => 'BrandI18n.name asc'));
