...
<div class="am-g" style="margin-left:0;margin-right:0;">
	...
	<div class="btnouter am-text-right" data-am-sticky="{top:'100px',animation:'slide-top'}" style="margin-bottom:0;">
		...
		<div class="am-panel-group am-u-lg-10 am-u-md-9 am-u-sm-8 am-fr" style="width:100%;padding-left:0;padding-right:0;">
		<!--基本信息-->
			   <div id="basic_information" class="am-panel am-panel-default ">
				...
				<div class="am-in">
					<div class="am-panel-bd am-form">
						      <div class="am-g">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label-text"><?php echo $ld['name']?></label>
						...
						<div class="am-g">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label-text"><?php echo $ld['sort']?></label>
							<div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
						...
						<div class="am-g"  style="margin-top:10px;">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3" style="margin-left:10px;margin-top:2px;"><?php echo $ld['status']?></label>
							<div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
									...
									<div class="am-panel am-panel-default am-panel-header">
										<div class="am-panel-hd">
											<div class="am-panel-title">
												...
												<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;">规格</div>
												<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;"><?php echo $ld['sort']?></div>
												<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;"><?php echo $ld['status']?></div>
												<div class="am-u-lg-2 am-u-md-3 am-u-sm-4" style="padding-left:0;"><?php echo $ld['operate']?></div>
										...
										<div>	
											<div class="am-panel am-panel-default am-panel-body">
												<div class="am-panel-bd">
													...
													<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;"><?php echo $sv['StyleTypeGroup']['group_name'];?>&nbsp;</div>
													<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;"><?php echo $sv['StyleTypeGroup']['orderby'] ?>&nbsp;</div>
													<div class="am-u-lg-2 am-u-md-2 am-u-sm-1" style="width:10%;">
													...
													<div class="am-u-lg-2 am-u-md-3 am-u-sm-4" style="padding-right:0;padding-left:0;">
