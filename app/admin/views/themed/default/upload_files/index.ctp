<div class="listsearch">
    ...
    <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-3" style="margin:10px 0 0 0;">
        ...
        <li style="margin:0 0 10px 0">
            <label class="am-u-sm-3 am-u-lg-2 am-u-md-2 am-form-label-text" style="padding-left:0;padding-right:0.5rem;"><?php echo $ld['posted_time']?></label>
            <div class="am-u-sm-3 am-u-lg-3 am-u-md-3 " style="padding:0 0rem;width:33%;">
            ...
            <?php foreach($uploadfiles as $k=>$v){?>
                <tr>
                   ...
                   <td  class="am-hide-sm-down"><?php echo $v['Document']['orderby'];?></td>
                    ...
                    <?php  }?> <a class="am-btn am-btn-default am-btn-xs am-text-danger  am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'upload_files/remove/<?php echo $v['Document']['id'] ?>')">
