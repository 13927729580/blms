            ...
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table">
                    <tr>
                     ...
                     <tr> 
                        <th><lable class="am-u-lg-6 am-form-label" style="padding-top:10px;"><?php echo $ld['file_name']?></lable></th>
                        <td class="am-u-lg-6"><input  type="text" name="file_nick" /></td>
                    </tr>
                    <tr>
                     <th><lable class="am-u-lg-6 am-form-label"><?php echo $ld['sort']?></lable></th>
                        <td class="am-u-lg-6"><input name="file_sort" type="text"/></td>
                    </tr>
                </table>
