        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table" id="hotel_img_ul">
                    <tr>
                        <th style="width: 20%;"><?php echo $ld['module']?></th>
                        <td>
                            <div style="width: 50%;">
                    ...
                    <tr>
                        <th style="padding-top:15px;width: 20%;"><?php echo $ld['page_name']?></th>
                        <td>
                            <input type="text" style="width:50%;float:left;" name="data[PageAction][name]" value="<?php if(isset($page_action_info['PageAction'])){echo $page_action_info['PageAction']['name'];} ?>" /><em>*</em>
                        </td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px;"><?php echo $ld['controller']?></th>
                        <td><input type="text" style="width:50%;float:left;" name="data[PageAction][controller]" value="<?php if(isset($page_action_info['PageAction'])){echo $page_action_info['PageAction']['controller'];} ?>" /><em>*</em></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px;"><?php echo $ld['function']?></th>
                        <td><input type="text" style="width:50%;float:left;" name="data[PageAction][action]" value="<?php if(isset($page_action_info['PageAction'])){echo $page_action_info['PageAction']['action'];} ?>" /><em>*</em></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px;">布局</th>
                        <td><input type="text" style="width:50%;float:left;" name="data[PageAction][layout]" value="<?php if(isset($page_action_info['PageAction'])){echo $page_action_info['PageAction']['layout'];} ?>" /><em>*</em></td>
                    </tr>
                    <tr>
