            ...
            foreach($bloginfo as $k){
                ...
                <tr>
                    ...
                    <td> <?php if($svshow->operator_privilege("showblogs_reomve")){
                            echo $html->link($ld['delete'],"javascript:;",array("class"=>"am-btn am-btn-default am-text-danger am-btn-xs am-radius","onclick"=>"list_delete_submit('{$admin_webroot}Blogs/remove/{$k['Blog']['id']}');"));
                        }?>
                   </td>
                </tr>
            <?php
