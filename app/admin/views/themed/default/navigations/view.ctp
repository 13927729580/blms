...
.am-u-lg-3.am-u-md-3.am-u-sm-3.am-form-group-label{padding-left: 0;}
.am-selected.am-dropdown{margin-left: 10px;}
.am-selected.am-dropdown button{margin-right: 10px;}
.am-selected.am-dropdown {margin-left: 0;}
			...
			<div id="basic_information" class="am-panel am-panel-default">
			    ...
			    <div class="am-panel-collapse am-collapse am-in">
                	...
                	<div class="am-form-group">
    		    			...
    		    			<div class="am-u-lg-8  am-u-md-8 am-u-sm-8">
    		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
    		    					<select data-am-selected id='type' name="data[Navigation][type]" onChange="searchType(this.value,'<?php echo !empty($this->data['Navigation']['parent_id'])?$this->data['Navigation']['parent_id']:'0';?>',<?php echo isset($this->data['Navigation']['id'])?$this->data['Navigation']['id']:0; ?>)">
               		...
               		<div class="am-form-group">
    		    			...
    		    			<div class="am-u-lg-8  am-u-md-8 am-u-sm-8">
    		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9"   >
    								...
    								<select data-am-selected id="data[Navigation][controller]" name="data[Navigation][controller]" onChange="setNa()"  >
    								...
    								<div id='p_category_div' style="display:none;margin-top:10px;">
    									<select data-am-selected id='p_category' onChange="changeNa(this.value)">
    								...
    								<div id='a_category_div' style="display:none;margin-top:10px;">
    									<select data-am-selected id='a_category' onChange="changeNa(this.value)">
    										<option value="0"><?php echo $ld['please_select'];?></option>
    								...
    								<div id='brand_div' style="display:none" >
    									<select data-am-selected id='brand'   onChange="changeNa(this.value)">
    										<option value="0"><?php echo $ld['please_select'];?></option>
    								...
    								<div id='topic_div' style="display:none" >
    									<select data-am-selected id='topic'   onChange="changeNa(this.value)">
    										<option value="0"><?php echo $ld['please_select'];?></option>
    								...
    								<div id='pro_div' style="display:none;" >
    									<select data-am-selected id='promotion'  onChange="changeNa(this.value)">
    										<option value="0"><?php echo $ld['please_select'];?></option>
    					...
    					<div class="am-form-group">
	    		    			...
	    		    			<div class="am-u-lg-5 am-u-md-6 am-u-sm-6">
	    		    				<div id="order_div" class="am-g" style="margin-left: 20px;">
    				...
    				<div class="am-form-group">
    		    		...
    		    		<div class="am-form-group">
    		    			<label class="am-u-lg-2 am-u-md-2 am-u-sm-4 am-form-group-label"><?php echo "SEO".$ld['attribute']?></label>
    		    			<div class="am-u-lg-8  am-u-md-8 am-u-sm-8">
    		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
    		    					<input type='text' name="data[Navigation][seo_attribute]" value='<?php echo isset($this->data['Navigation']['seo_attribute'])?preg_replace('/\'/','&#39;',preg_replace('/\"/','&#34;',$this->data['Navigation']['seo_attribute'])):''; ?>' maxlength='100' />
    		    				</div>
    		    			</div>
    		    		</div>
...
function search(a){ 
	...
	if(key.trim()==""){
		alert("<?php echo $ld['z_prompt3']; ?>");return false;
	}
	var num = document.getElementById("lan").value;
    	$.ajax({
