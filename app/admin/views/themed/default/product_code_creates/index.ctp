		      		...
		      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">	
						<div class="am-form-group">
							...
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
								<select id="brand_code" data-am-selected="{noSelectedText:'<?php echo $ld['please_select']; ?>',maxHeight:300}">
			            ...
			            <div class="am-form-group">
							...
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
								<select id="category_type_id" data-am-selected="{noSelectedText:'<?php echo $ld['please_select']; ?>',maxHeight:300}">
									<option value=''><?php echo $ld['please_select'] ?></option>
			             ...
			             <div class="am-form-group">
							...
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
								<select id="category_id" data-am-selected="{noSelectedText:'<?php echo $ld['please_select']; ?>',maxHeight:300}">
									<option value=''><?php echo $ld['please_select'] ?></option>
