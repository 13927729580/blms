...
.fs12{font-size:12px;}
.input_detail{resize:none;height:78px; width:511px;top:13px;position:relative;left:0px;overflow:hidden;}
.text_center{text-align:center;}
.w550h162{border:1px solid #ccc;width:550px;height:162px;}
.w550h40{border-bottom:1px solid #ccc;width:550px;height:40px;}
.face{cursor:pointer;margin-left:10px;line-height:40px;}
.face img{position:relative;top:-1px;left:0px;}
.expression{width:250px;display:none; position:absolute;top: 40px;left:6px;z-index: 100;}
.picks{width:25px;height:25px; float:left; border:1px solid #CECECE;background:#fff;}
#biaoqingnew{cursor:pointer;margin-left:10px;line-height:40px;}
#biaoqingnew img{position:relative;top:-1px;left:0px;}
</style>
                ...
                <div class="tablelist am-u-md-12 am-u-sm-12" style="padding-bottom:0;">
                    ...
                    <table class="am-table  table-main">
                       ...
                       <?php if($svshow->operator_privilege("open_keywords_edit")){
                        if($v['OpenKeywordAnswer']['status']=='1'){
                      
                         echo '<span class="am-icon-check am-yes" style="cursor:pointer;" onclick=change_state(this,"open_keywords/toggle_on_answer_status",'.$v["OpenKeywordAnswer"]["id"].')></div>';
                        }else{
                       
                            echo '<div style="cursor:pointer;"  class="am-icon-close am-no" onclick=change_state(this,"open_keywords/toggle_on_answer_status",'.$v["OpenKeywordAnswer"]["id"].')></div>';
                        }
                    }else{
...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="answer" name="answer">
    <div class="am-modal-dialog">
        <div class="am-modal-hd" style="border-bottom:1px solid #ddd;"><?php echo $ld['reply'].$ld['add']?>
        ...
        <div class="am-modal-bd am-form">        
                <div class="am-g">
                    <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight">
                        <?php echo $ld['keyword']?>
                    </div>
                    <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                        <input type="text" class="border" disabled="disabled" style="width:50%" name="key" value="<?php echo $keyword ?>" />
                        <input type="hidden" name="data[OpenKeywordAnswer][keyword_id]" value="<?php echo $id ?>" />
                    </div>
                </div>
                <div class="am-g am-margin-top-xs">
                    <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4" style="line-height:32px;font-size:16px;">
                        <?php echo $ld['reply'].$ld['type']?>
                    </div>
                    <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                        <select id="seltypenew" onchange="showhide('new')" class="border" name="data[OpenKeywordAnswer][msgtype]" value="" data-am-selected="{btnWidth:'20%'}">
                            <option value="text" ><?php echo $ld['word']; ?></option>
                            <option value="picture"><?php echo $ld['graphics']; ?></option>
                        </select>
                    </div>
                </div>
                <div class="am-g am-margin-top-xs" id="picresourcenew" style="display:none;">
                    <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4" style="line-height:32px;"><?php echo $ld['graphic_resources']; ?>
                    </div>
                    <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                        <select id="typenew" class="border" name="data[OpenKeywordAnswer][element_id]" value="" data-am-selected="{btnWidth:'50%'}">
                ...
                <div class="am-g am-margin-top-xs" id="responsenew">
                    <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight"><?php echo $ld['reply']?></div>
                    <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                        <div class="w550h162">
                            <div class="w550h40" style="position:relative">
                                <span id="biaoqingnew" onclick="biaoqingclick()"><?php echo $html->image('/admin/skins/default/img/haha.png');echo $ld['expression'] ?></span>
                            </div>
                            <a class="S_func1" style="margin-left:5px;" suda-uatrack="key=tblog_new_image_upload&value=image_button" title="图片" action-data="type=508&action=1&log=image&cate=1" action-type="multiimage" href="javascript:void(0);" tabindex="3">
                                <div class="expression">
                                    ...
                                    foreach($Expression as $k3=>$v3){
                                        echo "<div class='picks' onclick=\"pclick('new',this)\" id='[@F_".($k3+1)."@]' >";
                                        echo $html->image('/admin/skins/default/img/gif/F_'.($k3+1).".gif",array('title'=>$v3,'style'=>'margin-left:0'));
                                        echo "</div>";
                                    }
                                    ?>
                ...
                <div class="am-g am-margin-top-xs" id="response1new">
...
<?php if(isset($key_list) && sizeof($key_list)>0){foreach($key_list as $k1=>$v1){?>
    <div class="am-modal am-modal-no-btn" tabindex="-1" name="answer<?php echo $v1['OpenKeywordAnswer']['id']?>" id="answer<?php echo $v1['OpenKeywordAnswer']['id']?>">
        <div class="am-modal-dialog">
            <div class="am-modal-hd" style="border-bottom:1px solid #ddd"><?php echo $ld['reply'].$ld['edit']?>
                <a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
            </div>
            ...
            <div class="am-modal-bd am-form">
                    ...
                    <div class="am-g">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight"><?php echo $ld['keyword']?></div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                            <input type="text" class="border" disabled="disabled" style="width:50%" name="key" value="<?php echo $keyword ?>" />
                            <input type="hidden" name="data[OpenKeywordAnswer][keyword_id]" value="<?php echo $id ?>" />
                        </div>
                    ...
                    <div class="am-g am-margin-top-xs">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight"><?php echo $ld['reply'].$ld['type']?></div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                            <select id="seltype<?php echo $v1['OpenKeywordAnswer']['id']?>" onchange="showhide(<?php echo $v1['OpenKeywordAnswer']['id']?>)" class="border" name="data[OpenKeywordAnswer][msgtype]" value="<?php if(isset($v1['OpenKeywordAnswer']['msgtype'])){echo $v1['OpenKeywordAnswer']['msgtype'];} ?>" data-am-selected="{btnWidth:'20%'}">
                    ...
                    <div class="am-g am-margin-top-xs" id="picresource<?php echo $v1['OpenKeywordAnswer']['id']?>" style="<?php if($v1['OpenKeywordAnswer']['msgtype']=='text'){ echo 'display:none';}?>">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight"><?php echo $ld['graphic_resources']; ?></div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                            <select id="type<?php echo $v1['OpenKeywordAnswer']['id']?>" class="border" name="data[OpenKeywordAnswer][element_id]" data-am-select="{btnWidth:'50%'}">
                    ...
                    <div class="am-g am-margin-top-xs"  id="response<?php echo $v1['OpenKeywordAnswer']['id']?>" style="<?php if($v1['OpenKeywordAnswer']['msgtype']=='picture'){ echo 'display:none';}?>">
                         <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight"><?php echo $ld['reply']?></div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7 am-text-left">
                            <div class="w550h162">
                                <div class="w550h40" style="position:relative">
                                    <span id="biaoqing<?php echo $v1['OpenKeywordAnswer']['id']?>" onclick="biaoqingclick()" class="face" ><?php echo $html->image('/admin/skins/default/img/haha.png');echo $ld['expression'] ?></span>
                                </div>
                                <a class="S_func1" style="margin-left:5px;" suda-uatrack="key=tblog_new_image_upload&value=image_button" title="图片" action-data="type=508&action=1&log=image&cate=1" action-type="multiimage" href="javascript:void(0);" tabindex="3">
                                    <div class="expression">
                                        <?php
                                        foreach($Expression as $k3=>$v3){
                                            echo "<div class='picks' onclick='pclick({$v1['OpenKeywordAnswer']['id']},this)' id='[@F_".($k3+1)."@]'>";
                                            echo $html->image('/admin/skins/default/img/gif/F_'.($k3+1).".gif",array('title'=>$v3));
                                            echo "</div>";
                                        }
                                        ?>
                                        <div style="clear:both"></div>
                    ...
                    <div class="am-g am-margin-top-xs" id="response1<?php echo $v1['OpenKeywordAnswer']['id']?>" style="<?php if($v1['OpenKeywordAnswer']['msgtype']=='picture'){ echo 'display:none';}?>">
...
<script>
 //状态切换
    ...
    var Url="<?php echo $server_host; ?>"+webroot+"/admin/img/gif/";//表情图片路径
    //表情数组
    ...
    function manage(){
        window.location.href=admin_webroot+"open_elements";
    }
