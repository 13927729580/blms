...
<div class="am-modal am-modal-no-btn" tabindex="-1" name="quick_reply" id="quick_reply">
    <div class="am-modal-dialog">
        <div class="am-modal-hd" style="border-bottom:1px solid #ddd"><?php echo $ld['quick_reply'];?>
...
<script type="text/javascript">
    function showquickreply(open_user_id,keyword_error_id){
        $.ajax({ url: admin_webroot+"open_users/quickreply/"+open_user_id,
            type:"POST",
