...
<?php echo $form->create('open_keywords',array('action'=>'/open_keyword_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"open_keywords/open_keyword_uploadpreview";
