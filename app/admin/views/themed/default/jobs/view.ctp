    ...
    <div id="basic" class="am-panel am-panel-default">
        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
                        ...
                        <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                        	<div class="am-u-lg-8 am-u-md-8 am-u-sm-10">
                             <input id="job_name_<?php echo $v['Language']['locale'];?>" name="data[JobI18n][<?php echo $k;?>][name]" type="text" value="<?php echo isset($this->data['JobI18n'][$v['Language']['locale']])?$this->data['JobI18n'][$v['Language']['locale']]['name']:'';?>" >
                            	...
                            	<label class="am-u-lg-2 am-u-md-2 am-u-sm-2 am-view-label" style="padding-left: 0;"><?php echo $ld[$v['Language']['locale']]?><em style="color:red;">*</em></label>
                            <?php }?>
                                <?php }}?>
                    	</div>
                    </div>
             <div class="am-form-group">
                    ...
                    <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                        ...
                        if($configs["show_edit_type"]){?>
                              <div><span class="ckeditorlanguage" style="right: -50px;"><?php echo $v['Language']['name'];?></span></div>
            ...
            <div class="am-form-group" style="margin-top:10px;">
                ...
                <div class="am-u-lg-8 am-u-md-8 am-u-sm-8" style="padding-left: 40px;">
				    <label class="am-radio am-success">
    			         <input type="radio" name="data[Job][status]" value="1" data-am-ucheck <?php echo !isset($this->data['Job']['status'])||(isset($this->data['Job']['status'])&&$this->data['Job']['status']==1)?"checked":"";?> ><?php echo $ld['yes']?>
                    </label>
...
<script type="text/javascript">
    ...
    function searchInforationresources(code){
        ...
        $.ajax({
        	url:admin_webroot+"information_resources/searchInforationresources/",
        	type:"POST",
        	data:{'code':code},
            datatype:'html',
    ...
    function removeInforationresources(id){
        ...
        //return;
    	$.ajax({
    		url:admin_webroot+"information_resources/removeInforationresources/",
    		type:"POST",
    		data:postData,
    		dataType:"json",
    		success:function(data){
    ...
    function editInforationresources(id){
    	...
    	$.ajax({
    		url:admin_webroot+"information_resources/editInforationresources/",
    		type:"POST",
    		data:postData,
    		dataType:"json",
    		success:function(data){
    ...
    function updateInformationresources(code){
    		...
    		$.ajax({
        		url:admin_webroot+"information_resources/updateInformationresources/",
        		type:"POST",
        		data:postData,
                dataType:"json",
        		success:function(data){
