    ...
    <link href="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/css/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/css/carousel.css" rel="stylesheet">
    <link href="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/css/echartsHome.css" rel="stylesheet">
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
      <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
      <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
    <script src="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/example/www/js/echarts.js"></script>
    <script src="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/js/codemirror.js"></script>
    <script src="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/js/javascript.js"></script>
    <link href="<?php echo $admin_webroot; ?>vendors/echarts-2.2.0/doc/asset/css/monokai.css" rel="stylesheet">
...
option = {
    ...
    <script src="<?php echo $admin_webroot ?>vendors/echarts-2.2.0/doc/asset/js/jquery.min.js"></script>

    <script src="<?php echo $admin_webroot ?>vendors/echarts-2.2.0/doc/asset/js/echartsExample.js"></script>
    <script>
