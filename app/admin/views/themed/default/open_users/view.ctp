            ...
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table">
                    <tr>
                        ...
                        <td><?php echo $html->image($this->data['OpenUser']['headimgurl'],array('style'=>'width:60px;height:60px;'));?></td>
                    </tr>
                    <tr>
                            ...
                            <?php if($msg['OpenUserMessage']['send_from'] == 1){?>
                                <?php if($msg['OpenUserMessage']['return_message']!=""){//系统进行了回复  ?>
                                    <div style="margin:5px;clear:both;height:80px;">
                                        <div style="float:right;margin:5px;"><?php echo $html->image($OpenModel_img,array('style'=>'width:60px;height:60px;'));?></div>
                                ...
                                <?php } ?>
                                <div style="margin:5px;clear:both;height:80px;">
                                    <div style="float:left;margin:5px;"><?php echo $html->image($this->data['OpenUser']['headimgurl'],array('style'=>'width:60px;height:60px;'));?></div>
                                    <div style="max-width:50%;float:left;margin-top:15px;padding:10px;border:1px solid #E1ECCE;background:none repeat scroll 0 0 #E9F8D9;">
                                        <?php if($msg['OpenUserMessage']['msgtype'] == 'image') {?>
                                            ...
                                            <a href="<?php echo $msg['OpenUserMessage']['message']?>" target="_blank"><?php echo $html->url($msg['OpenUserMessage']['message'],array('style'=>'width:60px;height:60px;')); ?></a>
...
<script type="text/javascript">
    ...
    function showquickreply(Id){
        $.ajax({ url: admin_webroot+"open_users/quickreply/"+Id,
            type:"POST",
            data:{},
            dataType:"html",
