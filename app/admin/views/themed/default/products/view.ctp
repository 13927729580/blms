<style type="text/css">
    ...
    .am-table>tbody>tr>th,.am-table>tbody>tr>td{border:none;}
    .am-modal-dialog .am-modal-hd{border-bottom:1px solid #ddd;}
...
<script src="<?php echo $webroot; ?>plugins/javascriptviewer_jso.js" type="text/javascript"></script>
...
<?php }}?>
<div class="am-panel-group admin-content am-u-lg-9 am-u-md-9 am-u-sm-9  am-detail-view am-fr"  id="accordion" style="width: 100%;">
<!-- 导航 -->
<div class="scrollspy-nav" data-am-scrollspy-nav="{offsetTop: 45}" data-am-sticky="{top:'52px',animation:'slide-top'}" style="margin-bottom:8px;">
    <ul>
        ...
        <?php if(isset($product_action_list)){ ?>
        <li><a href="#product_action_list"><?php echo $ld['operation_records']?></a></li>
        <?php } ?>
    </ul>
</div>
...
<div class="btnouter am-text-right" data-am-sticky="{top:'100px',animation:'slide-top'}" style="margin-bottom:0;">
        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table">
					...
					<!-- 商品关键词 -->
                    <tr>
                        <th  style="padding-top:14px;" rowspan="<?php echo count($backend_locales)+1;?>"><?php echo $ld['meta_keywords']?></th>
                    </tr>
                    <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                        <tr>
                    ...
                    <!--商品图片1-->
                    <tr>
                        <th style="margin-top:-3px;padding-top:16px;"><?php echo $ld['aspect_thumbnail']; ?></th>
                        <td>
                            <input type="text" style="width:200px;" id="product_image1" name="data[Product][product_image1]" value="<?php echo isset($product_info['Product']['product_image1'])?$product_info['Product']['product_image1']:''; ?>" />
                            <input type="button" class="am-btn am-btn-xs am-btn-success am-radius" onclick="select_img('product_image1')" value="<?php echo $ld['choose_picture']?>" style="margin-top:5px;"/>
                            <div class="img_select" style="margin-top:5px;">
                                <?php echo $html->image((isset($product_info['Product']['product_image1'])&&$product_info['Product']['product_image1']!="")?$product_info['Product']['product_image1']:$configs['shop_default_img'],array('id'=>'show_product_image1'))?>
                            </div>
                        </td>
                    </tr>
                    <!--商品图片2-->
                    <tr>
                        <th style="margin-top:-3px;padding-top:16px;"><?php echo $ld['aspect_enlarge']; ?></th>
                        <td>
                            <input type="text" style="width:200px;" id="product_image2" name="data[Product][product_image2]" value="<?php echo isset($product_info['Product']['product_image2'])?$product_info['Product']['product_image2']:''; ?>" />
                            <input type="button" class="am-btn am-btn-xs am-btn-success am-radius" onclick="select_img('product_image2')" value="<?php echo $ld['choose_picture']?>" style="margin-top:5px;"/>
                            <div class="img_select" style="margin-top:5px;">
                                <?php echo $html->image((isset($product_info['Product']['product_image2'])&&$product_info['Product']['product_image2']!="")?$product_info['Product']['product_image2']:$configs['shop_default_img'],array('id'=>'show_product_image2'))?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th style="margin-top:-3px;padding-top:16px;"><?php echo $ld['product_manager']; ?></th>
                        <td>
                        		<select name="data[Product][product_manager]" data-am-selected="{maxHeight:300}">
                        			...
                        			<option value="<?php echo $v['Operator']['id']; ?>" <?php echo isset($product_info['Product']['product_manager'])&&$product_info['Product']['product_manager']==$v['Operator']['id']?'selected':''; ?>><?php echo $v['Operator']['name']; ?></option>
                        			<?php }} ?>
                        		</select>
                        </td>
                    </tr>
                        ...
                        <td><input type="text" style="width:200px;margin-right:5px;float:left;" id="brand_keyword" style="width:30%;"/><input class="am-btn am-btn-success am-btn-sm" type="button" value="<?php echo $ld['search']?>"  onclick="search_brand()"/>
                            <div id='select_brand' style="margin-top:20px;">            
                                ...
                                <?php if($svshow->operator_privilege("products_add_brand")){?>
                                    <input class="am-btn am-btn-success am-radius am-btn-sm"   type="button" data-am-modal="{target: '#brand', closeViaDimmer: 0, width: 400, height: 230}" value="<?php echo $ld['quick_add_brand']?>" />
                                <?php }?>
                            </div></td>
                    </tr>
                    <!--商品分类-->
                    <tr>
                        ...
                        <td><div>
                                <select data-am-selected="{noSelectedText:'<?php echo $ld['please_select'] ?>',maxHeight:'300px'}" name="data[Product][category_id]" id="product_category_id">
                                ...
                                if($svshow->operator_privilege("products_add_category")){
                                    ?><input class="am-btn am-btn-success am-radius am-btn-sm" style="margin-left:4px;" type="button" data-am-modal="{target: '#productcat', closeViaDimmer: 0, width: 400, height: 230}" value="<?php echo $ld['quick_add_category']?>" /><em>*</em><?php
                                }?>
                            </div></td>
                    </tr>
                    <!--扩展分类-->
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                ...
                                <input type="button" class="am-btn am-btn-success am-radius am-btn-sm" data-am-modal="{target: '#productcattype', closeViaDimmer: 0, width: 400, height: 230}" value="<?php echo $ld['quick_add_category_type']?>" />
                            </div>
                        </td>
                    </tr>
                    ...
                    <?php if (isset($SVConfigs["show_purchase_price"])&&$SVConfigs["show_purchase_price"]==1){ ?>
                        <tr><th><?php echo $ld['purchase_price']?></th><td><input type="text" style="width:200px;" name="data[Product][purchase_price]" value="<?php echo isset($product_info['Product']['purchase_price'])?$product_info['Product']['purchase_price']:'';?>" /></td></tr>
                    <?php }?>
                    <!--本店售价-->
                    ...
                    <tr class="border_show">
                    	<th style="padding-top:15px;"><?php echo $ld['location_price'];?></th>
                    	<td>
                    		...
                    		<div class='am-g am-form-group'>
                    			<label class='am-form-label am-u-lg-2 am-u-md-2 am-u-sm-3'><?php echo $v; ?></label>
                    			<div class='am-u-lg-5 am-u-md-8 am-u-sm-8'><input type="hidden" name="data[ProductLocalePrice][locale][]" value="<?php echo $k;?>" /><input type="text" name="data[ProductLocalePrice][product_price][]" value="<?php echo isset($pro_price[$k])?$pro_price[$k]:'0';?>" style="width:50%;"/></div>
				   ...
				   <?php if(isset($configs['show_purchase_price'])&&$configs['show_purchase_price']=='1'){ ?>
                    ...
                    <!-- 租赁价 -->
                    <tr class="border_show">
                        <th style="padding-top:15px;"><?php echo $ld['lease_price'] ?></th>
                        <td><div class="am-fl">
                                <label class="am-checkbox am-success">
                                    <input type="checkbox" name="data[Product][lease_status]" id="lease_status" value="1" onclick="handleLease(this.checked);count_lease_price(this)" data-am-ucheck <?php if(isset($product_info['Product']['lease_status'])&&$product_info['Product']['lease_status']==1){echo "checked";}?> /></label>
                            </div>
                            <div class="am-fl">
                               <input style="width:178px;margin-right:5px;" type="text" name="data[ProductLease][lease_price]" id="lease_price" value="<?php echo isset($lease_price['ProductLeasePrice']['lease_price'])?$lease_price['ProductLeasePrice']['lease_price']:'';?>" onblur="chaxiao();change_lease_price()" />
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
                    <tr class="am-hide">
                        <th style="padding-top:15px;"><?php echo $ld['lease_deposit'] ?></th>
                        <td><input style="width:200px;margin-right:5px;" type="text" name="data[ProductLease][lease_deposit]" id="lease_deposit" value="<?php echo isset($lease_price['ProductLeasePrice']['lease_deposit_base'])?$lease_price['ProductLeasePrice']['lease_deposit_base']:'';?>" onblur="chaxiao()" /></td>
                    </tr>
                    <tr>
                    <th style="padding-top:15px;border-bottom:1px solid #ddd"><?php echo $ld['lease_days'] ?></th>
                    <td style="border-bottom:1px solid #ddd">
                        <input style="width:200px;margin-right:5px;" type="text" name="data[ProductLease][unit]" id="unit" value="<?php echo isset($lease_price['ProductLeasePrice']['lease_deposit_unit'])?$lease_price['ProductLeasePrice']['lease_deposit_unit']:'';?>" onblur="chaxiao()" />
                        </td>
                    </tr>
                    <!--会员价格-->
            ...
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal " style="padding-bottom:0;">
                                ...
                                <li>
                                    ...
                                    <div class="img_select" onclick="select_img('product_add_img_0<?php echo $j+1;?>')"><?php if(!isset($product_gallery[$j]['ProductGallery']['img_thumb'])){?><p style="padding-top:50px;" id="product_add_img_0<?php echo $j+1;?>_pic"><?php echo "+".$ld['add_picture'] ?></p><?php }?>
                                        ...
                                        <?php if(isset($product_gallery[$j]['ProductGallery']['img_thumb'])&&isset($img_thumb_format)&&count($img_thumb_format)==1){
                                            echo $html->image((isset($product_gallery[$j])&&$product_gallery[$j]['ProductGallery']['img_thumb']!="")?IMG_HOST.$product_gallery[$j]['ProductGallery']['img_thumb']:"/admin/skins/default/img/default_no_photo.png",array('id'=>"show_product_add_img_0$k","onclick"=>"select_img('product_add_img_0$k')"));
                                        }else{
                                            echo $html->image((isset($product_gallery[$j])&&$product_gallery[$j]['ProductGallery']['img_thumb']!="")?$product_gallery[$j]['ProductGallery']['img_thumb']:"/admin/skins/default/img/default_no_photo.png",array('id'=>"show_product_add_img_0$k","onclick"=>"select_img('product_add_img_0$k')"));
                                        }?>
                                    </div>
                ...
                <?php if(!empty($product_info['Product']['code'])){ ?>
                    <div class="am-g" style="margin:16px auto;border-bottom: 1px solid #eee;">
                        <h4 class="am-panel-title"><span class="rotate_logo am-icon-cog am-icon-check" style="color:green;cursor: pointer;"></span><?php echo $ld['rotate_picture']; ?></h4>
                    </div>
                    <div style="margin-top:1.5em;" class="rotate_list">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <div id="image_holder_x" class="imageholder">
                                        ...
                                        <?php echo $html->image($pro_360_defaultImg,array('style'=>'width:150px;height:150px;','id'=>'product_image_x')); ?>
                                    </div>
                                ...
                                <td><p class="action-span" style="text-align:left;padding-left:0.5em;"><a class="addbutton" href="javascript:;" onclick="upload_img('<?php echo $product_info['Product']['code'];?>')"><?php echo $ld['upload_wheel']?></a><span>(<?php printf($ld['please_upload_number_jpg'],'72'); ?>)</span></p></td>
                            </tr>
                        </table>
                    </div>
                <?php } ?>
        ...
        <div id="advanced_set_up" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table" id="product_url">
                    ...
                    <?php if(isset($configs['point-equal'])){ ?>
                        ...
                        <tr>
                            ...
                            <td><input type="hidden" id="point" value="<?php
                                ...
                                ?>"> <input style="width:200px;" type="text" name="data[Product][point_fee]" id="point_fee" value="<?php
                    ...
                    <!-- 是否发送订阅 -->
                    <?php //pr($product_info['Product']); ?>
                    <tr>
                        <th><?php echo $ld['is_send_subscription']?></th>
                        <td><label style="padding:0 2rem;" class="am-checkbox am-success"><input type="checkbox" name="data[Product][is_subscription_send]" value="1" data-am-ucheck <?php if(isset($product_info['Product']['is_subscription_send'])&&$product_info['Product']['is_subscription_send']==1){echo "checked";}?> /><?php echo ''?></label></td>
                    </tr>
                    <!--能作为普通商品销售-->
                    <tr>
                    ...
                    <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                        <tr>
                            <td><p class="div_img_label_tag">
                                <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-3" style="width:450px;">
                                <?php
                                    if(isset($tag_infos[$v['Language']['locale']]) && sizeof($tag_infos[$v['Language']['locale']])>0){
                                        foreach($tag_infos[$v['Language']['locale']] as $t){?>
                                        <li>
                                            <span class="taglist"><span class="am-fl"><input style="margin-bottom:10px;width:80px;" type="text" value="<?php echo $t;?>" name="data[TagI18n][<?php echo $k;?>][name][]" style="margin-bottom: 10px;width: 100px;"></span><span onclick="removetags(this)" class="am-icon-minus-circle am-fl" style="padding-top:8px;color:#ff4949;margin-left:5px;"></span><span class="am-cf"></span></span>
                                        </li>
                                        <?php }} ?>
                                    </ul>

                                        <span>
                                        <input type="text" maxlength="10" style="width:128px;float:left;height:32px;" />
                                        <input class="am-btn am-btn-success am-radius am-btn-sm" onclick="addtags(this,'data[TagI18n][<?php echo $k;?>][name][]')" style="float:left;" type="button" name="data[TagI18n][<?php echo $k;?>][name][]" value="<?php echo $ld['add']?>" />
                                        </span>
                    ...
                    <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                        <tr>
                            <td>
                                ...
                                <input class="am-btn am-btn-success am-radius am-btn-sm" type="button" data-am-modal="{target: '#product_file', closeViaDimmer: 0, width: 400, height: 230}" onclick="show_upload_div(<?php echo $k;?>)" value="<?php echo $ld['file_uplaod']?>" />
                            </td>
                        </tr>
                    <?php }}?>
                </table>
                        ...
                        <tr>
                            <td>
                                <div id="package_table">
                                    <table style="width:100%;" class="tablelist am-table">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <?php //pr($package_products) ?> 
                                        <?php  if(isset($package_products)&&!empty($package_products)){foreach($package_products as $pk=>$pv){?>
                                            <tr >
                                                <td><a target="_blank" href="<?php echo  $html->url('/products/view/'.$pv['PackageProduct']['package_product_id']); ?>">
                                                        <?php echo $html->image(!empty($pv['PackageProduct']['img'])?$pv['PackageProduct']['img']:"/theme/default/images/default.png",array('style'=>'margin:5px 0 5px 10px;','width'=>'45px','height'=>'45px')); ?></a></td>
                ...
                <table class="am-table">
                    <tr>
                        <td colspan="3"><?php echo $this->element('category_tree');?>
                            ...
                            <!--品牌模块-->
                            <input style="width:200px;float:left;margin-right:5px;" type="text" name="product_keyword" id="product_keyword" /> <input  type="button" class="am-btn am-btn-success am-radius am-btn-sm " value="<?php echo $ld['search']?>" onclick="searchProducts();" /></td>
                    </tr>
                </table>
                ...
                <table class="am-table">
                    <tr>
                        <td colspan="3"><?php echo $this->element('category_tree_articles');?>
                            <!--分类模块-->
                            <input type="text" style="margin-right:5px;width:200px;float:left;" name="article_keyword" id="article_keyword" /> <input class="am-btn am-btn-success am-radius am-btn-sm"  type="button" value="<?php echo $ld['search']?>" onclick="searchArticles();" /></td>
                    </tr>
                </table>
                <div class="am-form-group">
    ...
    <!--  -->
    <?php if(isset($product_action_list)){ ?>
    <div id="product_action_list" class="am-panel am-panel-default">
		<div class="am-panel-hd">
			<h4 class="am-panel-title"><?php echo $ld['operation_records']?></h4>
		</div>
		<div class="am-panel-collapse am-collapse am-in">
			<table class="am-table">
				<thead>
				  <tr>
					...
					<th class="thtype"><?php echo $ld['status']?></th>
					<th align="center" style="font-weight:bold;"><?php echo $ld['note2']?></th>
				  </tr>
				</thead>
				<tbody>
				<?php foreach($product_action_list as $k=>$v){?>
				  <tr style="text-align: left;white-space: normal;">
					<td class="tddate"><?php echo $v['ProductAction']['created']?></td>
					<td style="white-space: normal;"><?php echo $v['Operator']['name']?></td>
					<td><?php echo $v['ProductAction']['status']=='1'?$ld['valid']:$ld['invalid']; ?></td>
					<td><?php echo $v['ProductAction']['remark'];?></td>
				  </tr>
				<?php }?>
				</tbody>
			  </table>
...
<div class="am-modal am-modal-no-btn" tabindex="-1" name="brand" id="brand">
    <div class="am-modal-dialog">
        ...
        <form id='catform2' class="am-form" method="POST">
            <?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
            ...
            <div class="am-modal-bd">
                    ...
                    <div class="am-g">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5 div_lineheight"><?php echo $ld['brand_name']?>：</div>
                        <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                         <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                            <div class="am-u-sm-9">
                            <input id="brand_name_<?php echo $v['Language']['locale'];?>" name="data1[BrandI18n][<?php echo $k;?>][name]" type="text" value="">
                            </div>
                            <div class="am-u-sm-2">
                    ...
                    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5 div_lineheight"><?php echo $ld["brand_code"]?>：</div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                            <div class="am-u-sm-9">
...
<div class="am-modal am-modal-no-btn" tabindex="-1" name="productcattype" id="productcattype">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd" style="padding-top:15px;">
            <form id='catform3' class="am-form" method="POST">
                
                    <div class="am-g">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5 div_lineheight">
                            <?php echo $ld['category_type_name']?>：
                        </div>

                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                            <div class="am-u-sm-9">
                            <input id="CattypeName" name="CattypeName" type="text" value="">
                            </div>
                            <div class="am-u-sm-2">
                            <em class="color_red">*</em>
                            </div>
                    ...
                    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5 div_lineheight">
                        <?php echo $ld["category_type_code"]?>：
                        </div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                        <div class="am-u-sm-9">
                        <input type="text" id="CattypeCode" name="CattypeCode">
                        </div>
                        </div>
                    </div>
...
<div class="am-modal am-modal-no-btn" tabindex="-1" name="placement" id="package_pro" style="overflow-y:auto;overflow-x:hidden;max-height:450px;">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <form id='packageform' class="am-form" method="POST" action="<?php echo $admin_webroot; ?>products/add_package_product">
                <div id="change_package"  class="am-g" style="margin:5px 0 0;">
                    <div class="am-u-sm-4">
                     <?php echo $this->element('category_package_tree');?>   
                    </div>
                    
                    <!--品牌模块-->
                    <div class="am-u-sm-5 am-g-end">
                      <input type="text" name="product_package_keyword" id="product_package_keyword" />  
                    </div>
                    <div class="am-u-sm-3 am-text-center">
                      <input type="button" value="<?php echo $ld['search']?>" class="am-btn am-btn-success am-radius am-btn-sm" id="search_package" onclick="get_page_pro()"/>  
                    </div>
        ...
        <div class="am-modal-bd" style="padding-top:15px;">
            <form id='catform1' class="am-form" method="POST">
                <?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                    ...
                    <div class="am-g">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5 div_lineheight"><?php echo $ld['higher_category']?>：
                        </div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                        <div class="am-u-sm-9">
                        <select name="parent_id" id="product_category_parent_id" data-am-selected="{maxHeight:300}">
                    ...
                    <div class="am-g am-margin-top-sm am-margin-bottom-sm">
                        ...
                        <?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
                            ...
                            <div class="am-u-lg-8 am-u-md-7 am-u-sm-7">
                                <div class="am-u-sm-9">
                                <input id="productcat_name_<?php echo $v['Language']['locale'];?>" name="data1[CategoryProductI18n][<?php echo $k;?>][name]" type="text" value="">
                                </div>
                                <div class="am-u-sm-2">
                                <em class="color_red">*</em>
                                </div>
...
<div class="am-modal am-modal-no-btn" tabindex="-1" name="product_file" id="product_file">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd" style="padding-top:15px;">
            ...
            <form id='upload_file_form' class="am-form" method="POST" enctype="multipart/form-data">
               
                    <div class="am-g">
                        <div class="am-u-lg-4 am-u-md-5 am-u-sm-5">
                    ...
                    <div class="am-g am-text-center am-margin-top-sm">
                            <input class="am-btn am-btn-success am-radius am-btn-sm"  type="button" name="UploadFileButton" value="<?php echo $ld['confirm']?>" onclick="javascript:doupload_file();">
                    </div>
                
                <p class="am-margin-bottom-xs am-margin-top-lg">
                    <?php echo $ld['file_optional_format']?>:<?php echo empty($file_types)? '':$file_types; ?>
                </p>
                <p class="am-margin-bottom-xs am-margin-top-xs">
...
<script type="text/javascript">
//勾选租赁价格
    function count_lease_price (obj) {
    if($(obj).prop("checked") == true){
    var shop_price = $("#shop_price").val();
    var lease_price = $("#lease_price").val();
    $.ajax({
        url:admin_webroot+"products/ajax_lease_price",
        type:"POST",
        dataType:"json",
        data:{"shop_price":shop_price,"lease_price":lease_price},
        success:function (data) {
           if (data.code == 1) {
            $("#lease_price").val(data.data.lease_price);
            $("#lease_deposit").val(data.data.lease_deposit_base);
           };
        }
    })
    }else{
...
function change_lease_price() {
    ...
    function delete_img(product_code){
        if (confirm("<?php echo $ld['confirm_delete'];?>")){
            $.ajax({
                cache: true,
                type: "POST",
                url:admin_webroot+"products/delete_img",
                data:{"product_code":product_code},
                success: function(data) {
                    var result= JSON.parse(data);
                    if(result['flag']==1){
                        $("#product_image_x").attr("src",webroot+"<?php echo $configs['shop_default_img']; ?>");
    ...
    function cha2(){
        if($("#lease_status").prop('checked') == true){
        if($("#lease_price").val() <= 0 || $("#lease_price").val() == ''){
        alert("<?php echo $ld['please_fill_lease_price'] ?>");
        return false;
        }
        // if($("#lease_deposit").val() <= 0 || $("#lease_deposit").val() == ''){
        // alert("<?php echo $ld['please_fill_lease_deposit'] ?>");
        // return false;   
        // }
        if($("#unit").val() < 0 || $("#unit").val() == ''){
        alert("<?php echo $ld['please_fill_lease_days'] ?>");
        return false;   
        }
        if ($("#unit").val() == 0) {
        alert("<?php echo $ld['lease_days_o'] ?>");
        return false;   
        }
        }
        if(document.getElementById("product_name_chi")){
            ...
            if(name.length>60){
                alert("<?php echo sprintf($ld['product_name_too_long'],60); ?>");
                return false;
            }
        }
        ...
        if(product_code.length>20){
    		alert("<?php echo sprintf($ld['product_code_maxlength_desc'],20); ?>");
        	return false;
        }
    ...
    function checkProductCode(){
        ...
        if(product_code.length>20){
            ...
            if(product_code!=""){
                ...
                var sUrl = admin_webroot+"products/select_product_code/";//访问的URL地址
                $.ajax({
                    type: "POST",
                    url: sUrl,
                    dataType: 'json',
    ...
    function doinsertattribute(){
        ...
        if(attrname==""){
            ...
            var sUrl = admin_webroot+"productstypes/doinsertattribute/";//访问的URL地址
            $.ajax({
                type: "POST",
                url: sUrl,
                dataType: 'json',
    ...
    function doinsertproductcat(){
        ...
        if(typename==""){
            ...
            var sUrl = admin_webroot+"product_categories/doinsertproductcat/";//访问的URL地址
            $.ajax({
                type: "POST",
                url: sUrl,
                dataType: 'json',
    ...
    function doinsertbrand(){
        ...
        if(logoname==""||logocode==""){
            alert(brand_and_code);
            return;
        }else{
            var sUrl = admin_webroot+"brands/doinsertbrand/";//访问的URL地址
            $.ajax({
                type: "POST",
                url: sUrl,
                dataType: 'json',
    ...
    function doupload_file(){
        var sUrl = admin_webroot+"upload_files/ajax_add/";//访问的URL地址
    ...
    function changePackageProductOrder(updown,id,next,thisbtn){
        ...
        changeHtml(thisbtn);
        var sUrl = admin_webroot+"products/change_packageorder/"+updown+"/"+id+"/"+next+"/"+productid;//访问的URL地址
        $.ajax({
            type: "POST",
            url: sUrl,
            dataType: 'json',
    ...
    function changeOrder(p_id,id){
        var sUrl = admin_webroot+"products/changeorder/"+p_id+"/"+id;//访问的URL地址
        $.ajax({
            type: "POST",
            url: sUrl,
            dataType: 'html',
    ...
    function changeProductCode(obj){
        if(obj.id=='product_brand_id'){
            var sUrl = admin_webroot+"products/change_product_code/";//访问的URL地址
            $.ajax({
                type: "POST",
                url: sUrl,
                dataType: 'json',
    ...
    function auto_code(){
        ...
        var sUrl = admin_webroot+"products/auto_code/";//访问的URL地址
        $.ajax({
            type: "POST",
            url: sUrl,
            dataType: 'json',
    ...
    function search_brand(){
        ...
        var sUrl = admin_webroot+"brands/search_brand/";//访问的URL地址
        $.ajax({
            type: "POST",
            url: sUrl,
            dataType: 'json',
    ...
    function delProImg(Id,i,product_id){
        var sUrl = admin_webroot+"products/delProImg/"+product_id;//访问的URL地址
        $.ajax({
            type: "POST",
            url: sUrl,
            dataType: 'json',
            ...
            success: function (result) {
                if(result.code==1){
                    if(product_id==''){
                        $('#show_product_add_img_0'+i).attr('src',admin_webroot+'skins/default/img/default_no_photo.png');
...
//  var tp ="ico sql";
    ...
    function addtags(obj,name){
        ...
        var text = '<li><span class="taglist" ><span class="am-fl"><input type="text" style="margin-bottom: 10px;width:80px;" name="'+name+'" value="'+val+'" /></span><span class="am-icon-minus-circle am-fl" style="padding-top:8px;color:#ff4949;margin-left:5px;" onclick="removetags(this)"></span><span class="am-cf"></span></span></li>';
        $(obj).parent().parent().find("ul").append(text);
    }
...
//    }
    ...
    function submit_package(){
        $.ajax({
            cache: true,
            type: "POST",
            url:admin_webroot+"products/add_package_product",
    ...
    function get_page_pro(){
        ...
        $.ajax({ url: admin_webroot+"products/search_package_products",
            type:"POST",
                    ...
                    if(result.content){
                        ...
                        for(i=0;i<result.content.length;i++){
                            if($.inArray(result.content[i]['Product'].id,package_arr)==-1){
                                ...
                                package_html+="<img class='package_img' src='"+webroot+result.content[i]['Product'].img_thumb+"'>";
                                ...
                                package_html+="<div class='show_package_del'><span class='addeds_package'><?php echo $ld['added']?></span><img src="+admin_webroot +"'skins/default/img/delete.png' class='del_sel_package' type='button' title='<?php echo $ld['delete']?>' id='del_sel_package"+result.content[i]['Product'].id+"' /></div>";
                                package_html+="</div>";
                            }else{
                                package_html+="<div class='show_search_package'>";
                                package_html+="<img class='package_img' src='"+webroot +result.content[i]['Product'].img_thumb+"'>";
                                ...
                                package_html+="<div class='show_package_del' style='display:block;'><span class='addeds_package'><?php echo $ld['added']?></span><img src="+admin_webroot +"skins/default/img/delete.png' class='del_sel_package' type='button' title='<?php echo $ld['delete']?>' id='del_sel_package"+result.content[i]['Product'].id+"' /></div>";
                                package_html+="</div>";
...
<script type="text/javascript">
    $(function(){
		...
		if(document.getElementById("lease_status")){
			handleLease($("#lease_status").prop("checked"));
		}
    })
    ...
    function getSkuType(Id,obj){
        ...
        if(attr_id!=""){
            $.ajax({ url: admin_webroot+"products/getskutype",
                type:"POST",
    ...
    $(".am-panel-bd").on("click","#productSku_list #productSku_list_table #sku_search_pro .sku_pro_ck",function(){
        ...
        if($(this).is(':checked')){
            ...
            attr_html+="<td>"+sku_pro_name+"<br >"+sku_pro_code+"</td><td>"+sku_pro_quantity+"<input type='hidden' name='data[SkuProduct][quantity][]' value='"+sku_pro_quantity+"' /></td>";
            $.each(sku_attr_code, function(i, n){
...
<script>
    var rotate_logo = document.querySelector('.rotate_logo');
    var rotate_list = document.querySelector('.rotate_list');

    rotate_list.style.display = 'none';
    if($('#product_image_x').attr("src") == '/theme/default/images/default.png'){
        rotate_logo.className = 'rotate_logo am-icon-cog am-icon-check';
    }else{
        rotate_logo.className = 'rotate_logo am-icon-check';
        rotate_list.style.display = '';
    }

    rotate_logo.onclick = function(){
        if(rotate_list.style.display == 'none'){
            rotate_list.style.display = '';
            rotate_logo.className = 'rotate_logo am-icon-check';
        }else{
            rotate_list.style.display = 'none';
