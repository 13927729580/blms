...
?>
    <table style="width:100%;" class="tablelist am-table">
        ...
        <?php if(isset($package_products)&&!empty($package_products)){foreach($package_products as $pk=>$pv){?>
            <tr >
                <td><a target="_blank" href="<?php echo $admin_webroot; ?>products/view/<?php echo $pv['Product']['id']?>"><?php echo $html->image($pv['Product']['img_thumb'],array('style'=>'margin:5px 0 5px 10px;','width'=>'45px','height'=>'45px')); ?></a></td>
