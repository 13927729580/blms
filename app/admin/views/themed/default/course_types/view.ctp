...
<div class="am-product">
    <div id="accordion" class="am-u-lg-12 am-u-md-12 am-u-sm-12">
        <?php echo $form->create('/course_types',array('action'=>'view/'.$course_type_info["CourseType"]["id"],'id'=>'course_type_edit_form','name'=>'course_type_edit','class'=>'am-form am-form-horizontal','type'=>'POST','onsubmit'=>"return chechk_form()"));?>
        <input type="hidden" name="data[CourseType][id]" id="_id" value="<?php echo $course_type_info['CourseType']['id'];?>" />
        <div class="am-g">
            ...
            <div id="Basic_information_pancel" class="am-panel-collapse am-collapse am-in">
                ...
                <div class="am-panel-bd">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5"><input type="text" name="data[CourseType][code]" id="code" value="<?php echo $course_type_info['CourseType']['code'];?>"></div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5"><input type="text" name="data[CourseType][name]" id="name" value="<?php echo $course_type_info['CourseType']['name'];?>"></div>
                        <em style="position: relative; top: 10px; color: red; left: 10px;">*</em>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-form-label"><?php echo $ld['status'] ?></label>
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5">
                            <label class="am-radio-inline"><input type="radio" name="data[CourseType][status]" <?php if($course_type_info['CourseType']['status'] == 1){?>checked="checked"<?php }?> value="1"/>有效</label>
                            <label class="am-radio-inline"><input type="radio" name="data[CourseType][status]" <?php if($course_type_info['CourseType']['status'] == 0){?>checked="checked"<?php }?> value="0"/>无效</label>
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-form-label"><?php echo $ld['description'] ?></label>
                        <div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
                            <textarea cols="30" id="elm" name="data[CourseType][description]" rows="10" style="width:auto;height:300px;"><?php echo @$course_type_info['CourseType']['description'];?></textarea>
                            <script>
                                var editor;
