...
<div class="am-g">
	<div class="am-u-lg-2 am-u-md-3 am-u-sm-4">
		<ul class="am-list admin-sidebar-list">
			...
			<li><a data-am-collapse="{parent: '#accordion'}" href="#"><?php echo $v['Action']['name']?></a></li>	
			<?php }}?>	
		</ul>
	</div>
			    ...
			    <div class="am-panel-bd ">
						...
						<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
							<?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
								<div class="am-u-lg-8 am-u-md-8 am-u-sm-9" style="margin-top:10px;">
									<input type="text" id="name<?php echo $v['Language']['locale']?>" name="data[RoleI18n][<?php echo $k;?>][name]" />
								</div>
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-8 am-u-md-8 am-u-sm-9">
							<div class="am-u-lg-8 am-u-md-8 am-u-sm-9">
								<input class="am-form-field am-radius" name="data[Role][orderby]" />
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-4 am-u-md-4 am-u-sm-4" >
							<label class="am-radio am-success" ><input type="radio" name="data[Role][status]" value="1" style="margin-left:0px;" data-am-ucheck checked /><?php echo $ld['yes']?>&nbsp;&nbsp;</label>
							<label class="am-radio am-success"><input type="radio" style="margin-left:0px;"name="data[Role][status]" value="0" data-am-ucheck /><?php echo $ld['no']?></label>
						</div>
					</div>
					<div class="btnouter">
	    ...
	    <div class="am-panel-hd">
		    <h4 class="am-panel-title">
		    	<label class="am-checkbox am-success am-form-label" style="font-weight:bold;display:inline;">
		    		<input type="checkbox"  data-am-ucheck  onclick='checkall(this)'/><?php echo $v['Action']['name']?>
		    	</label>
		    </h4>
		</div>
				...
				<div class="am-form-group" style="margin-left:10%;">
					...
					<?php if(isset($vv['SubAction']) && sizeof($vv['SubAction'])>0){?>
						...
						<?php foreach($vv['SubAction'] as $vvv){?>
                            <li>
							    <label class="am-checkbox am-success"><input type="checkbox" name="competence[]"  style="margin-left:0px;" data-am-ucheck  value="<?php echo $vvv['Action']['id']?>" /><?php echo $vvv['ActionI18n']['name']?></label>
						<?php }?>&nbsp;
                            </li>
                        </ul>
					<?php }?>
