	...
	<div class="am-panel am-panel-default am-panel-header">
		<div class="am-panel-hd">
			<div class="am-panel-title">
				...
				<div class="am-u-lg-2 am-show-lg-only"><?php echo $ld['option_value'] ?></div>
				<?php if($attribute['Attribute']['type']=='customize'|| $attribute['Attribute']['type']=='multiple_customize'){ ?><div class="am-u-lg-1 am-u-md-2 am-u-sm-2"><?php echo $ld['price']?></div><?php } ?>
	...
	<div>
		<div class="am-panel am-panel-default am-panel-body">
			<div class="am-panel-bd">			
				...
				<?php if($attribute['Attribute']['type']=='customize' || $attribute['Attribute']['type']=='multiple_customize'){ ?><div class="am-u-lg-1 am-u-md-2 am-u-sm-2">
				...
				<div class="am-u-lg-1 am-u-md-2 am-u-sm-2">
					<span><?php echo $v['AttributeOption']['orderby'] ?></span>
				</div>
				<div class="am-u-lg-1 am-u-md-2 am-u-sm-2">
...
function removeAttrOption(id){
    if(confirm(j_confirm_delete)){
        $.ajax({ 
        	url: admin_webroot+"attributes/remove_attr_option/"+id,
			type:"POST", 
            dataType:"json",
			data: { },
			success: function(data){
                if(data.flag==1){
                    loadAttrOptionPage(admin_webroot+"attributes/attribute_option/<?php echo $attribute_id; ?>");
                }else{
                    alert(data.msg);
                }
      		}
...
function removeAttrOptionAll(){
	...
	if(j>=1){
        data="?1=1"+data;
		if(confirm(j_confirm_delete)){
		    $.ajax({ url: admin_webroot+"attributes/remove_attr_option_all/"+data,
    			type:"POST", 
                dataType:"json",
    			data: { },	
    			success: function(data){
