        ...
        <?php if(isset($like_list) && sizeof($like_list)>0){foreach($like_list as $k=>$v){?>
            <tr>
                ...
                <td><?php
                  ...
                  <a class="am-btn am-btn-default am-btn-xs am-text-danger  am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'user_likes/remove/<?php echo $v['UserLike']['id'] ?>');">
