...
<style type="text/css">
	...
	.related_dt{width:100%;height:320px;overflow-y: auto;padding-left:10px;}
...
<div>	
	...
	<div class="scrollspy-nav" data-am-scrollspy-nav="{offsetTop: 45}" data-am-sticky="{top:'52px',animation:'slide-top'}" style="margin-bottom:8px;">
		<ul>
			...
			<li><a href="#gao"><?php echo $ld['advanced_config'];?></a></li>
		    ...
		    <div class="am-panel-collapse am-collapse am-in">
	      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">		
					<div class="am-form-group">
		    			<label class="am-u-lg-2 am-u-md-2 am-u-sm-4 am-view-label"><?php echo $ld['topic_name']?></label>
		    			<div class="am-u-lg-10  am-u-md-10 am-u-sm-8">
		    				<?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
			    				...
			    				<?php if(sizeof($backend_locales)>1){?>
				    				<label class="am-u-lg-3 am-u-md-3 am-u-sm-3 am-view-label" style="margin-top:1rem;">
					...
					<div class="am-form-group">
		    			...
		    			<div class="am-u-lg-10  am-u-md-10 am-u-sm-8">
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
		    					...
		    					<label class="am-radio am-success ">		
									<input type="radio" class="radio" data-am-ucheck  name="data[Topic][status]" value="0" <?php if((isset($this->data['Topic']['status'])&&$this->data['Topic']['status'] == 0)||!isset($this->data['Topic']['status'])){echo "checked";} ?>/><?php echo $ld['no']?>
								</label>		
		    				</div>
		    			</div>
		    		</div>	
					<div class="am-form-group">
		    			...
		    			<div class="am-u-lg-10  am-u-md-10 am-u-sm-8">
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
		    					...
		    					<label class="am-radio am-success ">	
									<input type="radio" name="data[Topic][front]" data-am-ucheck  value="0" <?php if((isset($this->data['Topic']['front'])&&$this->data['Topic']['front'] == 0)||!isset($this->data['Topic']['front'])){echo "checked";} ?> /><?php echo $ld['no']?>
								</label>
		    				</div>
		    			</div>
		    		</div>	
					...
					<div class="am-form-group">
		    			...
		    			<div class="am-u-lg-10  am-u-md-10 am-u-sm-8">
		    				<div class="am-u-lg-4 am-u-md-4 am-u-sm-4">
		    					<input type="text" class="am-form-field" value="<?php echo isset($this->data['Topic']['start_time'])?date('Y-m-d',strtotime($this->data['Topic']['start_time'])):'';?>"  name="data[Topic][start_time]" placeholder="" data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}" readonly/>
		    				</div>
		    				<div class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-text-center">-</div>
		    				<div class="am-u-lg-4 am-u-md-4 am-u-sm-4">
		    					<input type="text" class="am-form-field" value="<?php echo isset($this->data['Topic']['end_time'])?date('Y-m-d',strtotime($this->data['Topic']['end_time'])):'';?>" name="data[Topic][end_time]" placeholder="" data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}" readonly/>
		    				</div>
		    			</div>
		    		</div>	
					<div class="am-form-group">
					...
					<div class="am-u-lg-10 am-u-md-10 am-u-sm-8 am-u-end">
	    			 	<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
							...
							<div class="am-form-group">
								<?php echo $this->element('editor',array('editorName'=>"data[TopicI18n][{$k}][intro]",'editorId'=>'intro'.$v['Language']['locale'],'editorValue'=>isset($this->data['TopicI18n'][$v['Language']['locale']]['intro'])?$this->data['TopicI18n'][$v['Language']['locale']]['intro']:'','editorLang'=>$v['Language']['google_translate_code'])); ?>
							</div>
						</div>
		    		...
		    		<div class="am-form-group">
	      			 <label class="aam-u-lg-2 am-u-md-2 am-u-sm-4 am-view-label"> <?php echo $ld['simple_description'];?></label>
		    		 	 <div class="am-u-lg-10 am-u-md-10 am-u-sm-8">
		    		 		<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach($backend_locales as $k => $v){?>
		    				<div class="am-u-lg-10 am-u-sm-9 am-padding-left-0">
							<div class="am-form-group">
								<?php echo $this->element('editor',array('editorName'=>"data[TopicI18n][{$k}][mobile_intro]",'editorId'=>'mobile_intro'.$v['Language']['locale'],'editorValue'=>isset($this->data['TopicI18n'][$v['Language']['locale']]['mobile_intro'])?$this->data['TopicI18n'][$v['Language']['locale']]['mobile_intro']:'','editorLang'=>$v['Language']['google_translate_code'])); ?>
							</div>
						</div>
						<div class="am-u-lg-2 am-u-sm-3"><span class="ckeditorlanguage"><?php echo $v['Language']['name'];?></span></div>
						<div class="am-cf"></div>
	   ...
	   <div id="gao" class="am-panel am-panel-default">
		    		...
		    		<div class="am-form-group">
			    		...
			    		<div class="am-form-group" >
						     	 <div class="am-u-lg-12 am-u-md-12 am-u-sm-12 "> 
									...
									<li>
										<?php echo $html->image(trim($v['TopicProduct']['img_detail'])!=""?$v['TopicProduct']['img_detail']:$configs['shop_default_img'],array('style'=>'width:150px;height:140px;'));?><br/>
		...
		<div id="mobile_002" class="am-panel am-panel-default" >
		    ...
		    <div class="am-panel-collapse am-collapse am-in">
	      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">			
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-4 am-u-sm-5" style="margin-top:10px;">
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-6 am-u-md-6 am-u-sm-12 am-text-center ">
				    		<label><?php echo $ld['mobile_002'];?></label>
...
<?php echo $form->end();?>
			...
			<div class="am-popup" id="product_selectd">
				<div class="am-popup-inner">
					<div class="am-popup-hd" style="margin-top:10px;">
						<div class="am-popup-title" style="font-weight:400"><?php echo $ld['option_products']?></div>
							<span data-am-modal-close  class="am-close">&times;</span>
								</div>
								    <div id="product_selectds" class="related_dt topicsma am-form" style="margin-top:10px;"></div> 
							            <div style='margin-left:20px; '>
							            <label class="am-checkbox">       
							            <input onclick="listTable.selectAll(this,&quot;checkboxes[]&quot;)"  class="am-btn am-radius am-btn-success am-btn-sm" type="checkbox" data-am-ucheck />
							            </label>
