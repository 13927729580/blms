...
<div>	
	...
	<label class="am-checkbox am-success am-show-sm-down" style="font-weight:bold;"><?php echo $ld['interface_name']?></label>
					...
					<div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $ld['location']?></div>
			...
			<div>
				<div class="listtable_div_top am-panel-body">
					<div class="am-panel-bd am-g">
						...
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $v['UserApp']['location']==0?$ld['frontend']:($v['UserApp']['location']==1?$ld['backend']:$ld['all']); ?></div>
