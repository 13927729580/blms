		      		...
		      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">	
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label" style="padding-top:20px;"><?php echo 'app_secret';?></label>
				    			<div class="am-u-lg-7 am-u-md-8 am-u-sm-8">
				    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
				    					<input type="text" id="app_secret" name="data[UserApp][app_code]" value="<?php echo isset($syn_apps['UserApp']['id'])?$syn_apps['UserApp']['app_code']:''?>"/>
				    				</div>
				    				<label class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-form-label am-text-left" style="font-weight:normal;padding-top:20px;">
				    					<em style="color:red;">*</em>
				    				</label>
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label" style="padding-top:20px;"><?php echo 'app_id';?></label>
				    			<div class="am-u-lg-7 am-u-md-8 am-u-sm-8">
				    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
				    					<input type="text" name="data[UserApp][app_id]" value="<?php echo isset($syn_apps['UserApp']['id'])?$syn_apps['UserApp']['app_id']:''?>"/>
				    				</div>
				    			</div>
						</div>
						<div class="am-form-group">
				    			...
				    			<div class="am-u-lg-7 am-u-md-8 am-u-sm-8">
				    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
				    					<label class="am-checkbox am-success">
				    						<input type='hidden' name="data[UserApp][status]" value='0' />
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label" style="padding-top:16px;"><?php echo $ld['location']?></label>
				    			<div class="am-u-lg-7 am-u-md-8 am-u-sm-8">
				    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
				    					<select name="data[UserApp][location]" data-am-selected>
				    						<option value="0"><?php echo $ld['frontend'];?></option>
										<option value="1" <?php echo isset($syn_apps['UserApp']['location'])&&$syn_apps['UserApp']['location']=='1'?'selected':''; ?>><?php echo $ld['backend'];?></option>
										<option value="2" <?php echo isset($syn_apps['UserApp']['location'])&&$syn_apps['UserApp']['location']=='2'?'selected':''; ?>><?php echo $ld['all'];?></option>
									</select>
				    				</div>
				    			</div>
						</div>
...
<script type="text/javascript">
	...
	function check_form(){
		...
		if(!check_null('app_secret')){
			alert('请填写接口app_secret');
			return false;
		}
