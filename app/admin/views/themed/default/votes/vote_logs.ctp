...
<p class="am-u-md-12">	<a href="<?php echo $admin_webroot; ?>votes"><input  type="submit"class=" am-btn am-btn-default am-btn-xs am-radius am-fr" value="<?php echo $ld['votes']  ?>"/></a></p>
                ...
                <tr>
                    ...
                    <td class="thwrap am-hide-md-down"><?php
                        if ($v['VoteLog']['status'] == 1){
                            echo $html->image('/admin/skins/default/img/yes.gif',array('align'=>'absmiddle','onclick'=>''));
                        }elseif($v['VoteLog']['status'] == 0){
                            echo $html->image('/admin/skins/default/img/no.gif',array('align'=>'absmiddle','onclick'=>''));
                        }
                        ?></td>
                    <td><?php
