        ...
        <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
            ...
            <table class="am-table">
                <tr>
                    ...
                    <td style=" width:35%;float:left;"><input   id='OpenModelTypeId' name='data[OpenModel][open_type_id]'  type='text' value='<?php echo isset($this->data['OpenModel']['open_type_id'])?$this->data['OpenModel']['open_type_id']:'';?>'><td style="float:left;"><em>*</em>
                ...
                <tr>
                    ...
                    <td style=" width:35%;float:left;">
                        <?php $OpenModel_img=isset($this->data['OpenModel']['img'])&&$this->data['OpenModel']['img']!=""?$webroot.$this->data['OpenModel']['img']:"/theme/default/images/default.png";?>
                        <div><?php echo $html->image($OpenModel_img,array('style'=>'width:60px;height:60px;')); ?></div>
                ...
                <tr id="type_dy">
                    ...
                    <td ><label class="am-radio am-success" style="padding-top:2px"><input name='data[OpenModel][type]' type='radio' data-am-ucheck <?php echo isset($this->data['OpenModel']['type'])&&$this->data['OpenModel']['type']==0 ?'checked':'';?> value="0"><?php echo $ld['subscribe_no'] ?></label>
                        <label style="margin-left:10px;padding-top:2px;" class="am-radio am-success"><input name='data[OpenModel][type]' type='radio' data-am-ucheck <?php echo isset($this->data['OpenModel']['type'])&&$this->data['OpenModel']['type']==1?'checked':'';?> value="1"><?php echo $ld['service_no'] ?></label>
                        <label style="margin-left:10px;padding-top:2px;" class="am-radio am-success"><input name='data[OpenModel][type]' type='radio' data-am-ucheck <?php echo isset($this->data['OpenModel']['type'])&&$this->data['OpenModel']['type']==2?'checked':'';?> value="2"><?php echo $ld['website_application'] ?></label>
                        <label style="margin-left:10px;padding-top:2px;" class="am-radio am-success"><input name='data[OpenModel][type]' type='radio' data-am-ucheck <?php echo isset($this->data['OpenModel']['type'])&&$this->data['OpenModel']['type']==3?'checked':'';?> value="3"><?php echo $ld['mobile_application'] ?></label>
                    </td>
                </tr>
                <tr id="verify_status">
                ...
                <tr>
                    ...
                    <tr>
                        <td style="position:relative;"><span class="ckeditorlanguage"  style="top:80px;right:-5px;"><?php echo $ld[$v['Language']['locale']];?></span>
                            <textarea id="BOTTOM_AREA_INFORMATION_<?php echo $v['Language']['locale'];?>" name="data[OpenConfig][BOTTOM-AREA-INFORMATION][<?php echo $v['Language']['locale'];?>]"><?php echo isset($open_config_data['BOTTOM-AREA-INFORMATION']['OpenConfigsI18n'][$v['Language']['locale']])?$open_config_data['BOTTOM-AREA-INFORMATION']['OpenConfigsI18n'][$v['Language']['locale']]['value']:"" ?></textarea>
                            <?php if($configs["show_edit_type"]){?>
                                <script type="text/javascript">
                                    var editor;
                                    KindEditor.ready(function(K) {
...
<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
    <div class="am-modal-dialog">
        <div class="am-modal-hd" style="border-bottom:1px solid #ddd;"><?php echo $ld['reply'].$ld['set_up'];?>
        ...
        <div class="am-modal-bd" style="padding-top:15px;">
            <form class="am-form">
                    ...
                    <div class="am-g">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4" style="font-size:16px;line-height:32px;">
                            <?php echo $ld['reply'].$ld['type'];?>
                        </div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-md-7 am-text-left">
                            <select id="msgtype" onchange="changemsgtype(this)" data-am-selected="{btnWidth:'50%'}">
                                <option value="text"><?php echo $ld['word']; ?></option>
                                <option value="material"><?php echo $ld['graphics']; ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="am-g am-margin-top-xs" id="writtenwords">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4 div_lineheight">
                            <?php echo $ld['reply'];?></div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-md-7 am-text-left">
                            <div>
                                <div style="display:none;">
                                    <span id="biaoqingnew" onclick="biaoqingclick()"><img src="<?php echo $admin_webroot; ?>skins/default/img/haha.png"/><?php echo $ld['expression'] ?></span>
                                    <div class="expression">
                                        <?php
                                        foreach($Expression as $k3=>$v3){
                                            echo "<div class='picks' onclick=\"pclick(this)\" id='[@F_".($k3+1)."@]' ><img style='margin-left:0' src='<?php echo $admin_webroot; ?>skins/default/img/gif/F_".($k3+1).".gif' title='".$v3."' /></div>";
                                        }
                                        ?>
                    ...
                    <div class="am-g am-margin-top-xs" id="imagetext" style="display:none;">
                        <div class="am-u-lg-2 am-text-left am-u-md-3 am-u-sm-4" style="font-size:16px;line-height:32px;">
                            <?php echo $ld['source_material'] ?>
                        </div>
                        <div class="am-u-lg-8 am-u-md-7 am-u-md-7 am-text-left">
                            <select id="material" data-am-selected="{btnWdith:'50%'}" data-am-selected="{btnWidth:'50%'}">
                ...
                <div class="btnouter" style="margin-top:15px;">
...
<script type='text/javascript'>
    ...
    $(".answerElement").on('click',function(){
        ...
        if(configtype=="text"){
            ...
            $("#doc-modal-1 #writtenwords").css("display","block");
            $("#doc-modal-1 #imagetext").css("display","none");
            
        }else{
        	
            $("#doc-modal-1 #material").val(configvalue);
            $("#doc-modal-1 #imagetext").css("display","block");
    ...
    function changemsgtype(obj){
        ...
        if(type=="text"){
            ...
            $("#writtenwords").css('display','block');
    ...
    var Url="<?php echo $server_host; ?>"+admin_webroot+"img/gif/";//表情图片路径
    //表情数组
    ...
    $("#setanswer").on("click",function(){
        if(answerElement!=null){
            ...
            if(msgtype=="material"){
                if($("#material").val()!=""){
                    _value=$("#material").val();
                    value="<a href='<?php echo $server_host; ?>"+webroot+"/open_elements/preview/"+_value+"' target='_blank'>"+$("#material").find("option:selected").text()+"</a>";
                }else{
                    alert('请选择素材');
                    return false;
                }
...
<script type='text/javascript'>
    ...
    function ajaxFileUpload(){
        $.ajaxFileUpload({
            url:admin_webroot+'open_models/uploadimg/', //你处理上传文件的服务端
            secureuri:false,
            fileElementId:'OpenModelImg',
            dataType: 'json',
            success: function (result){
                if(result.code=='1'){
                    $("#OpenModelImg_show").attr("src",webroot+result.upload_img_url).css('display','block');
