    ...
    <table class="am-table  table-main">
        ...
        <?php if(isset($loglist)&&sizeof($loglist)>0){ foreach($loglist as $k=>$v){ ?>
            <tr>
                ...
                <td><a target="_blank" class="am-btn am-btn-success am-btn-xs am-radius" href="<?php echo $admin_webroot ?>open_models/log_view/<?php echo $v['OpenUserMessage']['id']; ?>/<?php echo $open_model_info['OpenModel']['id'] ?>">查看</td>
            </tr>
        <?php }}else{ ?>
            <tr>
