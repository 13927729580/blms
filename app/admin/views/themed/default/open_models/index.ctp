                ...
                <td class="am-action"><?php
                   ...
                   <?php  }
                    if($svshow->operator_privilege("open_models_remove")){?>
                           <a class="am-btn am-btn-default am-btn-xs am-text-danger am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'/open_models/remove/<?php echo $v['OpenModel']['id'] ?>');">
