...
<div>
    <?php echo $form->create('UserTak',array('action'=>'/','name'=>"SeearchForm",'id'=>"SearchForm","type"=>"get",'onsubmit'=>'return formsubmit();','class'=>'am-form am-form-horizontal'));?>
    <ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1">
        <li>
            <label class="am-u-lg-3 am-u-md-3 am-u-sm-4 am-form-label-text"><?php echo $ld['group']?></label>
...
<div>
	...
	<?php if($svshow->operator_privilege("task_group_add")){ ?>
		<a class="mt am-btn am-btn-warning am-seevia-btn-add am-btn-sm am-radius" href="<?php echo $html->url('/user_tasks/add'); ?>">
    ...
    <div class="listtable_div_btm">
        <div class="am-g">
            <div class="am-u-lg-1 am-u-md-2 am-u-sm-2">ID</div>
            <div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $ld['code'];?></div>
            <div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $ld['name'];?></div>
            <div class="am-u-lg-2 am-u-md-2 am-u-sm-2">分组名称</div>
            <div class="am-u-lg-1 am-u-md-2 am-u-sm-2">经验值</div>
            <div class="am-u-lg-1 am-u-md-1 am-u-sm-1"><?php echo $ld['status'];?></div>
            <div class="am-u-lg-2 am-u-md-3 am-u-sm-5"><?php echo $ld['operate']; ?></div>
        </div>
        <?php if(isset($task_list) && sizeof($task_list)>0){foreach($task_list as $k=>$v){?>
            <div class="am-g">
                <div class="listtable_div_top" >
                    <div style="margin:10px auto;" class="am-g">
                        <div class="am-u-lg-1 am-u-md-2 am-u-sm-2"><?php echo !empty($v['UserTask']['id'])?$v['UserTask']['id']:"-"?></div>
                        <div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo !empty($v['UserTask']['code'])?$v['UserTask']['code']:"-"?></div>
                        <div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo !empty($v['UserTask']['name'])?$v['UserTask']['name']:"-"?></div>
                        <div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo !empty($v['UserTask']['group_name'])?$v['UserTask']['group_name']:"-"?></div>
                        <div class="am-u-lg-1 am-u-md-2 am-u-sm-2"><?php echo $v['UserTask']['task_experience_value'];?></div>
                        <div class="am-u-lg-1 am-u-md-1 am-u-sm-1">
                            <?php if ($v['UserTask']['status'] == 1) {?>
                                <span class="am-icon-check am-yes"></span>
                            <?php }elseif($v['UserTask']['status'] == 0){ ?>
                                <span class="am-icon-close am-no"></span>
                            <?php } ?>
                        </div>
                        <div class="am-u-lg-2 am-u-md-3 am-u-sm-5">
                        	<?php if($svshow->operator_privilege("task_group_edit")){ ?>
                            <a class="mt am-btn am-btn-default am-btn-xs am-text-secondary am-seevia-btn-edit" href="<?php echo $html->url('/user_tasks/view/'.$v['UserTask']['id']); ?>">
                                <span class="am-icon-pencil-square-o"></span> <?php echo $ld['edit']; ?>
                            </a>
                            <?php } if($svshow->operator_privilege("task_group_remove")){ ?>
                            <a class="mt am-btn am-btn-default am-btn-xs am-text-danger  am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'user_tasks/remove/<?php echo $v['UserTask']['id'] ?>');">
    ...
    <?php if(isset($task_list) && sizeof($task_list)){?>
...
<script type="text/javascript">
    function formsubmit(){
        ...
        window.location.href = encodeURI(admin_webroot+"user_tasks?"+url);
    }
</script>