...
<?php echo $form->create('logistics_company',array('action'=>'/logistics_company_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"logistics_companies/logistics_company_uploadpreview";
