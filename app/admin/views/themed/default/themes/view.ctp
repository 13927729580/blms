...
<div class="am-panel-group admin-content am-u-lg-9 am-u-md-9 am-u-sm-9  am-detail-view" id="accordion" style="width: 98%;margin-right: 1%;">
    <!-- 导航 -->
    ...
    <div class="btnouter am-text-right" data-am-sticky="{top:'100px',animation:'slide-top'}" style="margin-bottom:0;">
        <input style="margin-right: 0;" type="submit" class="am-btn am-btn-success am-radius am-btn-sm" value="<?php echo $ld['d_submit'];?>" />  
        <input style="margin-right: 0;" class="am-btn am-btn-success am-radius am-btn-sm" type="reset" value="<?php echo $ld['d_reset']?>" />
    </div>
    <!-- 导航结束 -->
<div id="basic_info" class="am-panel am-panel-default">
    ...
    <div id="basic_information" class="am-panel-collapse am-collapse am-in">
        <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
            <table class="am-table" id="hotel_img_ul">
                <!--模板名称-->
                <tr>
                    <th style="width: 20%;"><?php echo isset($backend_locale)&&$backend_locale=='eng'?$ld['template'].' '.$ld['name']:$ld['template'].$ld['name'];?></th>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:50%;" id="description"  name="data[Template][description]" value="<?php echo isset($template_list['Template']['description'])?$template_list['Template']['description']:''; ?>" />
                    </td>
                </tr>
                <!--模板颜色样式-->
                <tr>
                    <th style="padding-top:15px"><?php echo $ld['module_style'] ?></th>
                    <td><input type="text" style="width:50%;" id="style" name="data[Template][template_style]" value="<?php echo isset($template_list['Template']['template_style'])?$template_list['Template']['template_style']:''; ?>"/>
                    </td>
                </tr>
                <tr>
                    <th style="padding-top:15px"><?php echo $ld['thumbnail']?></th>
                    <td><input id="template_img" style="margin-right: 10px;width:50%;float:left;" type="text" name="data[Template][template_img]" value="<?php echo isset($template_list['Template']['template_img'])?$template_list['Template']['template_img']:'';?>" /><input class="am-btn am-btn-success am-radius am-btn-sm" type="button" onclick="select_img('template_img')" value="<?php echo $ld['choose_picture']?>" />&nbsp;
                ...
                <tr>
                    ...
                    <td><input style="width:50%" type="text" name="data[Template][url]" value="<?php echo isset($template_list['Template']['url'])?$template_list['Template']['url']:'';?>"/></td>
                </tr>
                <!--状态是否有效-->
                <tr>
 ...
 <!--设置默认-->
                ...
                <tr>
                    ...
                    <td><input style="width:50%" type="text" id="author" name="data[Template][author]" value="<?php echo isset($template_list['Template']['author'])?$template_list['Template']['author']:'';?>"  /></td>
                </tr>
                <!--创建时间-->
                <tr>
                    <th style="padding-top:15px"><?php echo $ld['time']?></th>
                    <td><input style="width:50%" type="text" id="created" class="line_time" name="data[Template][created]" value="<?php echo isset($template_list['Template']['created'])?$template_list['Template']['created']:'';?>" data-am-datepicker="{theme: 'success',locale:'<?php echo $backend_locale; ?>'}" readonly/></td>
                </tr>
 ...
 <?php if(!empty($template_list)){ ?>
    ...
    <div id="ad_position" class="am-panel am-panel-default">
        ...
        <div id="ad_position_list" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <?php if($svshow->operator_privilege("advertisement_positions_add")){?>
...
<style type="text/css">
    ...
    .CodeMirror{width:70%;margin:0px;}
</style>
