	...
	<div>
		<div class="am-u-lg-2 am-u-md-3 am-u-sm-4">
			<ul class="am-list admin-sidebar-list" data-am-scrollspy-nav="{offsetTop: 45}" style="position: fixed; z-index: 100; width: 15%;max-width:200px;">
		    	<li><a href="#order_bulk_upload_orders"><?php echo $ld["import"].$ld["delivery"]?></a></li>
		...
		<div class="am-panel-group admin-content" id="accordion" style="width:83%;float:right;">
			<?php echo $form->create('orders',array('action'=>'/uploaddeliverypreview/','name'=>"theFileForm","enctype"=>"multipart/form-data"));?>
				<div id="order_bulk_upload_orders" class="am-panel am-panel-default">
			  		<div class="am-panel-hd">
						<h4 class="am-panel-title">
							<?php echo $ld["import"].$ld["delivery"]?>
						</h4>
				    </div>
								...
								<div class="am-form-group">
					    			...
					    			<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
					    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
											<?php echo $html->link($ld['download_example_batch_csv'],"/orders/download_csv_delivery/",'',false,false);?>
					    				</div>
					    			</div>
					    		</div>	
				    		<?php }?>	
