...
<div>	
	<div class="am-text-right am-btn-group-xs" style="margin-right:10px;margin-bottom:10px">
		<?php  echo $html->link($ld['order_list'],'/orders',array("class"=>"am-btn am-btn-warning am-btn-sm am-radius"),false,false);?>
	</div>
	<div>
		<div class="am-u-lg-2 am-u-md-3 am-u-sm-4">
			<ul class="am-list admin-sidebar-list" data-am-scrollspy-nav="{offsetTop: 45}" style="position: fixed; z-index: 100; width: 15%;max-width:200px;">
		    	<li><a href="#order_bulk_upload_orders"><?php echo $ld['order_bulk_upload_orders']?></a></li>
		...
		<div class="am-panel-group admin-content" id="accordion" style="width:83%;float:right;">
			<?php echo $form->create('orders',array('action'=>'/uploadorderspreview/','name'=>"theFileForm","enctype"=>"multipart/form-data"));?>
				<div id="order_bulk_upload_orders" class="am-panel am-panel-default">
			  		<div class="am-panel-hd">
						<h4 class="am-panel-title">
							<?php echo $ld['order_bulk_upload_orders']?>
						</h4>
				    </div>
				    <div class="am-panel-collapse am-collapse am-in">
			      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
							<div class="am-form-group">
				    			<label class="am-u-lg-3 am-u-md-3 am-u-sm-3 am-form-label" style="padding-top:22px;"><?php echo $ld['csv_file_bulk_upload']?></label>
								...
								<div class="am-form-group">
					    			...
					    			<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
					    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
											<?php echo $html->link($ld['download_example_batch_csv'],"/orders/download_csv_example/",'',false,false);?>
					    				</div>
					    			</div>
					    		</div>	
				    		<?php }?>	
