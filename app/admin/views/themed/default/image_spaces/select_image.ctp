...
.imagelistnew li {display:inline-block;vertical-align:top;margin: 10px 0px 0px;}
.imagelistnew .div_img {display:block;text-align: center;}
.imagelistnew .div_img_name {display:block;overflow:hidden;padding-top:5px;}
.imagelistnew .div_img_name a {float:none;padding:0;}
.imagelistnew .div_img img {max-height: 100px;max-width: 100%;height:auto;}
...
.imagelistnew a {color:#21964D;}
.imagelistnew a:hover {color:#FF7E00;text-decoration:underline;}
.imagelistnew .div_img_name {display:block;overflow:hidden;padding-top:5px;}
.imagelistnew .div_img_name a {float:none;padding:0;}
.imagelistnew .div_img_detail {padding-top:5px;}
.imagelistnew p {margin-top:0px;margin-bottom:2px;}
...
.imagelistnew li .div_img_name {width:95%;margin:0 auto;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;}
...
.set_img_size{background: #f37b1d none repeat scroll 0 0;margin: 0 auto;position: relative;margin-top: -100px;z-index: 1000;}
.set_img_size a{display: inline-block;margin: 0;padding: 3px 3px 3px 0;color:#fff;}
.set_img_size a:hover{color:#fff;text-decoration: underline;}

.am-u-sm-12 .am-selected.am-dropdown{width: 100px;float: left;margin-right: 5px;} 
</style>
...
<div class="am-panel-group admin-content am-u-lg-9 am-u-md-9 am-u-sm-9 am-fr" id="accordion" style="width:83%;">
    <div class="am-panel am-panel-default">
        <div class="am-panel-collapse am-collapse am-in">
            ...
            <form class='am-form am-form-inline am-form-horizontal' style="padding-bottom: 40px;">
                <div class="listsearch">
                    <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-2" style="margin:10px 0 0 0">
                        <li style="margin-top: 10px;">
                            <div class="am-u-sm-12">
                                <select data-am-selected id="photo_category_id" style="width:100px;float:left;margin-right:5px;">
                        ...
                        <li>
                            <label class="am-u-sm-4 am-form-label"><?php echo $ld['sort_by']?></label>
                            <div class="am-u-sm-7">
            ...
            <div id="applist" class="imagelistnew am-panel-bd" style="">
                ...
                <?php }else{?>
                    <ul class="am-avg-lg-4 am-avg-md-3 am-avg-sm-2" style="margin-bottom: 100px;"><?php
                    ...
                    <?php if($svshow->operator_privilege("image_spaces_remove")){?>
                        <div id="btnouterlist" class="btnouterlist" style="display: block;">
