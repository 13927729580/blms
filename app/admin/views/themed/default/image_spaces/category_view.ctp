...
<?php echo $form->create('image_spaces',array('action'=>'category_view/'.(isset($photo_categories_info['PhotoCategory'])?$photo_categories_info['PhotoCategory']['id']:''),'onsubmit'=>'return checksub()'));?>
    ...
    <div id="tablemain" class="tablemain am-panel am-panel-default">
        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
			...
			<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
				<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
				<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">	<input e name="data[PhotoCategoryI18n][<?php echo $k;?>][name]" type="text" class="pic-type" value="<?php echo isset($photo_categories_info['PhotoCategoryI18n'][$v['Language']['locale']])?$photo_categories_info['PhotoCategoryI18n'][$v['Language']['locale']]['name']:'';?>"></div>
		...
		<div class="am-form-group">
                    ...
                    <div class="am-u-lg-10 am-u-md-10 am-u-sm-9"><div class="am-u-lg-12">
             ...
             <div class="am-form-group" name='size' style='display:none'>
                    <label class=" am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-radio-label" style="margin-top:17px;"><?php echo $ld['big_picture']?></label>
                	 <div class="am-u-lg-10 am-u-md-10 am-u-sm-9 size"><div class="am-u-lg-12 am-u-md-12 am-u-sm-12">
                		<p class="c_txt" style="margin-top:8px;"><?php echo $ld['width']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_big_img_width]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_big_img_width'])?'800':$photo_categories_info['PhotoCategory']['cat_big_img_width']?>"/><p class="c_txt" style="margin-top:8px;"> X <?php echo $ld['height']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_big_img_height]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_big_img_height'])?'800':$photo_categories_info['PhotoCategory']['cat_big_img_height']?>"/><p class="c_txt" style="margin-top:8px;"><?php echo $ld['pixel']?></p></div>
                     </div>
             </div>
	       <div class="am-form-group" name='size' style='display:none'>
                    <label class=" am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-radio-label" style="margin-top:17px"><?php echo $ld['middle_picture']?></label>
                    <div class="am-u-lg-10 am-u-md-10 am-u-sm-9 size"><div class="am-u-lg-12 am-u-md-12 am-u-sm-12"><p class="c_txt" style="margin-top:8px;"><?php echo $ld['width']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_mid_img_width]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_mid_img_width'])?'400':$photo_categories_info['PhotoCategory']['cat_mid_img_width']?>"/><p class="c_txt" style="margin-top:8px;"> X <?php echo $ld['height']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_mid_img_height]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_mid_img_height'])?'400':$photo_categories_info['PhotoCategory']['cat_mid_img_height']?>"/><p class="c_txt" style="margin-top:8px;"><?php echo $ld['pixel']?></p></div></div>
	        </div>
	        <div class="am-form-group" name='size' style='display:none'>
                    <label class=" am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-radio-label" style="margin-top:17px"><?php echo $ld['small_picture']?></label>
	              <div class="am-u-lg-10 am-u-md-10 am-u-sm-9 size"><div class="am-u-lg-12 am-u-md-12 am-u-sm-12"><p class="c_txt" style="margin-top:8px;"><?php echo $ld['width']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_small_img_width]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_small_img_width'])?'140':$photo_categories_info['PhotoCategory']['cat_small_img_width']?>"/><p class="c_txt" style="margin-top:8px;"> X <?php echo $ld['height']?></p><input class='c_size' type='text' name="data[PhotoCategory][cat_small_img_height]" onblur="checknum(this)" value="<?php echo empty($photo_categories_info['PhotoCategory']['cat_small_img_height'])?'140':$photo_categories_info['PhotoCategory']['cat_small_img_height']?>"/><p class="c_txt" style="margin-top:8px;"><?php echo $ld['pixel']?></p></div></div>
	        </div>
              <div class="am-form-group">
			<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-view-label" style="margin-top:17px;"><?php echo $ld['sort']?></label>
			<div class="am-u-lg-10 am-u-md-10 am-u-sm-9"><div class="am-u-lg-12 am-u-md-12 am-u-sm-12"><input style="width:74%;" type="text" name="data[PhotoCategory][orderby]" value="<?php echo isset($photo_categories_info['PhotoCategory'])?$photo_categories_info['PhotoCategory']['orderby']:'';?>" /></div>
			</div>
		  </div>
...
<script>
    ...
    function checksub(){
        if($(".pic-type").eq(0).val() == '' || $(".pic-type").eq(1).val() == ''){
            alert("图片分类名称不能为空！");
            return false;
        }
    }
