		    ...
		    <div class="am-panel-collapse am-collapse am-in">
				...
				<div class="btnouter">
	    			<?php if(isset($messageInfo)){ ?>
	    				<button type="button" class="am-btn am-btn-success am-btn-sm am-radius" value="<?php echo $ld['back'];?>"  onclick="window.location.href=admin_webroot+'user_messages/';"><?php echo $ld['back'];?></button>
					<?php }else{ ?>
