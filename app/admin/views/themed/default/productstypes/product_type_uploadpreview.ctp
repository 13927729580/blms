...
<?php echo $form->create('Productstypes',array('action'=>'/product_type_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"productstypes/product_type_uploadpreview";
