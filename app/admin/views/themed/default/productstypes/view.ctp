		    	...
		    	<div class="am-panel-collapse am-collapse am-in">
					<div class="am-panel-bd am-form-detail am-form am-form-horizontal">		
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-4 am-u-sm-4 am-view-label" style="margin-top:1rem;"><?php echo $ld['product_type_name']?></label>	
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-4 am-u-sm-4 am-view-label" style="margin-top:1rem;"><?php echo $ld['attribute_code']?></label>
							<div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
					...
					<!--	<div class="am-form-group">
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-4 am-u-sm-4 am-view-label" style="margin-top:1rem;"><?php echo $ld['attribute_group']?></label>
							<div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
						...
						<div class="am-form-group"> 
							...
							<div class="am-u-lg-8 am-u-md-8 am-u-sm-8"><div class="am-u-lg-12">
								<label class="am-radio am-success">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-lg-6 am-u-md-6 am-u-sm-12 attr_list" id="attr_list">
                            		<?php if(isset($all_attr_list) && sizeof($all_attr_list)>0){foreach($all_attr_list as $k=>$v){?>
                            			<div class="am-u-lg-12 am-u-md-12 am-u-sm-12 attr_data" style="padding-left:0;">
...
function check_unique(producttype_code,producttype_id){
	$.ajax({
		url:admin_webroot+"productstypes/check_producttype_unique",
...
function getattrlist(action_flag){
    ...
    $.ajax({
		url:admin_webroot+"attributes/getattrlist/"+producttype_id,
...
function add_associated_attributes(attr_select_value){
    ...
    if(attr_select_value!=""&&producttype_id!=""){
        $.ajax({
    		url:admin_webroot+"productstypes/add_associated_attributes/"+producttype_id,
...
function removeattr(obj){
	...
	if(attr_id!=""&&producttype_id!=""){
        $.ajax({
    		url:admin_webroot+"productstypes/remove_associated_attributes/"+producttype_id+"/"+attr_id,
    		data:{},
    		method: 'POST',
    		dataType:'json',
    		success:function(data){
