...
<?php echo $form->create('contact_configs',array('action'=>'/contact_config_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"contact_configs/contact_config_uploadpreview";
