...
<div class="listsearch">
    ...
    <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-3" style="margin:10px 0 0 0;">
        <li style="margin:0 0 10px 0"><!--1-->
            ...
            <div class="am-u-sm-7 am-u-md-7 zm-u-lg-7">
                <select name="ctype" data-am-selected="{noSelectedText:'<?php echo $ld['all_data'] ?> '}" >
                    ...
                    <option value="CP" <?php if(@$ctype=="CP"){echo "selected";}?> ><?php echo $ld['category_product']?></option>
                    <option value="SP" <?php if(@$ctype=="SP"){echo "selected";}?> ><?php echo $ld['page']?></option>
                    <option value="AT" <?php if(@$ctype=="AT"){echo "selected";}?> ><?php echo $ld['activity']?></option>
                </select>
            </div>
        </li>
        ...
        <li style="margin:0 0 10px 0"><!--3-->
        	<label class="am-u-sm-3  am-u-md-3 am-u-lg-2 am-form-label"><?php echo $ld['comment_time']?></label>
            <div class="am-u-lg-9">
            <div class="am-u-sm-3 am-u-md-3 am-u-lg-5" style="padding:0 0rem;min-width:133px;">
            ...
            <div class="am-u-sm-3   am-u-md-3 am-u-lg-5 am-u-end" style="padding:0 0rem;min-width:133px;">
                <div class="am-input-group">
                ...
                <tr>
                    ...
                    <td style="max-width:220px;"><?php
                        ...
                        if($svshow->operator_privilege("comments_remove")){
                            echo $html->link(' '.$ld['remove'],"javascript:;",array("class"=>"mt am-icon-trash-o am-btn am-text-danger am-btn-default am-btn-xs am-radius","onclick"=>"list_delete_submit('{$admin_webroot}comments/remove/{$v['Comment']['id']}')"));
                        }
                        ?></td>
                </tr>
            <?php }}else{?>
