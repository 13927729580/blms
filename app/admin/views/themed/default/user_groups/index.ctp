            ...
            <tr>
                ...
                <td class="am-action">
                   ...
                   <?php  }?><?php if($svshow->operator_privilege("user_groups_remove")){?>
                        <a class="am-btn am-btn-default am-text-danger am-btn-sm am-radius" href="<?php echo $admin_webroot; ?>user_groups/remove/<?php echo $v['UserGroup']['id']; ?>" onclick="return confirm('<?php echo $ld['confirm_delete'] ?>');"> <span class="am-icon-trash-o"></span> <?php echo $ld['delete']; ?></a>
                    <?php }?>
                </td>
            </tr>
        <?php }}else{ ?>
