...
<div>
	<?php echo $form->create('sms_send_histories',array('action'=>'index','name'=>"SearchLogsForm","type"=>"get","class"=>"am-form am-form-horizontal"));?>
	...
	<div class="am-panel-group am-panel-tree">
		<div class=" am-panel-header">
			<div class="am-panel-hd listtable_div_btm">
				<div class="am-panel-title">
					<div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $ld['mobilephone_number']?></div>
					<div class="am-u-lg-5 am-u-md-5 am-u-sm-7"><?php echo $ld['content']?></div>
					<div class="am-u-lg-2 am-u-md-2 am-hide-sm-only"><?php echo $ld['create_time']?></div>
		...
		<?php if(isset($sms_send_histories_logs) && sizeof($sms_send_histories_logs)>0){foreach($sms_send_histories_logs as  $k=>$v){?>	
			<div>
				<div class="listtable_div_top am-panel-body">
					<div class="am-panel-bd">					
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo $v['SmsSendHistory']['phone']?></div>
						<div class="am-u-lg-5 am-u-md-5 am-u-sm-7"> &nbsp;<?php echo $v['SmsSendHistory']['content'];?></div>
						<div class="am-u-lg-2 am-u-md-2 am-hide-sm-only"> &nbsp;<?php echo $v['SmsSendHistory']['created'];?></div>
						<div class="am-u-lg-1 am-u-md-1 am-hide-sm-only">
							<?php if($v['SmsSendHistory']['flag']){?>
					 ...
					 <?php echo $html->link($ld['view'],'/sms_send_histories/view/'.$v['SmsSendHistory']['id'],array('class'=>"am-btn am-btn-xs am-btn-success am-icon-eye"),false,false);?> 
						</div>
						<div style="clear:both;"></div>
					</div>
				</div>
	...
	<?php if(isset($sms_send_histories_logs) && sizeof($sms_send_histories_logs)>0){?>
