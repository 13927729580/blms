	...
	<div class="am-form-group">
		<ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1 am-thumbnails am-form am-form-horizontal">
			...
			<li>
				...
				<div class="am-u-lg-9 am-u-md-9 am-u-sm-8">
    		    	<input type="text" placeholder="<?php echo $ld['title'].'/'.$ld['keyw'];?>" name="title" value="<?php echo @$titles?>" ></div>
			</li>
					<li>
			  <div class="am-u-lg-3 am-u-md-3 am-u-sm-4">
				...
				<label class="am-u-lg-9 am-u-md-9 am-u-sm-8 am-form-label"><input  type="button" value="<?php echo $ld['advanced_search']?> " id="shuangji" class="am-btn am-btn-xs am-btn-default  am-form-label am-left"  <!--onclick="sv_advanced_search(this,'advanced_article')"-->			
					</label>
		    </li>
	...
	<div class="am-form-group"  id="advanced_article" style="display:none;">
		<ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1 am-thumbnails am-form am-form-horizontal">
			...
			<li>
				...
				<div class="am-u-lg-4 am-u-md-3 am-u-sm-4" style="padding-right:0;width:36%;">
					<div class="am-input-group">
					<input class="" type="text" data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}" readonly  name="start_date" style="min-height:38px;" value="<?php echo $start_date;?>"  placeholder=""/>
					<span class="am-input-group-label" onclick="cla(this)" style="cursor:pointer;">
                <i class="am-icon-remove"></i>
              </span>
            </div>
				</div>
				<label style="padding:0;width:4%;" class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-hide-sm-only am-text-center"><em>-</em></label>
				<div class="am-u-lg-4 am-u-md-3 am-u-sm-4 am-u-end" style="padding-left:0;padding-right:0;width:32%;">
					<div class="am-input-group">
					<input class="" type="text" data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}" readonly  name="end_date" style="min-height:38px;" value="<?php echo $end_date;?>"  placeholder=""/>
					<span class="am-input-group-label" onclick="cla(this)" style="cursor:pointer;">
                <i class="am-icon-remove"></i>
              </span>
            </div>
	...
	<div class="am-u-lg-2  am-u-md-2  am-hide-sm-only">	
		<div class="am-panel-group am-panel-tree" id="accordion" >
			<div class="listtable_div_btm am-panel-header">
				<div class="am-panel-hd" style="">
			      	<div class="am-panel-title">
						 <div style="padding:0;" class="am-u-lg-6 am-u-md-8 am-u-sm-8"><?php echo $ld['category_article'];?></div>
		...
		<!--一级菜单-->
			...
			<div>
				<div class="listtable_div_top am-panel-body" >
				    <div class="am-panel-bd fuji" style="padding-top: 12%;">
						<div class="am-u-lg-6 am-u-md-8 am-u-sm-8 " style="padding:0;margin-top: 2px;">
							<span data-am-collapse="{parent: '#accordion', target: '#action_<?php echo $v['CategoryArticle']['id']?>'}" class="<?php echo (isset($v['SubCategory'])&&!empty($v['SubCategory']))?"am-icon-plus":"am-icon-minus";?>"></span>&nbsp;
							<?php echo $html->link("{$v['CategoryArticleI18n']['name']}","/articles/?article_cat={$v['CategoryArticle']['id']}",array("style"=>" color:black;","class"=>"list"),false,false);?>
						</div>
						<div class="am-u-lg-4 am-u-md-4 am-u-sm-4 seolink am-action " style="">
					...
					<div class="am-panel-collapse am-collapse am-panel-child" id="action_<?php echo $v['CategoryArticle']['id']?>"  >
						<?php foreach ($v['SubCategory'] as $kk=>$vv){?>
							<div class="am-panel-bd am-panel-childbd actionn_<?php echo $vv['CategoryArticle']['id']?>">
								<div class="am-u-lg-6 am-u-md-8 am-u-sm-8 " style="padding: 0;margin-top: 4px;">	
									<span data-am-collapse="{parent: '#action_<?php echo $v['CategoryArticle']['id']; ?>', target: '#actionn_<?php echo $vv['CategoryArticle']['id']?>'}" class="<?php echo (isset($vv['SubCategory']) && !empty($vv['SubCategory']))?"am-icon-plus":"am-icon-minus";?>" style="margin-left:15px;position: absolute;top: 4px;"></span>&nbsp;
									<?php echo $html->link("{$vv['CategoryArticleI18n']['name']}","/articles/?article_cat={$vv['CategoryArticle']['id']}",array( "class"=>"am-btn  am-btn-xs am-text-secondary list am-seevia-btn-view","style"=>"color:black;padding-left:0;padding-right:0;margin-left:23px;"),false,false);?>
								</div>
							...
							<?php if(isset($vv['SubCategory'])&& sizeof($vv['SubCategory'])>0){?>
								<div class="am-panel-collapse am-collapse am-panel-subchild" id="actionn_<?php echo $vv['CategoryArticle']['id']?>">	
									<?php foreach($vv['SubCategory'] as $kkk=>$vvv){?>
										<div class="am-panel-bd am-panel-childbd" style="padding-right: 0;">
											<div class="am-u-lg-8 am-u-md-8 am-u-sm-8" style="width: 92px;padding:0;padding-left: 15px;margin-top: 3px;">	
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $html->link("{$vvv['CategoryArticleI18n']['name']}","/articles/?article_cat={$vvv['CategoryArticle']['id']}",array("style"=>"text-decoration:none;color:black;","class"=>"list"),false,false);?>
											</div>
											<div class="am-u-lg-4 am-u-md-4 am-u-sm-4 seolink am-btn am-btn-xs am-text-secondary am-seevia-btn-view yulan" style="background-color: #5eb95e;width: 66px;height: 26px;line-height: 25px;padding:0;">
												<span class="am-icon-eye" style="color: white"></span>
			...
			<div class=" listtable_div_top am-panel-body">	
				<div class="am-panel-bd am-g">
					...
					<div class="am-u-lg-1 am-u-md-1 am-u-sm-2">
						...
						<!--<?php echo $html->image('/admin/skins/default/img/yes.gif',array('style'=>'cursor:pointer;','onclick'=>'listTable.toggle(this, "articles/toggle_on_status", '.$v["Article"]["id"].')'))?>-->
						...
						<?php }else{?>
						<!--<?php echo $html->image('/admin/skins/default/img/no.gif',array('style'=>'cursor:pointer;','onclick'=>'listTable.toggle(this, "articles/toggle_on_status", '.$v["Article"]["id"].')'));?>-->
					...
					<div class="am-u-lg-1 am-u-md-1 am-hide-md-down">
						...
						<!--<?php echo $html->image('/admin/skins/default/img/yes.gif',array('style'=>'cursor:pointer;','onclick'=>'listTable.toggle(this, "articles/toggle_on_recommand", '.$v["Article"]["id"].')'))?>-->
...
<!--双击搜索消失-->
$('#shuangji').click(function(){
	$('#advanced_article').toggle();
});
...
$(function(){
	...
	$subchild.on('opened.collapse.amui', function() {
		if($(this).hasClass('am-in')){
			var parentbody2=$(this).prev(".am-panel-childbd");
...
for(var i = 0;i<list.length;i++){
	var list_a=list[i].text;//原始字符串
	if(list_a.length>3){
	  list_b=list_a.substring(0,3)+"...";
	  list[i].innerText = list_b;
	}
}
</script>
