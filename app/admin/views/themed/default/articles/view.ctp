...
<input type="submit" class="am-btn am-btn-success am-radius am-btn-sm" onclick="return cha2()" value="<?php echo $ld['d_submit'];?>" style="margin-right:20px;" />
...
<!-- 编辑按钮区域 -->
	      		...
	      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">	
					...
					<div class="am-form-group" >
						...
						<div class="am-u-lg-8 am-u-md-6 am-u-sm-9">
							<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">	
								<input type="text" class="input_sort" name="data[Article][orderby]" value="<?php echo isset($article['Article']['orderby'])?$article['Article']['orderby']:50;?>" />
							</div>
						</div>
					</div>
					<div class="am-form-group">
					...
					<div class="am-form-group">
						<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-view-label"><?php echo $ld['content_image']?></label>
						<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
							<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
							<div class="am-u-lg-9 am-u-md-9 am-u-sm-9" style="margin-top:10px;">					
								<input id="articleI18n_02_<?php echo $v['Language']['locale'];?>" type="text" name="data[ArticleI18n][<?php echo $k;?>][img02]" value="<?php echo isset($article['ArticleI18n'][$v['Language']['locale']])?$article['ArticleI18n'][$v['Language']['locale']]['img02']:'';?>" />
								
								<input type="button" class="am-btn am-btn-xs am-btn-success am-radius" onclick="select_img('articleI18n_02_<?php echo $v['Language']['locale'];?>')" value="<?php echo $ld['choose_picture']?>"  style="margin-top:5px;"/>
								...
								<div class="img_select" style="margin:5px;">
									<?php echo $html->image((isset($article['ArticleI18n'][$v['Language']['locale']]['img02'])&&$article['ArticleI18n'][$v['Language']['locale']]['img02']!="")?$article['ArticleI18n'][$v['Language']['locale']]['img02']:$configs['shop_default_img'],array('id'=>'show_articleI18n_02_'.$v['Language']['locale']))?>
								</div>
							</div>
						<?php }}?>
						</div>
				   ...
				   <div class="am-form-group">
						...
						<div class="am-u-lg-10 am-u-md-9 am-u-sm-9">
							...
							<div class="am-u-lg-10 am-u-sm-9 am-padding-left-0">
								<div class="am-form-group">
									<?php echo $this->element('editor',array('editorName'=>"data[ArticleI18n][{$k}][content]",'editorId'=>'elm'.$v['Language']['locale'],'editorValue'=>isset($article['ArticleI18n'][$v['Language']['locale']]['content'])?$article['ArticleI18n'][$v['Language']['locale']]['content']:'','editorLang'=>$v['Language']['google_translate_code'])); ?>
								</div>
							</div>
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
							<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">	
								<label class="am-radio am-success">
									<input type="radio" data-am-ucheck name="data[Article][front]" value="1" <?php echo isset($article['Article']['front'])&&$article['Article']['front']=='1'?'checked':''; ?> />
									<?php echo $ld['yes']?>
								</label>&nbsp;&nbsp;&nbsp;&nbsp;
								<label class="am-radio am-success">
									<input type="radio" data-am-ucheck name="data[Article][front]" value="0" <?php echo !isset($article['Article']['front'])||isset($article['Article']['front'])&&$article['Article']['front']=='0'?'checked':''; ?> />
									<?php echo $ld['no']?>
								</label>
							</div>
							<label class="am-u-lg-3 am-u-md-3 am-u-sm-3 am-form-group-label"><em style="color:red;">*</em></label>
					...
					<div class="am-form-group">
						...
						<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
							<div class="am-u-lg-9 am-u-md-9 am-u-sm-9" style="margin-top:10px;">	
								<span style="line-height: 35px;"><?php echo isset($article['Article']['created'])?$article['Article']['created']:'';?></span>
							</div>
						</div>
					</div>
	 ...
	 <div  id="advanced_set_up"class="am-panel am-panel-default" >
		    ...
		    <div class="am-panel-collapse am-collapse am-in">
	      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
	      		 <div class="am-form-group">
    		    			<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-group-label"><?php echo "SEO".$ld['attribute']?></label>
    		    			<div class="am-u-lg-8  am-u-md-9 am-u-sm-9">
    		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
    		    					<input type='text' name="data[Article][seo_attribute]" value='<?php echo isset($article['Article']['seo_attribute'])?preg_replace('/\'/','&#39;',preg_replace('/\"/','&#34;',$article['Article']['seo_attribute'])):''; ?>' maxlength='100' />
    		    				</div>
    		    			</div>
    		    		</div>
				...
				<div class="am-form-group">
					...
					<div class="am-form-group">
		    			...
		    			<div class="am-u-lg-10 am-u-md-9 am-u-sm-9">
						<?php
							if(isset($Resource_info['article_tamplate'])&&sizeof($Resource_info['article_tamplate'])>0){
								foreach($Resource_info['article_tamplate'] as $k=>$v){
						?>
						<div class="am-u-lg-3 am-u-md-3 am-u-sm-3">
							<label class="am-radio am-success">
								<input type="radio" name="data[Article][template]" value="<?php echo $k; ?>"  data-am-ucheck <?php echo isset($article['Article']['template'])&&$article['Article']['template']==$k?'checked':''; ?> /><?php echo $html->image($v,array('style'=>'width:80%;height:auto;')); ?>
							</label>
						</div>
						<?php }} ?>
		    			</div>
					...
					<div class="am-form-group">
		    			...
		    			<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
		    				...
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">(<?php echo $ld['routeurl_desc'] ?>)</div>
		    				
		    			</div>
		    		</div>
					<div class="am-form-group">
		    			<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-view-label" style="margin-top:10px;"><?php echo $ld['files_upload']?></label>
		    			<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
		    				<div class="am-u-lg-11 am-u-md-11 am-u-sm-11">	
								<input type="file" name="data_file" id="file" />
							</div>
							<div class="am-u-lg-11 am-u-md-11 am-u-sm-11">(<?php echo $ld['only']?> pdf、doc、docx、xls、xlsx)</div>
							<input type="hidden" name="data[Article][file]" value="<?php echo isset($article['Article']['file'])?$article['Article']['file']:'';?>" />
		    			</div>
		    		</div>	
					<div class="am-form-group">
		    			<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-view-label" style="margin-top:15px;"><?php echo $ld['article'].$ld['video']?>Id</label>
		    			<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">	
					...
					<div class="am-form-group">
		    			<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-view-label" style="margin-top:10px;"><?php echo $ld['video_upload']?></label>
		    			<div class="am-u-lg-8 am-u-md-9 am-u-sm-9">
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">	
								<input type="file" name="upload_video" id="upload_video" />
							</div>
							<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">(<?php echo $ld['only']?> MP4 <?php echo $ld['prod_type_format']?>)</div>
					...
					<div class="am-form-group">
		    			...
		    			<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
		    				<div class="am-u-lg-9 am-u-md-9 am-u-sm-9" style="margin-top:10px;">	
		    					<textarea name="data[ArticleI18n][<?php echo $k;?>][content2]"><?php echo isset($article['ArticleI18n'][$v['Language']['locale']])?htmlspecialchars($article['ArticleI18n'][$v['Language']['locale']]['content2']):'';?></textarea>
		    				</div>
	    					<?php if(sizeof($backend_locales)>1){?>
	    						<label class="am-u-lg-3 am-u-md-3 am-u-sm-3 am-form-group-label am-text-left" style="font-weight:normal;padding-top:10px;"><?php echo $ld[$v['Language']['locale']]?></label>
	    					<?php }?>&nbsp;
