...
<input style="margin-right:15px" class="am-btn am-btn-success am-radius am-btn-sm" type="reset" value="<?php echo $ld['d_reset']?>" />
</div>
<!-- 编辑按钮区域 -->
		...
		<?php }}?>
		<div class="am-panel-group admin-content" id="accordion" style="width:83%;float:right;margin-right:23px;">
				...
				<div class="am-panel-collapse am-collapse am-in">
				    <div class="am-panel-bd am-form-detail am-form am-form-horizontal">
						...
						<div class="am-form-group">
							...
							<div class="am-u-lg-10 am-u-md-9 am-u-sm-9">
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9" >
									<select id="CategoryParentId" name="data[CategoryArticle][parent_id]" data-am-selected="" >
						...
						<div class="am-form-group" >
							...
							<div class="am-u-lg-10 am-u-md-9 am-u-sm-9" style="margin-bottom: -1.3em;">
							<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9" style="margin-top:10px;">
					...
					<div class="am-panel-collapse am-collapse am-in">	
					<div style="border:0px " class="am-panel-bd ">
					 <label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-group-label"><?php echo $ld['r_description']?></label>
							<div class="am-u-lg-10  am-u-md-9 am-u-sm-9">			
				...
				<div class="am-panel-collapse am-collapse am-in">
			    	<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
						...
						<div class="am-form-group">
							...
							<div class="am-u-lg-10 am-u-md-9 am-u-sm-9">
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
									<select name="data[CategoryArticle][template]" data-am-selected="{noSelectedText:'<?php echo $ld['please_select']; ?>'}">
									<option value=''><?php echo $ld['please_select'] ?></option>
									<?php
										if(isset($Resource_info['article_category_template'])&&sizeof($Resource_info['article_category_template'])>0){
											foreach($Resource_info['article_category_template'] as $k=>$v){
									?>
									<option value='<?php echo $k; ?>' <?php echo isset($this->data['CategoryArticle']['template'])&&$this->data['CategoryArticle']['template']==$k?'selected':''; ?>><?php echo $v; ?></option>
									<?php }} ?>
								</select>
								</div>
							</div>
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-3 am-u-sm-3 am-form-group-label"><?php echo $ld['article_template']; ?></label>
							<div class="am-u-lg-10 am-u-md-9 am-u-sm-9">
								<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
									<select name='data[CategoryArticle][article_template]' data-am-selected="{noSelectedText:'<?php echo $ld['default']; ?>',maxHeight: 100}">
										...
										?>
										<option value='<?php echo $k; ?>' <?php echo isset($this->data['CategoryArticle']['template'])&&$this->data['CategoryArticle']['article_template']==$k?'selected':''; ?>><?php echo $v; ?></option>
										<?php }} ?>
									</select>
								</div>
							</div>
