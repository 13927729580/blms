...
<?php
	$browser_infos=array(
		'ie'=>'/admin/skins/default/img/broswer/IE.png',
		'opera'=>'/admin/skins/default/img/broswer/OP.png',
		'firefox'=>'/admin/skins/default/img/broswer/FF.png',
		'chrome'=>'/admin/skins/default/img/broswer/CH.png',
		'safari'=>'/admin/skins/default/img/broswer/SF.png',
		'edge'=>'/admin/skins/default/img/broswer/IE.png',
		'qq'=>'/admin/skins/default/img/broswer/QQ.png'
	);
?>
<div class="">
	...
	<ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1 am-thumbnails">
		...
		<li style="margin-top:10px;">
			...
			<div class="am-u-lg-4 am-u-md-4 am-u-sm-4">
				<input type="text" name="date1"  class="am-form-field"  data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}"  value="<?php echo @$date1;?>" placeholder="起始" readonly>
			</div>
			<div class="am-u-lg-4 am-u-md-4 am-u-sm-4">
				<input type="text" name="date2"  class="am-form-field" data-am-datepicker="{theme:'success',locale:'<?php echo $backend_locale; ?>'}"  value="<?php echo @$date2;?>" placeholder="结束" readonly>
			</div>
		</li>
					...
					<div class="am-panel-bd">
						<div class="am-u-lg-3 am-u-md-3 am-u-sm-2 am-hide-sm-only">
							<label class="am-checkbox am-success">
								...
								<?php $time=explode(" ",$v["OperatorLog"]["created"]);echo $time[0].' '.$time[1];?><br>
								<?php
								//输出浏览器图片
								$browser_text=trim($v["OperatorLog"]['browser']);
								$browser_name=preg_replace('|[0-9.]+|','',$browser_text);
								$browser_name=strtolower($browser_name);
								$browser_image=isset($browser_infos[$browser_name])?$browser_infos[$browser_name]:'';
								echo $browser_image!=''?($html->image($browser_image,array('title'=>$browser_text,'style'=>'width:20px;'))):$browser_text;
						?>&nbsp;
								<?php echo $v["OperatorLog"]["ipaddress"]; ?>
							</label>
						</div>
