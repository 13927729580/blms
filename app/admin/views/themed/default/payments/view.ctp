...
<div class="btnouter am-text-right" data-am-sticky="{top:'100px',animation:'slide-top'}" style="margin-bottom:0;">
    <input type="submit" class="am-btn am-btn-success am-radius am-btn-sm" value="<?php echo $ld['d_submit']?>" style="margin-right:20px;"/> 
            ...
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table">
                    ...
                    <tr>
                        ...
                        <td><input style="width:60%;float:left;" type="text" id="payment_code" name="data[Payment][code]" value="<?php echo isset($payment['Payment']['code'])?$payment['Payment']['code']:''; ?>" onchange="checkpaymentcode(this,1)" /><em style="color:red;">*</em></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:60%;" name="data[Payment][fee]" value="<?php echo isset($payment['Payment']['fee'])?$payment['Payment']['fee']:0; ?>" id='fee'/></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px">Logo</th>
    					<td><input style="width:60%;float:left;margin-right:5px;" id="payment_logo" type="text" name="data[Payment][logo]" value="<?php echo isset($payment['Payment']['logo'])?$payment['Payment']['logo']:'';?>" /><input type="button"  class="am-btn am-btn-xs am-btn-success am-radius" onclick="select_img('payment_logo')" value="<?php echo $ld['choose_picture']?>" />&nbsp;
