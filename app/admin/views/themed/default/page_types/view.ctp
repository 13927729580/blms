...
<input type="hidden" name="data[PageType][id]" value="<?php echo isset($this->data['PageType']['id'])?$this->data['PageType']['id']:0; ?>" />
        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <table class="am-table" id="hotel_img_ul">
                    <tr>
                        <th style="padding-top:13px;width: 20%;"><?php echo $ld['type']?></th>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:50%;float:left;" class="border" name="data[PageType][name]" value="<?php if(isset($this->data['PageType']['name'])){echo $this->data['PageType']['name'];} ?>" /><em>*</em></td>
                    </tr>
                    <tr>
                        <th style="padding-top:18px;"><?php echo $ld['module_style']?></th>
                        <td><input type="text" style="width:50%;float:left;" class="border" name="data[PageType][css]" value="<?php if(isset($this->data['PageType']['css'])){echo $this->data['PageType']['css'];} ?>" /><em>*</em></td>
                    </tr>
                    <tr>
                ...
                <div>
                    ...
                    <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                        <?php if($svshow->operator_privilege("page_types_add")){?>
                            <p class="am-u-md-12">
                                <h2 style="float: left;margin-top: 0;"><?php echo $ld['view_page_style']?></h2>
                                <?php echo $html->link($ld['add_module_page'],"/page_actions/page_action_view/0?type_id=".$id,array("class"=>"am-btn am-btn-warning am-btn-sm am-fr","target"=>"_blank",'style'=>'float:right'),'',false,false);?>
                            </p>
                        <?php }?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php }if($svshow->operator_privilege("page_types_remove")){?>
                                                <a class="scan am-btn am-btn-default am-btn-xs am-text-danger am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'page_actions/remove/<?php echo $v['PageAction']['id'] ?>');">
