	...
	<div class="am-panel-group am-panel-tree">
		<div class="  listtable_div_btm am-panel-header">
			<div class="am-panel-hd">
				<div class="am-panel-title am-g">
					...
					<div class="am-u-lg-3 am-u-md-4 am-u-sm-5"><?php echo $ld['z_operation']?></div>
				</div>
			</div>
		</div>
		...
		<div class="listtable_div_top am-panel-body">
			<div class="am-panel-bd am-g">
				<div class="am-u-lg-3 am-u-md-4 am-u-sm-5">
				<div class="am-cf">
					<label class="am-checkbox am-success  am-hide-sm-only" style="padding-top:0;display:inline;max-width:20px;float:left;">
						<input type="checkbox" name="checkbox[]" data-am-ucheck value="<?php echo $v['Page']['id']?>" />
						</label>
						<span onclick="javascript:listTable.edit(this, 'static_pages/update_page_title/', <?php echo $v['Page']['id']?>)" style="float:left;"><?php echo $v['PageI18n']['title'] ?></span>
				</div>					
				...
				<?php //pr($v) ?>
				<div class="am-u-lg-2 am-show-lg-only"><span onclick="javascript:listTable.edit(this, 'static_pages/update_page_subtitle/', <?php echo $v['PageI18n']['id']?>)"><?php echo $v['PageI18n']['subtitle'] ?></span>&nbsp;</div>
		...
		<div class="am-u-lg-5 am-u-md-6 am-u-sm-12 am-hide-sm-only" style="margin-left:7px;">
            ...
            <div class="am-fl">
	    			<select name="act_type" id="act_type" onchange="operate_change(this)" data-am-selected>
	    				...
	    				<?php   if($svshow->operator_privilege("static_pages_remove")){?>
