			...
			<div class="am-panel am-panel-default am-panel-body">
				<div class="am-panel-bd">					
					<div class="am-u-lg-4 am-u-md-4 am-u-sm-4" style="margin-top:7px;">
            			...
            			<a class="toggle_p" onclick="region('<?php echo $v['Region']['id']; ?>',this)"  style="cursor:pointer;">展开子集地区</a>
            			<?php }?>
					</div>	
...
function region(id,obj){
    ...
    if($(obj).hasClass('toggle_p')){
    	$(obj).html('收起子集地区').removeClass('toggle_p');
    	
    }else{
    	$(obj).html('展开子集地区').addClass('toggle_p');
    }
...
// 	$(".toggle_p1").eq(0).on('click',function(){
// 		if($(".toggle_p1").eq(0).html() == '展开子集地区'){
// 			$(".toggle_p1").eq(0).html('收起子集地区');
// 		}else{
// 			$(".toggle_p1").eq(0).html('展开子集地区');
// 		}		
// 	});
// 	$(".toggle_p1").eq(1).on('click',function(){
// 		if($(".toggle_p1").eq(1).html() == '展开子集地区'){
// 			$(".toggle_p1").eq(1).html('收起子集地区');
// 		}else{
// 			$(".toggle_p1").eq(1).html('展开子集地区');
// 		}		
// 	});
