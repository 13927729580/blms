...
<div id="tablelist" class="tablelist am-u-md-12 am-u-sm-12">
    <table class="am-table  table-main">
        ...
        echo $html->link(' '.$ld['remove'],"javascript:void(0);",array("class"=>"am-btn am-icon-trash-o am-btn-default am-text-danger am-btn-xs am-radius","onclick"=>"list_delete_submit('{$admin_webroot}scores/removelog/{$v['id']}')"));} ?></div>
    </td>
<?php } ?>
    </tr>
<?php }}else{ ?>
