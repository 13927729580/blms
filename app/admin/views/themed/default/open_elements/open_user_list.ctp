...
<div id="btnouterlist" class="btnouterlist">
    <div>
        ...
        <input type="button" class="am-btn am-btn-success am-radius am-btn-sm" value="<?php echo '发送所有'?>" onclick="send_all()" />
        <input type="button" class="am-btn am-btn-success am-radius am-btn-sm" value="<?php echo $ld['preview']?>" onclick="batch_preview()" />
        <a href="<?php echo $html->url('/open_users/index'); ?>" target='_blank' class='am-btn am-btn-warning am-radius am-btn-sm'>更新关注用户</a>
    </div>
