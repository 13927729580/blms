    ...
    <div id="tablemain" class="am-panel am-panel-default">
        ...
        <div id="basic_information" class="am-panel-collapse am-collapse am-in">
            <div class="am-panel-bd am-form-detail am-form am-form-horizontal" style="padding-bottom:0;">
                <div>
                    <select id="toppage" name="toppage" onChange="changeHome()" data-am-selected="{maxHeight:280}">
                        ...
                        <option value="TOPIC"><?php echo $ld['topics']?></option>
                    </select>
                    <div>
                        <label>外部素材链接：</label><input class="span5" style="width: 500px;" type='text' name='other-element-url' id='other-element-url' />
                        <input class="am-btn am-btn-success am-btn-sm" type="button" value="采集内容" onclick="getContents()">
                    </div>
                </div>
                <div id="top_div" style="margin:0.7rem auto;display:none;"></div>
                <div id="smallmenu">
                    <div class="msg-item" id="m_item">
                        <div onclick="disright()" style="cursor:pointer;">
                            ...
                            <div class="cover">
                                <?php echo $html->image(isset($this->data['OpenElement'])&&$this->data['OpenElement']['media_url']!=""?$this->data['OpenElement']['media_url']:$element_default_img,array('onload'=>'set_flash_img(this,352,156)','onclick'=>'select_imge("tip100")','class'=>'default-tip','id'=>'show_tip100'));?>
                            </div>
                        ...
                        if($type==2){//多图文
                            if(!isset($manypic)||empty($manypic)){
                                ...
                                <div class="titlediv" id="tit0" onmousemove="back1(0)" onmouseleave="back2(0)" onmouseout="back2(0)">
                                    ...
                                    <?php echo $html->image($element_default_img,array('class'=>'smallback','id'=>'show_tip0'));?>
                                ...
                                foreach($manypic as $k=>$v){
                                    ...
                                    <div class="titlediv" id="tit<?php echo $k;?>" onmousemove="back1(<?php echo $k;?>)" onmouseleave="back2(<?php echo $k;?>)" onmouseout="back2(<?php echo $k;?>)">
                                        ...
                                        <?php echo $html->image(!empty($v['OpenElement']['media_url'])?$v['OpenElement']['media_url']:$element_default_img,array('class'=>'smallback','id'=>'show_tip'.$k,'onclick'=>"select_imge('tip".$k."')"));?>
                    ...
                    <div id="rightmenu">
                        ...
                        <div id="right" class="msg-editer-wrapper" >
                            ...
                            <div class="msg-editer-wrapper1" style="width:700px;">
                                <div class="msg-editer">
                                    ...
                                    <div class="control-group group_title" >
                                        ...
                                        <div class="group_title">
                                            <input class="op_title span5" id="title100" onkeyup="strLenCalc(100)" type="text" name="data[100][OpenElement][title]" style="width: 679px;" value="<?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['title'];}?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">排序值</label>
                                        <div>
                                            <input class="span5" id="seq100" type="text" name="data[100][OpenElement][seq]" style="width: 100px;" value="<?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['seq'];}?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="uplod" id="uplod100" style="<?php echo (!empty($this->data['OpenElement']['media_url']))?'':'display:none;';?>;width:676px;" >
                                        <div style="float:left;">
                                            <?php echo $html->image(isset($this->data['OpenElement'])&&$this->data['OpenElement']['media_url']!=""?$this->data['OpenElement']['media_url']:$element_default_img,array('class'=>'show_media_url','id'=>'show1_tip100'));?>
                                        </div>
                                    ...
                                    <div class="control-group group_content">
                                        ...
                                        <div class="choosebutton" style="border:none">
                                            <textarea  style="z-index:200;resize:none;height:300px; width:676px;top:-4px;position:relative;left:-2px;overflow:hidden;" class="op_description" id="description100" name="data[100][OpenElement][description]"><?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['description'];}?></textarea>
                                            <script type="text/javascript">
                                                var editor;
                                    ...
                                    <?php if(empty($this->data['OpenElement']['url'])){?>
                                        ...
                                        <div class="control-group out_address dis_none" id="outadd100">
                                            ...
                                            <div><input id="url100" class="span5" type="text" name="data[100][OpenElement][url]" style="width: 679px;" value="<?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['url'];}?>">
                                            </div>
                                        </div>
                                    <?php }else{?>
                                        <div class="control-group out_address" id="outadd100">
                                            <label class="control-label" ><?php echo $ld['external_chain'].$ld['address']; ?></label>
                                            <span class="help-inline">(<?php echo $ld['external_chain_desc'] ?>)</span>
                                            <div><input id="url100" class="span5" type="text" name="data[100][OpenElement][url]" style="width: 679px;" value="<?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['url'];}?>"></div>
                                        </div>
                                    <?php }?>
                                    <?php if(empty($this->data['OpenElement']['link'])){?>
                                        ...
                                        <div class="control-group out_source dis_none" id="ors100">
                                            ...
                                            <div><input id="url100" class="span5" type="text" name="data[100][OpenElement][link]" style="width: 679px;" value="<?php if(isset($this->data['OpenElement'])){echo $this->data['OpenElement']['link'];}?>"></div>
                                        </div>
                                    <?php }else{?>
                                ...
                                <div>
                                    <div class="msg-editer">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">排序值</label>
                                            <div>
                                                <input class="span5" id="seq0" type="text" name="data[0][OpenElement][seq]" style="width: 100px;" value="0">
                                            </div>
                                        </div>
                                        <div class="control-group group_img">
                                            <label class="control-label"><?php echo $ld['cover'] ?></label>
                                        ...
                                        <div class="uplod" id="uplod0" style="display:none;">
                                            <div style="float:left;"><?php echo $html->image($element_default_img,array('class'=>'show_media_url','id'=>'show1_tip0'));?></div>
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    KindEditor.ready(function(K) {
                                                        editor = K.create('#description0', {
                                                            ...
                                                            newlineTag:'p',
                                                            items : [
                                                                'source','fontname', 'fontsize',  'selectall' ,'|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline',
                                                                'removeformat', '|', 'justifyleft', 'justifycenter', 'justifyright', 'insertorderedlist',
                                                                'insertunorderedlist', '|', 'emoticons', 'image', 'link','fullscreen'],
                                                            afterBlur: function(){this.sync();}});
                                                    });
                                    ...
                                    <div>
                                        <div class="msg-editer">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">排序值</label>
                                                <div>
                                                    <input class="span5" id="seq<?php echo $k;?>" type="text" name="data[<?php echo $k;?>][OpenElement][seq]" style="width: 100px;" value="<?php if(isset($v['OpenElement']['seq'])){echo $v['OpenElement']['seq'];}?>">
                                                </div>
                                            </div>
                                            <div class="control-group group_img">
                                                <label class="control-label"><?php echo $ld['cover'] ?></label>
                                            ...
                                            <div class="uplod" id="uplod<?php echo $k;?>" style="<?php echo (!empty($v['OpenElement']['media_url']))?'':'display:none;';?>">
                                                <div style="float:left;"><?php echo $html->image($v['OpenElement']['media_url'],array('class'=>'show_media_url','id'=>'show1_tip'.$k));?></div>
                                            ...
                                            <div class="control-group group_content">
                                                ...
                                                <span class="help-inline">(<?php echo $ld['required'] ?>)</span>
                                                <div class="choosebutton" style="border:none">
                                                    <textarea style="resize:none;height:275px; width:676px;top:-4px;position:relative;left:-2px;overflow:hidden;" class="op_description" id="description<?php echo $k;?>" name="data[<?php echo $k;?>][OpenElement][description]"><?php if(!empty($v['OpenElement']['description'])){echo $v['OpenElement']['description'];}?></textarea>
                                                    <script type="text/javascript">
...
<script>
    $(function(){
        ...
        if(typeof(element_Id)!="undefined"&&element_Id==""){
            $(".default-tip").attr("src",admin_webroot+"skins/default/img/element_add_default.png");
            $(".smallback").attr("src",admin_webroot+"skins/default/img/element_add_default.png");
        }
        $("#open_type_id").change(function(){
            var open_type_id=$(this).val();
            $.ajax({ url: admin_webroot+"open_elements/open_user_list/"+encodeURI(open_type_id),
                dataType:"html",
                data: {},
    ...
    function send_all(){
        if(confirm("是否群发微信")){
            ...
            $.ajax({
                url: admin_webroot+"open_elements/sendAll",
                dataType:"json",
                type:"POST",
                data:{'element_id':element_id,'open_type_id': open_type_id,'element_type':element_type},
                success: function(data){
                    alert(data.msg);
                }
            });
    ...
    function ajax_send(touser,send_type){
        ...
        var element_id=$("#element_id").val();
        if(open_type_id!=""){
            $.ajax({ url: admin_webroot+"open_elements/send",
                dataType:"json",
                type:"POST",
    ...
    function changeHome(){
        var route=document.getElementById("toppage").value;
        if(route==""){
            $("#top_div").html("").hide();
            return;
        }
        ...
        $.ajax({
            ...
            success: function (result) {
                $("#top_div").html(result).show();
                if(document.getElementById("next_toppage")){
                    setHomepage();
                }
                $("#top_div select").selected();
            }
        });
    }

    function getCurrShowDiv(){
        var res;
        $('.msg-editer-wrapper').each(function(key,name){
            if(!$(this).is(':hidden')){
                res = $(this).attr('id');
            }
        });
    ...
    function setHomepage(){
        var route=document.getElementById("toppage").value;
        if(!route) return;
        var id = document.getElementById("next_homepage").value;
        var show_div = getCurrShowDiv();
        var add_content_textarea = $('#' + show_div).find('textarea').last().attr('id');
        var add_title_input = $('#' + show_div).find('.group_title').find('input').attr('id');
        var add_title_div_num;
        var num = show_div.substr(5);
        if(num === '')
            add_title_div_num = '100';
        else
            add_title_div_num = num;
        if(route == 'PAGE'){
            $.ajax({
                type: "GET",
                url: admin_webroot+"open_elements/ajaxGetPageContent?id=" + id,
                dataType: 'html',
                success: function (result) {
                    KindEditor.html('#' + add_content_textarea,result);
                    KindEditor.sync('#' + add_content_textarea);
                }
            });
        }
        if(route == 'ARTICLE'){
            $.ajax({
                type: "GET",
                url: admin_webroot+"open_elements/ajaxGetArticleContent?id=" + id,
                dataType: 'json',
                success: function (result) {
                    KindEditor.html('#' + add_content_textarea,result.content);
                    $('#' + add_title_input).val(result.title);
                    strLenCalc(add_title_div_num);
                    KindEditor.sync('#' + add_content_textarea);
                }
            });
        }
        if(route == 'TOPIC'){
            $.ajax({
                type: "GET",
                url: admin_webroot+"open_elements/ajaxGetTopicContent?id=" + id,
                dataType: 'json',
                success: function (result) {
                    KindEditor.html('#' + add_content_textarea,result.intro);
                    $('#' + add_title_input).val(result.title);
                    strLenCalc(add_title_div_num);
                    KindEditor.sync('#' + add_content_textarea);
                }
    ...
    function getContents(){
        var get_url = $('#other-element-url').val();
        if(!get_url) return;
        $.ajax({
            type: "POST",
            url: admin_webroot+"open_elements/ajaxGetContents",
            dataType: 'json',
            data: {url:get_url},
            success: function (result) {
                var show_div = getCurrShowDiv();
                ...
                if(num === '')
                    ...
                    add_title_div_num = num;
                KindEditor.html('#' + add_content_textarea,result.data.content);
                KindEditor.sync('#' + add_content_textarea);
                $('#' + add_title_input).val(result.data.title);
                strLenCalc(add_title_div_num);
                $('#show1_tip' + add_title_div_num).attr('src',result.data.thumb);
                $('#show_tip' + add_title_div_num).attr('src',result.data.thumb);
                $('#tip' + add_title_div_num).val(result.data.thumb);
            }
        });
    }
</script>