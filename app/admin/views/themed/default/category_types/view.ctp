...
<div>
	...
	<div class="am-panel-group admin-content am-detail-view am-fr" id="accordion"  style="width:100%;padding-left:0;padding-right:0;">
			    ...
			    <div class="am-panel-collapse am-collapse am-in" style="margin-top:10px;margin-left:12px;">
					...
					<div class="am-form-group">
						<label class="am-u-lg-2 am-u-md-3 am-u-sm-3  am-view-label" style="padding-top:2px;"><?php echo $ld['category_code']?></label>
		    			            <div class="am-u-lg-9 am-u-md-9 am-u-sm-6">	<div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
			...
			<div id="associated_brand" class="am-panel am-panel-default">
			    ...
			    <div class="am-panel-collapse am-collapse am-in">
					...
					<div class="am-form-group" style="margin-top:15px;">	
				    	<div class="am-u-lg-6 am-u-md-6 am-u-sm-6 am-text-left" style="padding-left:25px;">
				    	...
				    	<div class="am-u-lg-6 am-u-md-6 am-u-sm-6 am-text-left">
							<label>
								<?php echo $ld['have_associated_brand']?></label>
