...
<div class="am-modal-dialog">
    ...
    <div class="am-modal-bd"  style="height:300px;overflow:auto;">
			...
			<div id="basic_information" class="am-panel-collapse am-collapse am-in">
	      		<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
					...
					<?php if(isset($informationresource_info)&&isset($informationresource_info[$v['Language']['locale']])){
						foreach($informationresource_info[$v['Language']['locale']] as $ik=>$i){ //pr($i); ?>
								
								<?php if($ik==$iik){?>
								<div class="am-form-group" style="margin-bottom:5px;"> 
									<div class="input_type am-u-lg-5 am-u-md-4 am-u-sm-4" id="informationresource_span_<?php echo $informationresource_id_info[$ik][$v['Language']['locale']]?>" onclick="showInput(<?php echo $informationresource_id_info[$ik][$v['Language']['locale']];?>)">
										<?php echo $i;
										?>
									</div>
					...
					<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>	
						<div class="am-form-group am-margin-top-xs">
							...
							<?php if(sizeof($backend_locales)>1){ ?>
								<div class="am-u-lg-1 am-u-md-1 am-u-sm-1" style="line-height:37px;"><?php echo $ld[$v['Language']['locale']]?></div>
							<?php }?>&nbsp;
							<?php if($k==0){?>
