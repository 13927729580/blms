		    ...
		    <div id="basic_information" class="am-panel-collapse am-collapse am-in">
		      	<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['system'] ?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
						<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
							<select data-am-selected="{maxHeight:150,noSelectedText:'<?php echo $ld['please_select']; ?>'}" name="data[InformationResource][system_code]">
							<option value=""><?php echo $ld['please_select']; ?></option>
							<?php if(isset($all_systems)&&sizeof($all_systems)>0){foreach($all_systems as $v){ ?>
							<option value="<?php echo $v; ?>" <?php echo isset($this->data['InformationResource']['system_code'])&&$this->data['InformationResource']['system_code']==$v?'selected':''; ?>><?php echo $v; ?></option>
							<?php }} ?>
						</select>
						</div>
						</div>
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['module'] ?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
						<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
							<input type='text' name="data[InformationResource][module_code]" value="<?php echo isset($this->data['InformationResource']['module_code'])?$this->data['InformationResource']['module_code']:''; ?>" />
							</div>
						</div>
					</div>
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['resource_name'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
				  		<?php if(isset($backend_locales) && sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10" style="margin-bottom:8px;">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['parent_resource'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
								<select data-am-selected="{searchBox: 1,maxHeight:150, btnSize: 'default ', btnStyle: '#CCCCCC'}" name="data[InformationResource][parent_id]">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['r_description'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['resource_code'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
					...
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['z_resource_value'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">				
					...
					<!--是否可用-->
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['availability'];?></div>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10">
								<label class="am-radio am-success"><input type="radio" class="radio" data-am-ucheck name="data[InformationResource][status]" style="margin-left:0px;" value="1" checked="true" <?php if(isset($this->data['InformationResource']['status'])){if($this->data['InformationResource']['status']==1){echo "checked";}}?>/><?php echo $ld['yes'];?></label>&nbsp;&nbsp;&nbsp;
					...
					<!--排序-->
					<div class="am-form-group">
						<div class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"><?php echo $ld['sort'];?></div> 
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-9">
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
								...
								<p style="margin-top:0;"><?php echo $ld['sorting_prompt'];?></p> 
							</div>
