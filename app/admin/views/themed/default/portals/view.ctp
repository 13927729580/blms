                ...
                <table class="am-table">
                    <tr>
       				...
       				<tr>
        				...
        				<td>
    <?php echo $html->image((isset($portalInfo['Portal']['img'])?$portalInfo['Portal']['img']:'/theme/default/images/default.png'),array('style'=>'margin-left:10px;')); ?>
...
function ajaxFileUpload(){
	 $.ajaxFileUpload({
		  url:admin_webroot+'portals/uploadimg/', //你处理上传文件的服务端
		  secureuri:false,
		  fileElementId:'PortalImg',
		  dataType: 'json',
		  success: function (result){
			if(result.code=='1'){
				$("#PortalImg").parent().find("img").attr("src",webroot+result.upload_img_url);
