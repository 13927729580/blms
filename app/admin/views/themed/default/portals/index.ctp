				...
				<td>
					<?php
						if($v["Portal"]["status"]==1){
							echo $html->image('/admin/skins/default/img/yes.gif',array('style'=>'cursor:pointer;','onclick'=>'listTable.toggle(this, "portals/toggle_on_status", '.$v["Portal"]["id"].')'));
						}else{
							echo $html->image('/admin/skins/default/img/no.gif',array('style'=>'cursor:pointer;','onclick'=>'listTable.toggle(this, "portals/toggle_on_status", '.$v["Portal"]["id"].')'));
						}
					?>
				</td>
				<td class="am-action">
                    	...
                    	<a class="am-btn am-btn-default am-btn-xs am-text-danger   am-seevia-btn-delete" href="javascript:void(0);" onclick="list_delete_submit(admin_webroot+'/portals/remove/<?php echo $v['Portal']['id'] ?>')">
