...
<div>
	<div class="am-text-right  am-btn-group-xs" style="margin-right:10px;margin-bottom:10px">
		<?php echo $html->link($ld['voucher'],'/vouchers/',array("class"=>"am-btn am-btn-default am-btn-sm"),'',false,false);?>
	</div>
	<div>
		<div class="am-u-lg-2 am-u-md-3 am-u-sm-4">
			<ul class="am-list admin-sidebar-list" data-am-scrollspy-nav="{offsetTop: 45}" style="position: fixed; z-index: 100; width: 15%;max-width:200px;">
		    	<li><a href="#batch_upload_voucher"><?php echo $ld['bulk_upload']?></a></li>
		...
		<div class="am-panel-group admin-content" id="accordion" style="width:83%;float:right;">
			<?php echo $form->create('vouchers',array('action'=>'/uploadpreview/'.$batch_sn,'name'=>"uploadForm","enctype"=>"multipart/form-data"));?>
				<div id="batch_upload_voucher" class="am-panel am-panel-default">
							...
							<?php if(isset($profilefiled_codes)&&sizeof($profilefiled_codes)>0&&!empty($profilefiled_codes)){?>
								<div class="am-form-group">
					    			...
					    			<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
										...
										<?php echo $html->link($ld['download_example_batch_csv'],"/vouchers/download_csv_example/",'',false,false);?>
					    				</div>
					    			</div>
					    		</div>
				    		<?php }?>
