<p class="am-u-md-12 am-text-right am-btn-group-xs" >
    <?php
        if($svshow->operator_privilege("email_lists_add")){
            echo $html->link($ld['magazine_user'],'/newsletter_lists/',array('target'=>"_blank","class"=>"am-btn am-radius am-btn-sm  am-btn-default"));
            echo "&nbsp;";
                ...
                <tr>
                    ...
                    <?php 	}?>
                        <?php if($svshow->operator_privilege("email_lists_remove")){?>
                            <a class="am-btn am-btn-default am-btn-xs am-text-danger am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'/email_lists/remove/<?php echo $v['MailTemplate']['id'] ?>')">
