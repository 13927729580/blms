            ...
            <tr>
                ...
                <td><?php
                    ...
                    if($svshow->operator_privilege("users_remove")){
                        echo $html->link($ld['delete'],"javascript:;",array("class"=>"am-btn am-btn-danger am-btn-xs am-radius","onclick"=>"list_delete_submit('{$admin_webroot}users/remove/{$v['User']['id']}')"));
                    }
                    ?></td>
            </tr>
        <?php }}else{?>
