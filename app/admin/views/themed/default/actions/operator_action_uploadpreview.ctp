...
<?php echo $form->create('operator_actions',array('action'=>'/operator_action_uploadpreview/','name'=>"theForm"));?>
...
{
document.theForm.action=admin_webroot+"operator_actions/operator_action_uploadpreview";
