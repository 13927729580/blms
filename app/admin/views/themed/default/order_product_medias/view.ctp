...
<div class="am-g admin-content am-course  ">
    ...
    <?php echo $form->create('/order_product_medias',array('action'=>'view/'.$id,'id'=>'order_product_media_add_form','name'=>'order_product_media','type'=>'POST','onsubmit'=>""));?>
    <input type="hidden" name="data[OrderProductMedia][id]" id="_id" value="<?php echo $product_media_info['OrderProductMedia']['id'];?>" />
    <input type="hidden" name="data[OrderProductMedia][order_product_id]" id="order_product_id" value="<?php echo $product_media_info['OrderProductMedia']['order_product_id'];?>" />
                ...
                <div class="am-panel-bd am-form-detail am-form am-form-horizontal">
                    <div class="am-form-group">
						...
						<select name='data[OrderProductMedia][type]' data-am-selected="{maxHeight:200}">
							...
							<option value="image" <?php if($product_media_info['OrderProductMedia']['type']=="image"){echo "selected";}?>>图片</option>
							<option value="video" <?php if($product_media_info['OrderProductMedia']['type']=="video"){echo "selected";}?>>视频</option>
						</select>
				    </div>
                	</div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-9 am-u-md-8 am-u-sm-8">
                            <div class="am-u-lg-9 am-u-md-9 am-u-sm-9" style="margin-top:10px;">
                                <input type="text" name="data[OrderProductMedia][media]" value="<?php echo $product_media_info['OrderProductMedia']['media'];?>" />
                                <input type="file" onchange="ajax_upload_media(this)"/>
                                <div class="img_select" style="margin:5px;">
                                    <?php echo $html->image($product_media_info['OrderProductMedia']['media'],array('id'=>'show_img'))?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-9 am-u-md-9 am-u-sm-9">
                            <div class="am-u-lg-11 am-u-md-11 am-u-sm-11">
                                <div class="am-form-group">
                                    <textarea cols="80" id="elm" name="data[OrderProductMedia][description]" rows="10" style="width:auto;height:300px;"><?php echo $product_media_info['OrderProductMedia']['description'];?></textarea>
                                    <script>
                                        var editor;
