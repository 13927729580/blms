...
.img_select{clear:both;max-width:150px;max-height:120px;padding:5px;padding-left: 15px;}
...
<div>
	...
	<div class="admin-content am-u-lg-9 am-u-md-9 am-u-sm-9 am-detail-view" id="accordion" style="width:100%;float:right;padding-left:0;padding-right:0;">
		    ...
		    <div class="am-panel-collapse am-collapse am-in">
				...
				<?php if(isset($config_groups[$groups]) && sizeof($config_groups[$groups])>0){foreach($config_groups[$groups] as $sub_k=>$sub_group){ ?>	
					...
					<div class="am-form-group">
						<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" ><?php echo $sub_group_info['ConfigI18n'][$backend_locale]['name']?></label>
						<?php  foreach($backend_locales as $k=>$v){if(isset($sub_group_info['ConfigI18n'][$v['Language']['locale']]['id']) && !empty($sub_group_info['ConfigI18n'][$v['Language']['locale']]['id'])){ ?>
							<div class="am-u-lg-6 am-u-md-7 am-u-sm-8">
								...
								<?php if(sizeof($backend_locales)>1){?><label class="am-u-lg-1 am-u-md-1 am-u-sm-1" style="margin-top:6px;margin-left:0px;"><?php echo $ld[$v['Language']['locale']];?></label><?php }?>
								<?php
			    ...
			    <div class="am-form-group">
					<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left" style="padding-top:20px;"><?php echo $sub_group_info['ConfigI18n'][$backend_locale]['name']?></label>
					<div class="am-u-lg-7 am-u-md-7 am-u-sm-8">
						<?php  foreach($backend_locales as $k=>$v){ ?>
							...
							<label class="am-u-lg-1 am-u-md-1 am-u-sm-1" style="margin-top:12px;margin-left:0px;">
								<?php echo $ld[$v['Language']['locale']];?>
							</label>
							<?php }?>
							<label class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-form-label am-text-left" style="margin-top:8px;margin-left:0px;">
							<?php
								if(!empty($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) && trim($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) !=""){
			    ...
			    <div class="am-form-group" >
					<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" >
			    ...
			    <div class="am-form-group" >
					...
					<?php 	foreach ($backend_locales as $k => $v) {?>
						<div class="am-u-lg-6 am-u-md-7 am-u-sm-8" >
							...
							<?php if(sizeof($backend_locales)>1){?><label class="am-u-lg-1 am-u-md-1 am-u-sm-1" style="margin-top:12px;margin-left:0px;"><?php echo $ld[$v['Language']['locale']];?></label><?php }?>
							<?php
								if(!empty($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) && trim($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) !=""){
									echo $html->link(" ", "javascript:config_help(".(empty($sub_group_info['ConfigI18n'][$v['Language']['locale']]['id'])?0:$sub_group_info['ConfigI18n'][$v['Language']['locale']]['id']).")",array('escape'=>false,'class'=>'helpbtn'));
								}?>
			    ...
			    <div class="am-form-group">
					<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" style="padding-top:10px;">
			    ...
			    <div class="am-form-group">
					<?php if($sub_group_info['Config']['code']=='watermark_location'){continue;}	?>
						<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" style="padding-top:20px;">
							<?php echo isset($sub_group_info['ConfigI18n'][$backend_locale])?$sub_group_info['ConfigI18n'][$backend_locale]['name']:""?>
						</label>
				...
				<div class="am-form-group">
						<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" style="padding-top:22px">
							<?php echo isset($sub_group_info['ConfigI18n'][$backend_locale])?$sub_group_info['ConfigI18n'][$backend_locale]['name']:"";?>
						</label>
					    <div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
						<?php 	foreach ($backend_locales as $k => $v) { ?>
				...
				<div class="am-form-group">
						...
						<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left"  style="padding-top:13px;">
							<?php echo $sub_group_info['ConfigI18n'][$backend_locale]['name']?>
						</label>
					<div class="am-u-lg-7 am-u-md-7 am-u-sm-8">
					<?php 	foreach ($backend_locales as $k => $v) { ?>
						...
						<?php if(sizeof($backend_locales)>1){?>
							<label class="am-u-lg-1 am-u-md-1 am-u-sm-1" style="margin-top:12px;margin-left:0px;"><?php echo $ld[$v['Language']['locale']];?></label>
						<?php }?>
							<label class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-form-label am-text-left" style="margin-top:12px;margin-left:0px;">
						<?php
							if(!empty($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) && trim($sub_group_info['ConfigI18n'][$v['Language']['locale']]['description']) !=""){
				...
				<?php if ($sub_group_info['Config']['type'] == "checkbox") {?>
			    	<div class="am-form-group">
						<label class="am-u-lg-2 am-u-md-2 am-u-sm-3  am-form-label am-text-left" style="padding-top:12px;">
							<?php echo $sub_group_info['ConfigI18n'][$backend_locale]['name']?>
						</label>
			    ...
			    <div class="am-form-group">
		 		...
		 		<?php if($sub_group_info['Config']['type']=="multiselect"){?>
				<div class="am-form-group">
					<label class="am-u-lg-2 am-u-md-2 am-u-sm-3 am-form-label am-text-left" style="padding-top:20px;"><?php echo $sub_group_info['ConfigI18n'][$backend_locale]['name']; ?></label>
					<div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
						<?php foreach ($backend_locales as $k => $v) {?>
							...
							<div class="am-u-lg-10 am-u-md-10 am-u-sm-10">
								<ul class="am-avg-lg-3 am-avg-md-1 am-avg-sm-1">
									...
									foreach ($options as $option) {$text = explode(":", $option);
										$config_values=explode(';',$sub_group_info['ConfigI18n'][$v['Language']['locale']]['value']);
									if (@$text[1] != "") {?>
									<li>
									<label style="padding-top:1px;" class="am-checkbox am-success">
										<input type="checkbox" class="<?php echo $sub_group_info['Config']['code']?><?php echo $v['Language']['locale'];?>"  name="data[<?php echo $i; ?>][value][]" data-am-ucheck style="margin-left:0px;" value="<?php echo $text[0]; ?>" <?php echo in_array($text[0],$config_values)?'checked':''; ?>/>
										<font><?php if (@$text[1]) { echo $text[1];} ?></font>
									</label>&nbsp;&nbsp;&nbsp;&nbsp;
									</li>
									<?php }}} ?>
...
function test_email(){
	...
	var mail_secure = $('.mail-secure'+backend_locale+":checked").val();
	var mail_service_value = 1;
