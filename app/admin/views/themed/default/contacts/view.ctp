                ...
                <table class="am-table">
                    <?php if(!empty($Resource_info['contact_us_type'])){ ?>
                        <tr>
                            ...
                            <td><?php echo isset($Resource_info['contact_us_type'][$this->data['Contact']['type']])?$Resource_info['contact_us_type'][$this->data['Contact']['type']]:$ld['contacts_us']; ?>
                            </td>
                        </tr>
                    <?php } ?>
                    <!--
                    ...
                    <tr>
                        ...
                        <td><input style="width:60%;" type="text" id="data[Contact][contact_name]" name="data[Contact][contact_name]" value="<?php echo $this->data['Contact']['contact_name'];?>" readonly/></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px"><?php echo $ld['email']?></th>
                        <td><input  style="width:60%;"  type="text" id="data[Contact][email]" name="data[Contact][email]" value="<?php echo $this->data['Contact']['email'];?>" readonly/></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px">QQ</th>
                        <td><input  style="width:60%;"  type="text" id="data[Contact][qq]" name="data[Contact][qq]" value="<?php echo $this->data['Contact']['qq'];?>" readonly/></td>
                    </tr>
                    <tr>
                        <th style="padding-top:15px"><?php echo $ld['phone'];?></th>
                        <td><input style="width:60%;" type="text" id="data[Contact][mobile]" name="data[Contact][mobile]" value="<?php echo $this->data['Contact']['mobile'];?>" readonly />
                    </tr>
					
					<?php if(isset($contact_config_data)&&sizeof($contact_config_data)>0){foreach($contact_config_data as $v){ 
							$contactconfigvalue=isset($contact_config_value[$v['ContactConfig']['code']])?$contact_config_value[$v['ContactConfig']['code']]:'';
							if(isset($contact_config_option[$v['ContactConfig']['code']][$contactconfigvalue])){
								$contactconfigvalue=$contact_config_option[$v['ContactConfig']['code']][$contactconfigvalue];
							}
					?>
					<tr>
                        <th style="padding-top:15px"><?php echo $v['ContactConfigI18n']['name'];?></th>
                        <td><?php echo $contactconfigvalue; ?></td>
                    </tr>
					<?php }} ?>
			<!--
                    <tr>
