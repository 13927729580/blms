...
<div class="listsearch">
    ...
    <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-3" style="margin:10px 0 0 0;">
        ...
        <li style="margin:0 0 10px 0">
            <label class="am-u-sm-3 am-u-md-2  am-u-lg-2 am-form-label"><?php echo $ld['added_time']?></label>
            <div class="am-u-sm-3 am-u-md-3 am-u-lg-3" style="padding:0 0rem;width:34%;">
            ...
            <div class="am-u-sm-3 am-u-md-3 am-u-lg-3 am-u-end" style="padding:0 0rem;width:34%;">
                <div class="am-input-group">
        ...
        <li style="margin:0 0 10px 0">
            ...
            <div class="am-u-sm-7 am-u-md-7 am-u-lg-8">
                <input placeholder="<?php echo $ld['contacter']?>/<?php echo $ld['email']?>" type="text" name="kword_name" value="<?php echo @$kword_name;?>"/>
            </div>
       </li>
        <li style="margin:0 0 10px 0">
...
<div class="am-text-right am-btn-group-xs" style="clear:both;margin:10px auto;">
	<?php if($svshow->operator_privilege("contacts_detail")){echo $html->link($ld['contact_config_management'],"/contact_configs/index",array('target'=>'_blank',"class"=>" mt am-btn am-btn-default am-seevia-btn-view"));} ?>
</div>
...
<div id="tablelist" class="tablelist am-u-md-12 am-u-sm-12">
    <table class="am-table  table-main">
        <thead>
	    <tr>
	        <th style="max-width:200px;word-wrap:break-word;word-break:normal;"><label style="margin:0 0 0 0;" class="am-checkbox am-success"><span class="am-hide-sm-only"><input onclick='listTable.selectAll(this,"checkboxes[]")' type="checkbox" data-am-ucheck/></span><b><?php echo $ld['contacter']?></b></label></th>
	        <?php if(!empty($Resource_info['contact_us_type'])){ ?>
	         <th class="am-hide-md-down"><?php echo $ld['type']?></th>
	        <?php } ?> 
		        <th ><?php echo $ld['email']?></th>
			 <th><?php echo $ld['phone']; ?></th>
...
if(isset($contact_info) && sizeof($contact_info)>0){
    foreach($contact_info as $k=>$v){
        ?>
        <tr>
            <td style="max-width:200px;word-wrap:break-word;word-break:normal; "><label style="margin:0 0 0 0;" class="am-checkbox am-success"><span class="am-hide-sm-only"><input type="checkbox" name="checkboxes[]" data-am-ucheck value="<?php echo $v['Contact']['id']?>" /></span><?php echo $v["Contact"]["contact_name"]; ?></label>
            </td>
            <?php if(!empty($Resource_info['contact_us_type'])){ ?>
            <td class="am-hide-md-down"><?php echo isset($Resource_info['contact_us_type'][$v['Contact']['type']])?$Resource_info['contact_us_type'][$v['Contact']['type']]:$ld['contacts_us']; ?>
            </td><?php } ?>
            ...
            <td  ><?php if($svshow->operator_privilege("contacts_detail")){ ?>
             <a  style="margin-top:5px;" class="am-btn am-btn-success am-btn-xs am-seevia-btn am-seevia-btn-view" href="<?php echo $html->url('/contacts/view/'.$v['Contact']['id']);?>"> <span class="am-icon-eye"></span> <?php echo$ld['details_view']; ?>
            	...
            	<?php }?>
               <?php  if($svshow->operator_privilege("contacts_remove")){?> <a style="margin-top:5px;" class="am-btn am-btn-default am-btn-xs am-text-danger am-seevia-btn-delete" href="javascript:;" onclick="list_delete_submit(admin_webroot+'contacts/remove/<?php echo $v['Contact']['id']?>')">
