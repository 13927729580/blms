...
<div class="am-product">
    <div id="accordion" class="am-u-lg-12 am-u-md-12 am-u-sm-12">
        <?php echo $form->create('/evaluation_categories',array('action'=>'add','id'=>'evaluation_category_add_form','name'=>'evaluation_category_add','type'=>'POST','class'=>'am-form am-form-horizontal','onsubmit'=>"return chechk_form()"));?>
        <input type="hidden" name="data[EvaluationCategory][id]" id="_id" value="" />
        <div class="am-g">
            ...
            <div id="Basic_information_pancel" class="am-panel-collapse am-collapse am-in">
                ...
                <div class="am-panel-bd">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5"><input type="text" name="data[EvaluationCategory][code]" id="code" value=""></div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5"><input type="text" name="data[EvaluationCategory][name]" id="name" value=""></div>
                        <em style="position: relative; top: 10px; color: red; left: 10px;">*</em>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-lg-4 am-u-md-4 am-u-sm-4 am-form-label"><?php echo $ld['status'] ?></label>
                        <div class="am-u-lg-6 am-u-md-5 am-u-sm-5">
                            <label class="am-radio-inline"><input type="radio" name="data[EvaluationCategory][status]" value="1" checked/>有效</label>
                            <label class="am-radio-inline"><input type="radio" name="data[EvaluationCategory][status]" value="0"/>无效</label>
                        </div>
                    </div>
                </div>
            </div>
