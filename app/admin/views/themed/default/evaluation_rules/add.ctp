...
<div class="am-g admin-content am-course  ">
    ...
    <?php echo $form->create('/evaluation_rules',array('action'=>'add/'.$code,'id'=>'evaluation_rule_add_form','name'=>'evaluation_rule_add','type'=>'POST','onsubmit'=>""));?>
    <input type="hidden" name="data[EvaluationRule][id]" id="_id" value="" />
                ...
                <div class="am-panel-bd am-form-detail am-form am-form-horizontal">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-lg-9 am-u-md-8 am-u-sm-8">
                            ...
                            <label class="am-radio-inline"><input type="radio" name="data[EvaluationRule][question_type]" value="0"/>单选</label>
                        </div>
                    </div>
                    <div class="am-form-group">
