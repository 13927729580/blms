...
<div>
	<form id="SearchForm" accept-charset="utf-8" action="<?php echo $admin_webroot; ?>product_sale_statements/" method="get" enctype="multipart/form-data" name="SearchForm" class="am-form am-form-horizontal" >
...
<?php }?>
	...
	function form_st(){
		var str=get_str();
		window.location.href=encodeURI(admin_webroot+"product_sale_statements/"+str);
	}
	function get_str(){
...
function changeprofile(){
	...
	var str=get_str();
	window.location.href=encodeURI(admin_webroot+"product_sale_statements/index/export/"+str+"&code="+code);
	...
	function print_act(){
		...
		win.location.href=encodeURI(admin_webroot+"product_sale_statements/product_print/"+str);
	}
