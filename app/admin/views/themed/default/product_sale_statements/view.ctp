...
<script type="text/javascript">
	...
	function formsubmit(){
		...
		window.location.href=encodeURI(admin_webroot+"product_sale_statements/view/<?php echo $product_code;?>"+str);
	}
	function export_act(){
		var st = document.getElementsByName('start_date')[0].value,
			ed = document.getElementsByName('end_date')[0].value,
		...
		ta = ta.substring(ta,ta.length-1);
		var str = "?st="+st+"&ed="+ed+"&kw="+kw+"&ta="+ta;
		url = admin_webroot+"product_sale_statements/view/<?php echo $product_code;?>/export/"+str;
