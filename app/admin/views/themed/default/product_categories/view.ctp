...
<div class="am-g" style="margin-left:0;margin-right:0;">
	...
	<?php echo $form->create('ProductCategory',array('action'=>'view/'.(isset($this->data['CategoryProduct']['id'])?$this->data['CategoryProduct']['id']:""),'name'=>'ProductCategoryForm','onsubmit'=>'return productcat_input_checks();'));?>
			<!-- 右上角按钮 -->
			<div class="btnouter am-text-right" data-am-sticky="{top:'100px',animation:'slide-top'}" style="margin-bottom:0;margin-top:0;">
		...
		<div class="am-panel-group   am-detail-view" id="accordion" style="width:100%;">
				...
				<div class="am-panel-collapse am-collapse am-in">
				    <div class="am-panel-bd am-form-detail am-form am-form-horizontal">
						...
						<div class="am-form-group">
						    <label class="am-u-lg-2 am-u-md-3 am-u-sm-4 ">
						...
						<div class="am-form-group">
							...
							<?php {foreach ($backend_locales as $k => $v){?>
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="margin-top:10px;padding:0px;width:85.2%;">
						...
						<div class="am-form-group" >
							<label class="am-u-lg-2 am-u-md-3 am-u-sm-4  am-form-radio-label" >
						...
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 "style="margin-top:8px;"><?php echo $ld['product_categories_show_info']?></label>
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
								<?php
						...
						<div class="am-form-group" >
							...
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6">
								<label class="am-radio am-success" style="padding-top:2px;">
									<input type="radio" name="data[CategoryProduct][home_show]" data-am-ucheck
									 value="1" <?php echo (isset($this->data['CategoryProduct']['home_show'])&&$this->data['CategoryProduct']['home_show']==1)?"checked":"";?> />
									<?php echo $ld['yes']?>
								</label>&nbsp;&nbsp;
								<label class="am-radio am-success" style="padding-top:2px;">
									<input name="data[CategoryProduct][home_show]" type="radio" data-am-ucheck
									 value="0" <?php echo !isset($this->data['CategoryProduct']['new_show'])||(isset($this->data['CategoryProduct']['home_show'])&&$this->data['CategoryProduct']['home_show']==0)?"checked":"";?> />
									<?php echo $ld['no']?>
								</label>
							</div>
						</div>
 ...
 <!--文本域1-->			
				<div class="am-panel-collapse am-collapse am-in">	
					<div class="am-panel-bd">
					    	<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label" style="margin-left:0;"></label>				
			    	...
			    	<div class="am-panel-bd am-form-detail am-form am-form-horizontal">
						<div class="am-form-group">
							<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-group-label">
								...
								<div class="am-u-lg-6 am-u-md-6 am-u-sm-6" style="padding-left:0;padding-right:0;margin-left:15px;"><div style="padding-left:0;">
						...
						<div class="am-form-group">
							...
							<div class="am-u-lg-6 am-u-md-6 am-u-sm-6" style="padding-left:0;padding-right:0;margin-left:15px;">
						...
						<div class="am-form-group" style="margin-top:18px;">
							...
							<div class="am-u-lg-7 am-u-md-7 am-u-sm-7" style="padding-left:0;padding-right:0;margin-left:15px;">
							<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
								<div style="margin-top:10px;padding-left:0;width:85.3%;float:left;" >
								...
								<?php if(sizeof($backend_locales)>1){?>
									<label class="am-u-lg-1 am-u-md-1 am-u-sm-1  am-form-group-label" style="font-weight:normal;">
						...
						<div class="am-form-group">
							...
							<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){?>
								...
								<?php if(sizeof($backend_locales)>1){?>
									<label class="am-u-lg-1 am-u-md-1 am-u-sm-1   am-form-group-label " style="font-weight:normal;padding-top:12px;">
										<?php echo $ld[$v['Language']['locale']]?>
									</label>
								<?php }?>
							<?php }}?>
			    ...
			    <div class="am-panel-collapse am-collapse am-in">
			      	<div class="am-panel-bd am-form-detail am-form am-form-horizontal"> 
						<?php if(isset($backend_locales)&&sizeof($backend_locales)>0){foreach ($backend_locales as $k => $v){if($configs["show_edit_type"]){?>
					             <label class="am-u-lg-2 am-u-md-3 am-u-sm-4  "> </label>
							     <div class="am-u-lg-10 am-u-md-9 am-u-sm-8 "  >
									  <div class="am-form-group">
											 <span class="ckeditorlanguage"><?php echo $v['Language']['name'];?></span>
							...
							<?php }else{?>	
							<div class="am-form-group">
								<label class="am-u-lg-2 am-u-md-3 am-u-sm-4 am-form-label">
