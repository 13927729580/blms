    ...
    <div class="listtable_div_btm am-margin-bottom-sm">
        ...
        <?php if(isset($user_course_list) && sizeof($user_course_list)>0){foreach($user_course_list as $k=>$v){ ?>
            <div class="am-g">
				...
				<div class="am-u-lg-2 am-u-md-2 am-u-sm-2"><?php echo isset($couse_class_detail_list[$v['UserCourseClass']['user_id']][$v['UserCourseClass']['course_id']])?$couse_class_detail_list[$v['UserCourseClass']['user_id']][$v['UserCourseClass']['course_id']]:0;echo "&nbsp;/&nbsp;<span class='am-text-success'>";echo isset($user_complete_course[$v['UserCourseClass']['user_id']][$v['UserCourseClass']['course_id']])?$user_complete_course[$v['UserCourseClass']['user_id']][$v['UserCourseClass']['course_id']]:0;echo "</span>&nbsp;/&nbsp;";echo isset($couse_class_list[$v['Course']['code']])?$couse_class_list[$v['Course']['code']]:0; ?></div>
