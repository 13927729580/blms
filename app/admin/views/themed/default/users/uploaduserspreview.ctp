...
<?php echo $form->create('users',array('action'=>'/batch_add_user/','name'=>"theForm"));?>
<?php //pr($code_transfer); ?>
<div id="tablelist" class="tablelist am-u-md-12 am-u-sm-12">
	<table id="t1" class="am-table  table-main">
		...
		<tr>
			...
			?>
				<td><input type='text' class="user_<?php echo $fields_kk[1]?>" name="data[<?php echo $k?>][<?php echo $fields_kk[0]; ?>][<?php echo $fields_kk[1]?>]" value="<?php echo isset($v[$fields_kk[1]])?$v[$fields_kk[1]]:"";?>" /></td>
			<?php }?>
		</tr>
		<?php }}?>
	</table>
