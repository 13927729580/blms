            ...
            <tr>
                ...
                <td><?php
                    ...
                    if($svshow->operator_privilege("userchat_remove")){ 
                        echo $html->link($ld['delete'],"javascript:;",array("class"=>"am-btn am-btn-default am-text-danger am-btn-xs am-radius","onclick"=>"list_delete_submit('{$admin_webroot}users/removechat/{$v['UserChat']['id']}')"));
