<div class="listsearch">
    ...
    <ul class="am-avg-sm-1 am-avg-md-2 am-avg-lg-3" style="margin:10px 0 0 0;">
        ...
        <li style="margin:0 0 10px 0">
            <label class="am-u-lg-3 am-u-md-4 am-u-sm-4  am-form-label"><?php echo $ld['member_name']?></label>
        ...
        <li style="margin:0 0 10px 0">
            <label class="am-u-lg-3 am-u-md-3 am-u-sm-4 am-form-label">Email</label>
            <div class="am-u-lg-7 am-u-md-7 am-u-sm-7">
        ...
        <li style="margin:0 0 10px 0">
            ...
            <div class="am-u-sm-4 am-u-md-4 am-u-lg-4  am-u-end am-padding-right-0">
        ...
        <li>
            <div class="am-u-lg-2  am-show-lg-only" style="margin-left:20px; ">
    ...
    #check_down .am-icon-checked,#check_down .am-icon-unchecked,#check_down1 .am-icon-checked,#check_down1 .am-icon-unchecked{top:0;}
    </style>
    			
    <?php echo $form->end();?><!----->
</div>
<div id="tablelist" class="tablelist am-u-md-12 am-u-sm-12" style="margin-top:15px;">
    <table class="am-table  table-main">
        <thead>
        <tr>
            <th><label style="margin:0 0 0 0;" class="am-checkbox am-success"><span class="am-hide-sm-down" id="check_down"><input onclick='listTable.selectAll(this,"checkboxes[]")' type="checkbox" data-am-ucheck/></span><b><?php echo $ld['date']?></b></th>
        ...
        <?php if(isset($log_list) && sizeof($log_list)>0){foreach($log_list as $k=>$v){?>
            <tr>
                <td><label style="margin:0 0 0 0;" class="am-checkbox am-success"><span class="am-hide-sm-down" id="check_down1"><input type="checkbox" name="checkboxes[]" data-am-ucheck value="<?php echo $v['UserBalanceLog']['id']?>" /></span><?php echo $v['UserBalanceLog']['created']?></td>
