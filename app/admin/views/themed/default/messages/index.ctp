...
<div class="listsearch">
    ...
    <ul class="am-avg-lg-3  am-avg-md-2 am-avg-sm-1" style="margin:10px 0 0 0;">
         ...
         <li style="margin:0 0 10px 0">
            ...
            <div class="am-u-lg-3  am-u-md-3 am-u-sm-3 " style="padding:0 0rem;width:33%;">
            ...
            <em class=" am-u-lg-1  am-u-md-1 am-u-sm-1  am-text-center" style="padding-top:5px;width:4%;padding-left:0.5rem;padding-right:0.5rem;">-</em>
            <div class="  am-u-lg-3  am-u-md-3  am-u-sm-3 am-u-end" style="padding:0 0rem;width:33%;">
                <div class="am-input-group">
                <input style="" type="text" class="am-form-field am-input-sm" data-am-datepicker="{theme: 'success',locale:'<?php echo $backend_locale; ?>'}" readonly name="end_time" value="<?php echo @$end_time;?>" />
                <span class="am-input-group-label" onclick="cla(this)" style="cursor:pointer;">
                <i class="am-icon-remove"></i>
              </span>
            </div>
...
<script type="text/javascript">
    ...
    {
        //alert('good');
        var info = $('form[name="UserForm"]').serialize();
        //document.UserForm.action=admin_webroot+"messages/batch";
        //document.UserForm.onsubmit= "";
        //alert(info);
        //document.UserForm.submit();
        info += '&act_type=delete';
        $.ajax({
            url: admin_webroot+"messages/batch",
            type:"GET",
            data:info,
            dataType:"html",
