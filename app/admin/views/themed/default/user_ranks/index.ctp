			...
			<div>
				...
				<?php 	}?>
							<?php if($svshow->operator_privilege("user_ranks_remove")){?>
								<a href="<?php echo $admin_webroot; ?>user_ranks/remove/<?php echo $v['UserRank']['id']; ?>" class="am-btn am-text-danger am-btn-default am-btn-sm am-radius"  onclick="return confirm('<?php echo $ld['confirm_delete'] ?>');"><span class="am-icon-trash-o"></span> <?php echo $ld['delete']; ?></a>
							<?php }?>
						</div>
						<div style="clear:both;"></div>
					</div>
