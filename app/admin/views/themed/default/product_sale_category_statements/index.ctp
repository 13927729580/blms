...
<div>
	<div>
		<ul class="am-avg-lg-3 am-avg-md-2 am-avg-sm-1 am-form am-form-horizontal">
			...
			<li style="margin-bottom:10px;">
				...
				<div class="am-u-lg-1 am-u-md-1 am-u-sm-1 am-text-center" style="padding-top:7px;padding-left:0.5rem;padding-right:0.5rem;width:4%;">-</div>	
				<div class="am-u-lg-3 am-u-md-3 am-u-sm-3" style="padding-left:0;padding-right:0;width:32%;">
					<div class="am-input-group">
...
<?php }?>
	...
	function form_st(){
		var str=get_str();
		window.location.href=encodeURI(admin_webroot+"product_sale_category_statements/"+str);
	}
	function get_str(){
		//订单来源
		var ta = ck_checkbox();
