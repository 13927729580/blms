...
function disright(){
	...
	$("#rightmenu #OpenElementForm .btnouter").css("top","820px");
...
//	}
	...
	//清除外链输入框中的信息
	document.getElementById('other-element-url').value='';
}
...
function dele(obj){
	//设置添加时的默认空白图片
	var element_default_img=admin_webroot+"skins/default/img/element_default.jpg";
	if(typeof(element_Id)!="undefined"&&element_Id==""){
		element_default_img=admin_webroot+"skins/default/img/element_add_default.png";
	}
	if(obj==100){
